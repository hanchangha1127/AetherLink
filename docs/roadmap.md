...
fixed at 274 files and SHA-256
...
Forty-seven of the closed 52 output files are raw-byte-identical. The two DM
ZIPs, `mapping.prt`, `resources.txt`, and `seeds.txt` differ only below their
...
The 40,835-byte mode-0600 result has SHA-256
`bc73eccc2e98a1efe9c62b169e5842d98037d5dc112a68f41bb12cc6f704da01`,
and its independent producer/checker suite passes 19/19.
...
gap only. It does not claim all 52 raw outputs or cross-host builds are byte-
