...
- The newest G6/G7 Android Release slice keeps one strict-lock Release graph
  ...
  source stays fixed across before/between/after snapshots at 274 files and
  SHA-256
  ...
  the 10,695,032-byte AAB SHA-256 is
  `ed8d40dcfe14340a209642023fc20fbdd2f14952094ebaf9c0353277bf0bfd23`.
  Across the closed 52-file output graph, 47 files are raw-byte-identical. The
  two DM ZIPs, `mapping.prt`, `resources.txt`, and `seeds.txt` retain distinct
  ...
  upstream-prestripped native-symbol state. The 40,835-byte mode-0600 result
  has SHA-256
  `bc73eccc2e98a1efe9c62b169e5842d98037d5dc112a68f41bb12cc6f704da01`.
  Its independent checker, 19 regressions, the archive suite's 78 tests,
