...
| `E006` | macOS route and pair lifecycle owner | Observed | `apps/macos/CompanionCore/Sources/CompanionAppModel.swift:924`, `apps/macos/CompanionCore/Sources/CompanionAppModel.swift:1224`, `apps/macos/CompanionCore/Sources/CompanionAppModel.swift:3415` | The app model owns the connection manager and starts pair-scoped private-overlay and relay transports, but the inventoried source does not provide production candidate gathering or traversal. |
