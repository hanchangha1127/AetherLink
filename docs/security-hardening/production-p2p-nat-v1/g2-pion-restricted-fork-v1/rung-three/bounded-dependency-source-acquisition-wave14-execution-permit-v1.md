# Wave14 bounded dependency-source acquisition permit v1

This document explains the machine-checked, one-use Wave14 acquisition permit.
...
- The exact historical
  ...
  Wave14 claim and does not mark this permit consumed.
...
- The canonical command is
  `["/Applications/Xcode.app/Contents/Developer/usr/bin/python3", "-I", "-B", "-S", "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave14_v1_once.py", "--execute"]`
