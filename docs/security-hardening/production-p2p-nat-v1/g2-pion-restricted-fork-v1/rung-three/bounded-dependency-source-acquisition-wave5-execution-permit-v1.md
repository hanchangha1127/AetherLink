# Wave5 bounded dependency-source acquisition permit v1

This document explains the machine-checked, one-use Wave5 acquisition permit.
...
- The permit covers exactly 30 public `GET` requests to
  ...
  of the 15 identity-complete Wave5 module/version vertices.
