# Bounded dependency source acquisition Wave14 readback execution permit v1

This document explains the machine-checked, one-use Wave14 readback permit.
...
acquisition attempt `7fef20e6c3931b698f32b2a71f8a596a`; it does not authorize
...
`build/offline-source/pion-ice-v4.3.0/dependencies/.wave-14-v1-readback.claim`
...
- 15 acquisition-authority files, including the Wave13 one-use claim retained
  as the V12 predecessor namespace anchor;
...
failure record and every portable name beginning `.wave-14-v1-staging-` must
...
- 15,050,695 ZIP response bytes;
- 15,051,448 accepted response bytes;
- 2,571 ZIP entries;
- 55,954,414 ZIP-uncompressed bytes.
...
V12 checker and tests are live-held predecessor authority; V11 tests are
...
`bounded-dependency-source-acquisition-wave14-readback-v1.json`, followed by
`bounded-dependency-source-acquisition-wave14-readback-manifest-v1.json`.
