...
identities are not replacements for the immutable archive member hashes above,
are not frozen in tracked source, and are not claimed bit-for-bit reproducible.
