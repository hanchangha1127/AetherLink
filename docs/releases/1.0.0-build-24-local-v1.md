...
graphs at 276 files and SHA-256
...
The complete closed output inventory contains 53 files. Forty-eight are raw-
byte-identical, including the zero-issue 86-byte lint XML at SHA-256
`224d8ee1273d5e13d2c5a6ad745b7a4acacdf9458356b0cf1e7762d7b6309b90`;
the two DM ZIPs, `mapping.prt`, `resources.txt`, and
...
candidate and intentionally has no cross-run documentation hash.
...
regressions, the separate A/B producer/checker's 23 regressions, independent
