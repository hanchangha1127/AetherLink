#!/usr/bin/env python3
"""Focused tests for the exact read-only 341-input combined v13 checker."""
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v13 tests require unoptimized "
            "`python3 -I -B -S`"
        )
...
CHECKER_PATH = ROOT / "script/check_p2p_nat_g2_pion_combined_fixed_point_v13.py"


def load_checker():
    spec = importlib.util.spec_from_file_location(
        "combined_fixed_point_v13_tests_target",
        CHECKER_PATH,
    )
...
EXPECTED_WAVE14_RESOURCE_IDENTITY = [
    (1, 167, 'mod', 'golang.org/x/crypto', 'v0.40.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/001-6ade739bf483ce7bbe3a.mod', '10e83b8328b00fad3c2548dce61cd6d6871ae229c50fdf7e98475fb0c26a1d35'),
    (2, 167, 'zip', 'golang.org/x/crypto', 'v0.40.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/001-6ade739bf483ce7bbe3a.zip', '6a55423d327359615db923c5f17e5f10c4c7d91c39ef8d0b7f6e0876f89ff9da'),
    (3, 168, 'mod', 'golang.org/x/term', 'v0.33.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/002-47100744b1c211a90d13.mod', '9b00c89d2f9f48d10efdd8a7ae8f83e572adf06ca1cf9c69e97e666fc4c5bb17'),
    (4, 168, 'zip', 'golang.org/x/term', 'v0.33.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/002-47100744b1c211a90d13.zip', '6165d56707f7b1aef699f762a05eed017502c60ebd486e6a735265fc586d0f07'),
    (5, 169, 'mod', 'golang.org/x/text', 'v0.27.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/003-1bdf857599830a828b79.mod', 'da5f12c7398b0c0ea136ec5ece1df536f0f955ad648feeeae33530c3e2fb9cbf'),
    (6, 169, 'zip', 'golang.org/x/text', 'v0.27.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/003-1bdf857599830a828b79.zip', '1230ce66d74ed4510f1578f25b4e53beee00926dc24c86fab7242637f8415ea8'),
    (7, 170, 'mod', 'golang.org/x/tools', 'v0.34.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/004-b142b05fc3ea3268cdd3.mod', '5be696f88fba87769d3912f87af6e800858e85ba4b3b0b599870926492114a9e'),
    (8, 170, 'zip', 'golang.org/x/tools', 'v0.34.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/004-b142b05fc3ea3268cdd3.zip', '3c6b7e5a2a7cc47b1f354c097881d0bd11dc13457d57d5ff86b2469acbd5f846'),
]
EXPECTED_WAVE14_FALSE_ROOT_GO_MOD_FILES = set()
EXPECTED_WAVE14_FROZEN_PATH_RAWS = [
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave14-v1.json', '14d6debddca620af7f628198f7a7ae2d9291adc35a6fffbe13873d3fd75dc28f'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave14-v1.md', '0d909c39aaf81a90c51803ad28839828e6b1df2060e7c347c34bdecda7587cce'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave14_decision_v1.py', 'eec92c7e557119b6eef79dd08069c0e99e0c75f9c7e1b42f5c00ff2d6696eee6'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave14_decision_v1.py', '155fed39113bb3a40e085efde1517409fba22a98e175094cee9edeefd7f380b3'),
    ('script/check_p2p_nat_g2_pion_combined_fixed_point_v12.py', 'cc693cb0126267962813a418a53ece371aec0172d24a75ea70cf6dbe89a1db45'),
    ('script/test_p2p_nat_g2_pion_combined_fixed_point_v12.py', '43dea4e06f07a304b620f33cf9aa647e39839dc5365705756fa10433e9bd60bd'),
    ...
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave14-execution-permit-v1.md', 'a10b431de6711309248b27adf3aeb6482c11ca835785a2497ba88fdbba41280b'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave14-execution-permit-v1.json', '867e1541606f67404f5066cfb6fe8f5265422024e4aec6e9c5e44db755b7fe49'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave14_acquisition_v1.py', 'a19f4f9c89f92f694b4de2d54646a9033af3872f4f8fb461e667b31463255b9f'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave14_acquisition_v1.py', '0f173b5440a29a21f0e587c4d9ce941fc75109737d35a426346e8c7bcc55c423'),
    ('script/acquire_p2p_nat_g2_pion_rung3_dependency_wave14_v1_once.py', '2a8add24b10cf8b1995b60a66f499c298e18fb513514dd1933f5ea04a2b36c2c'),
    ('script/test_acquire_p2p_nat_g2_pion_rung3_dependency_wave14_v1_once.py', '8fadae0e87d3097bc6b9338011780d52e8afc32d1c5532defa245469cd6956c1'),
    ...
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/evidence.json', 'cd8b5528f0080d5405bfb021e163afde4a8a88b1e5d74542396bc5e1269dc343'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/001-6ade739bf483ce7bbe3a.mod', '10e83b8328b00fad3c2548dce61cd6d6871ae229c50fdf7e98475fb0c26a1d35'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/001-6ade739bf483ce7bbe3a.zip', '6a55423d327359615db923c5f17e5f10c4c7d91c39ef8d0b7f6e0876f89ff9da'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/002-47100744b1c211a90d13.mod', '9b00c89d2f9f48d10efdd8a7ae8f83e572adf06ca1cf9c69e97e666fc4c5bb17'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/002-47100744b1c211a90d13.zip', '6165d56707f7b1aef699f762a05eed017502c60ebd486e6a735265fc586d0f07'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/003-1bdf857599830a828b79.mod', 'da5f12c7398b0c0ea136ec5ece1df536f0f955ad648feeeae33530c3e2fb9cbf'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/003-1bdf857599830a828b79.zip', '1230ce66d74ed4510f1578f25b4e53beee00926dc24c86fab7242637f8415ea8'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/004-b142b05fc3ea3268cdd3.mod', '5be696f88fba87769d3912f87af6e800858e85ba4b3b0b599870926492114a9e'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-14-v1/accepted/004-b142b05fc3ea3268cdd3.zip', '3c6b7e5a2a7cc47b1f354c097881d0bd11dc13457d57d5ff86b2469acbd5f846'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave14-receipt-v1.json', '62cc101000b06630c9b0b1ad5d22386bc05f7bbef754fbd3170ba839ce4ca99a'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave14-manifest-v1.json', '98ff8db13d81363294a26004d8feca66baa5a8beced121d7ee2f83af2dc07d97'),
]
...
EXPECTED_CHECKER_CALL_COUNT = 1_380
EXPECTED_CHECKER_CALL_SURFACE_SHA256 = (
    "b6d949dd44ec6f526a73570acea35d38056e4c6b915e0a8279dbfe1677c6050e"
)
EXPECTED_V13_CANDIDATE_CONTENT_SHA256 = (
    "e1f711b558642ad2167da48f25184cd4c3235314c67f06a60cfd14ceecea1988"
)
EXPECTED_V13_GRAPH_SHA256 = (
    "a35d9bd389a6fb9e04052eb411e4c9701a76ff0fd699e1c2d2a113d86439dfd5"
)
EXPECTED_V13_FRONTIER_SHA256 = (
...
def validate_checker_static_surface(source):
    ...
    if (compile_count, exec_count) != (8, 8):
...
def held_toolchain():
    with (
        ...
        v12 = CHECKER.harden_checker_module(
            CHECKER.load_v12_checker(held_v12)
        )
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(ROOT) as held_provider:
                ...
                yield v12, v11, v10, v9, v8, v7, v6, v5, v4, v1, runner


@contextmanager
def held_wave14_documents(*, include_held=False):
    with held_toolchain() as chain:
        v12, v11, v10, v9, v8, v7, v6, v5, v4, v1, runner = chain
        bindings = (
            CHECKER.wave14_control_bindings()
            + CHECKER.wave14_auxiliary_evidence_bindings()
        )
        with runner.HeldInputSet(ROOT, bindings) as held:
            documents = CHECKER.parse_wave14_documents(runner, held)
            if include_held:
...
def held_all_documents():
    with held_toolchain() as chain:
        ...
        auxiliary = CHECKER.wave14_auxiliary_evidence_bindings()
        with runner.HeldInputSet(ROOT, controls + auxiliary) as held:
            yield (
                ...
                CHECKER.parse_wave14_documents(runner, held),
            )


def assert_wave14_mutation_fails(
    testcase: unittest.TestCase,
    mutate,
    expected_code: str,
) -> None:
    with held_wave14_documents() as (v4, runner, documents):
        mutated = copy.deepcopy(documents)
        mutate(mutated)
        with (
            mock.patch.object(
                CHECKER,
                "verify_wave14_content_bindings",
            ),
            testcase.assertRaises(
                CHECKER.CombinedCheckFailure,
            ) as caught,
        ):
            CHECKER.wave14_request_resources(v4, runner, mutated)
    testcase.assertEqual(str(caught.exception), expected_code)


def rebind_wave14_selector_hashes(
    runner,
    documents,
) -> tuple[str, str]:
    """Rebind selector-bearing projections so semantic checks run."""

    decision = documents[CHECKER.WAVE14_DECISION_PATH]
    permit = documents[CHECKER.WAVE14_PERMIT_PATH]
    readback_permit = documents[CHECKER.WAVE14_READBACK_PERMIT_PATH]
    readback = documents[CHECKER.WAVE14_READBACK_PATH]
    ...
    request_set_sha256 = CHECKER.sha256_bytes(
        CHECKER.wave14_digest_bytes(source_requests)
    )
...
class CombinedFixedPointV13Tests(unittest.TestCase):
    maxDiff = None

    @classmethod
    def setUpClass(cls):
        original_load_v12 = CHECKER.load_v12_checker
        original_derive_tool_paths = CHECKER.derive_and_validate_tool_paths
        original_os_open = os.open
        cls.actual_python_open_paths = []

        def capturing_load_v12(held):
            module = original_load_v12(held)
        ...
        with (
            mock.patch.object(
                CHECKER,
                "load_v12_checker",
                side_effect=capturing_load_v12,
            ),
            mock.patch.object(
                CHECKER,
    ...
    def test_01_self_predecessor_and_terminal_bytes_are_exact(self):
        ...
        for path, expected in (
            (CHECKER.V12_CHECKER_PATH, CHECKER.V12_CHECKER_RAW_SHA256),
            (CHECKER.V12_TESTS_PATH, CHECKER.V12_TESTS_RAW_SHA256),
        ):
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
        for path, expected in CHECKER.WAVE14_CONTROL_SHA256.items():
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
    ...
    def test_02_candidate_content_authority_and_route_are_derived(self):
        ...
        self.assertEqual(candidate["schemaVersion"], "13.0")
        self.assertEqual(
            binding["sha256"],
            EXPECTED_V13_CANDIDATE_CONTENT_SHA256,
        )
        ...
        self.assertEqual(
            candidate["derivedResult"],
            {
                ...
                "frontierSha256": EXPECTED_V13_FRONTIER_SHA256,
    ...
    def test_03_exact_341_input_composition_and_hashes(self):
        inputs = self.candidate["inputSet"]
        rows = inputs["sourceBindings"]
        expected_counts = {
            "heldSourceInputCount": 341,
            "resourceCount": 340,
            "modCount": 170,
            "zipCount": 170,
            ...
            "aggregateRawByteSize": 322_537_995,
        }
        for key, value in expected_counts.items():
            self.assertEqual(inputs[key], value, key)
        self.assertEqual(len(rows), 341)
        self.assertEqual(len({row["path"] for row in rows}), 341)
        self.assertEqual(
            inputs["combinedInputSetSha256"],
            CHECKER.V13_INPUT_SET_SHA256,
        )
        self.assertEqual(
            hashlib.sha256(CHECKER.wave14_digest_bytes(rows)).hexdigest(),
            CHECKER.V13_SOURCE_BINDINGS_SHA256,
        )
        pair_orders = sorted(
            {
                row["tupleOrder"]
        ...
        self.assertEqual(pair_orders, list(range(1, 171)))
        self.assertEqual(
            sorted(
                {
                    row["tupleOrder"]
    ...
    def test_04_reconstruction_and_archive_counters_are_not_stale(self):
        ...
        self.assertEqual(
            (
                ...
                CHECKER.V13_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
            ),
            (171, 66_259, 1_230_182_064, 1_230_182_064),
        )
        self.assertEqual(
            (
        ...
        self.assertEqual(
            ...
            (342, 2_644, 2_986, 2_986),
        )
        self.assertEqual(
            verification["underlyingIndependentGraphAlgorithmCount"],
            48,
        )
        self.assertEqual(verification["hardenedCheckerModuleCount"], 12)
        self.assertEqual(verification["providerFacadeLoadCount"], 12)
        self.assertEqual(counters["heldTerminalEvidenceCount"], 94)
        self.assertEqual(counters["heldAuxiliaryEvidenceCount"], 3)
        self.assertEqual(counters["heldToolInputCount"], 12)
        self.assertEqual(counters["transitiveDistinctToolPathCount"], 14)
        for key in (
    ...
    def test_05_live_and_historical_boundaries_are_explicit(self):
        ...
        self.assertTrue(verification["pinnedV12PredecessorExecuted"])
        self.assertEqual(
            verification["v12TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(verification["v12TestsLiveHeld"])
        self.assertTrue(
            verification[
        ...
        self.assertTrue(
            verification["wave14LiveTerminalControlMetadataVerified"]
        )
        self.assertTrue(
            verification["wave14LiveFinalAndAcceptedInventoriesVerified"]
        )
        self.assertTrue(
            verification["wave14CompletionAppliesToRetainedSnapshot"]
        )
        self.assertFalse(
            verification[
        ...
        self.assertFalse(predecessor["v12TestsLiveHeld"])

    def test_06_wave14_terminal_resources_are_exact(self):
        with held_wave14_documents() as (v4, runner, documents):
            resources = CHECKER.wave14_request_resources(
                v4,
                runner,
                documents,
            )
            snapshot = documents[CHECKER.WAVE14_READBACK_PERMIT_PATH][
            ...
            verified_resources = documents[CHECKER.WAVE14_READBACK_PATH][
                "verified"
            ]["resources"]
        ...
        self.assertEqual(len(EXPECTED_WAVE14_FROZEN_PATH_RAWS), 27)
        ...
        self.assertEqual(
            ...
            (15_051_448, 753, 15_050_695, 2_571, 55_954_414),
        )
        self.assertTrue(
            documents[CHECKER.WAVE14_READBACK_PERMIT_PATH][
        ...
        self.assertEqual(
            ...
            EXPECTED_WAVE14_FALSE_ROOT_GO_MOD_FILES,
        )
    ...
    def test_07_combined_input_inventory_is_recomputed(self):
        ...
        self.assertEqual((len(controls), len(auxiliary)), (94, 3))
        self.assertEqual(len(rows), 341)
        self.assertEqual(
            hashlib.sha256(
        ...
        self.assertEqual(
            hashlib.sha256(
                CHECKER.wave14_digest_bytes(projection)
            ).hexdigest(),
            CHECKER.V13_SOURCE_BINDINGS_SHA256,
        )

    def test_08_unknown_authority_and_tool_pin_fail_closed(self):
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_PERMIT_PATH][
                "authority"
        ...
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_DECISION_PATH][
                "toolBindings"
        ...
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                "toolBindings"
        ...
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_READBACK_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
            "E_WAVE14_READBACK",
        )
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_READBACK_MANIFEST_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
        ...
        for key in ("acquisitionClaim", "evidence"):
            assert_wave14_mutation_fails(
                ...
                lambda docs, target=key: docs[
                    CHECKER.WAVE14_READBACK_PERMIT_PATH
    ...
    def test_08_each_wave14_accepted_raw_binding_tamper_fails_closed(self):
        with held_wave14_documents() as (v4, runner, documents):
            accepted = documents[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acceptedDirectory"]["files"]
            self.assertEqual(len(accepted), 8)
            for index in range(8):
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                    "frozenAcquisitionSnapshot"
    ...
    def test_09_stale_wave13_snapshot_and_v11_predecessor_fail_closed(self):
        def substitute_resource_same_cardinality(documents):
            rows = documents[CHECKER.WAVE14_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            rows[0] = copy.deepcopy(rows[2])

        def substitute_authority_same_cardinality(documents):
            rows = documents[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acquisitionAuthority"]
            rows[0] = copy.deepcopy(rows[1])

        def substitute_v11_predecessor(documents):
            predecessors = documents[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["predecessorBindings"]
        ...
        def add_v11_predecessor_sibling(documents, path, nested=False):
            container = documents[path]
            if nested:
                container = container["frozenAcquisitionSnapshot"]
            predecessors = container["predecessorBindings"]
            predecessors["combinedFixedPointV11"] = copy.deepcopy(
                predecessors["combinedFixedPointV12"]
            )
        ...
        assert_wave14_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE14_DECISION_PATH][
                "heldSourceInputSet"
            ].__setitem__("sourceBindingCount", 325),
            "E_WAVE14_DECISION",
        )
        assert_wave14_mutation_fails(
            self,
        ...
        assert_wave14_mutation_fails(
            self,
            substitute_v11_predecessor,
            "E_WAVE14_READBACK_PERMIT",
        )
        for path, nested, expected in (
            (CHECKER.WAVE14_DECISION_PATH, False, "E_WAVE14_DECISION"),
            (CHECKER.WAVE14_PERMIT_PATH, False, "E_WAVE14_PERMIT"),
            (
                CHECKER.WAVE14_READBACK_PERMIT_PATH,
                True,
                "E_WAVE14_READBACK_PERMIT",
        ...
        for path, nested, expected in (
            ...
            for key, value in (
                ("path", "build/offline-source/stale-wave13.claim"),
                ("rawSha256", "0" * 64),
            ):
                assert_wave14_mutation_fails(
                    self,
                    ...
                    anchor_key=key, anchor_value=value: (
                        ...
                        )["predecessorBindings"]["combinedFixedPointV12"][
        ...
        for path, key, value, expected in (
            ...
            def mutate_limit(
                ...
                if target == CHECKER.WAVE14_PERMIT_PATH:
                    section = (
                        "zipLimits"
    ...
    def test_10_selected_tuple_and_live_hold_overclaim_fail_closed(self):
        ...
        assert_wave14_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE14_READBACK_PERMIT_PATH][
                "verificationContract"
            ].__setitem__("v12TestsLiveHeld", False),
            "E_WAVE14_READBACK_PERMIT",
        )

    def test_10_all_wave14_selectors_and_false_root_mods_are_exact(self):
        with held_wave14_documents() as (v4, runner, documents):
            baseline = documents[CHECKER.WAVE14_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            verified = documents[CHECKER.WAVE14_READBACK_PATH]["verified"][
                "resources"
            ]
                ...
                for index in range(count):
                    for value in (True, 0, "false", None, missing):
                        ...
                        resources_sha256, request_set_sha256 = (
                            rebind_wave14_selector_hashes(runner, mutated)
                        )
                        with (
                            self.subTest(
                            ...
                            CHECKER.wave14_request_resources(
                                v4,
                                runner,
                                mutated,
                            )
            ...
            for index in zip_root_indexes:
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE14_READBACK_PATH]["verified"][
                    "resources"
    ...
    def test_11_post_success_reporting_contract_is_pinned(self):
        ...
        assert_wave14_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE14_READBACK_PERMIT_PATH].__setitem__(
    ...
    def test_12_terminal_modes_sizes_and_namespace_are_live(self):
        with held_wave14_documents(include_held=True) as (
            _,
            _,
            documents,
            held,
        ):
            CHECKER.validate_wave14_completed_namespace(held, documents)
            for path, (size, mode) in CHECKER.WAVE14_CONTROL_METADATA.items():
    ...
    def test_13_legacy_wave9_compatibility_remains_exact_and_bounded(self):
        with held_all_documents() as value:
            chain = value[0]
            d9 = value[-6]
            _, _, _, _, v8, _, _, _, v4, _, runner = chain
    ...
    def test_14_static_surface_rejects_dynamic_process_network_and_write_bypass(
        ...
        self.assertEqual(len(exec_calls), 8)
        self.assertEqual(
    ...
    def test_16_error_document_requests_no_credentials(self):
        ...
        self.assertEqual(value["schemaVersion"], "13.0")
    ...
    def test_17_v12_predecessor_is_exact_and_mutations_fail_closed(self):
        predecessor = self.predecessor_candidate
        self.assertEqual(
            predecessor["contentBinding"]["sha256"],
            CHECKER.V12_CANDIDATE_CONTENT_SHA256,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            CHECKER.V12_GRAPH_SHA256,
        )
        self.assertEqual(
            predecessor["derivedResult"]["frontierSha256"],
            CHECKER.V12_FRONTIER_SHA256,
        )
        self.assertEqual(
            predecessor["checkerVerification"]["v11TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(
            predecessor["checkerVerification"]["v11TestsLiveHeld"]
        )
        with held_wave14_documents() as (_, runner, documents):
            decision = documents[CHECKER.WAVE14_DECISION_PATH]
            verified = CHECKER.validate_v12_predecessor_candidate(
                runner,
                predecessor,
                decision,
            )
            ...
            with self.assertRaises(
                ...
                CHECKER.validate_v12_predecessor_candidate(
                    runner,
                    predecessor,
                    stale_key_decision,
                )
            self.assertEqual(str(caught.exception), "E_V12_PREDECESSOR")
            for key in (
                "contentSha256",
            ...
            for key, value in (
                ...
                with self.subTest(wave13_namespace_anchor=key):
                    mutated_decision = copy.deepcopy(decision)
                    mutated_decision["predecessorBindings"][
                        "combinedFixedPointV12"
                    ]["wave13NamespaceAnchor"][key] = value
                    with self.assertRaises(
                        CHECKER.CombinedCheckFailure,
                    ) as caught:
                        CHECKER.validate_v12_predecessor_candidate(
    ...
    def test_18_live_protocol_order_and_tool_holds_are_observed(self):
        ...
        with (
            mock.patch.object(
                CHECKER,
                "validate_wave14_completed_namespace",
    ...
    def test_20_tool_path_derivation_rejects_duplicate_missing_and_extra(self):
        ...
        self.assertEqual(len(direct_paths), 12)
        self.assertEqual(len(transitive_paths), 14)
...
class CombinedFixedPointV13FastBoundaryTests(unittest.TestCase):
