#!/usr/bin/env python3
"""Recompute the exact 333-input Wave1..Wave13 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v11
combined checker, all Wave13 decision/acquisition/readback controls, and the
root archive plus 166 mod and 166 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v12 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v12.py"
...
CHECKER_ID = (
    ...
    "wave7-wave8-wave9-wave10-wave11-wave12-wave13-check-v12"
)
...
WAVE13_CONTROL_METADATA = {
    WAVE13_DECISION_PATH: (14_495, 0o644),
    WAVE13_PERMIT_PATH: (19_040, 0o644),
    WAVE13_RECEIPT_PATH: (1_660, 0o600),
    WAVE13_MANIFEST_PATH: (465, 0o600),
    WAVE13_READBACK_PERMIT_PATH: (18_778, 0o644),
    WAVE13_READBACK_PATH: (7_315, 0o600),
    WAVE13_READBACK_MANIFEST_PATH: (2_301, 0o600),
}
WAVE13_CONTENT_SHA256 = {
    WAVE13_DECISION_PATH:
    ...
    WAVE13_READBACK_PATH:
        "33c99ba641294989c71e5b526006bfa66dfd4738b7f80a91a3af272a81893696",
    WAVE13_READBACK_MANIFEST_PATH:
        "7b31893a35e92071dc6be48482e71cf3d94444c01499a0f29357658d7655a633",
}
WAVE13_REQUEST_SET_SHA256 = (
    "eae1bb0f8645a5d698bfe50fae505a1c7d6887c78c9dcc3b088939b97e0ffce1"
)
WAVE13_PERMIT_RESOURCES_SHA256 = (
    "cdb0c96d670feb69063b50709a342313501de575e4d8d692f943dffcab176f29"
)
WAVE13_RESOURCE_SET_SHA256 = (
    "bcb43e80159d68f179c24e87f1f8d439bb1c387d713b9a3aec0ac932f9a6ee92"
)
WAVE13_FROZEN_FILE_SET_SHA256 = (
    "a99b35472a140330847b1ff7e746a83dc060707ea63af3ef22d165a4f2ced11d"
)
WAVE13_ATTEMPT_ID = "eb05816e0b897ea8c3ad8b7089668e91"
WAVE13_READBACK_ATTEMPT_ID = "8b5f92c9d90f825f5f3b46df0d006ef3"
WAVE13_COMPACT_IDENTITY_SHA256 = (
    "7e43930dc1781385959cdfa3812f43be4e7e922bb1ed5f078ae9bf3f4a25da87"
)
WAVE13_FULL_WITNESS_SHA256 = (
    "22c1051a0d0ce5a31018a2b4e61fb5599849123700f1e07a886f34e509da9074"
)
WAVE13_HELD_SOURCE_BINDINGS_SHA256 = (
    "504b3ed2a6182db6464c93999c3bd073381ee181c7238ca62da5afd2ca87269f"
)
WAVE13_ACQUISITION_CLAIM_RAW_SHA256 = (
    "085fdfae86d88a53526c836e61f956b89694c67cf54ea95b9ef43cb2a8566cc2"
)
WAVE13_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "6a6e2973690dfa9c5d0a6edd2aee8f6ae584fe1c4cb03a12b4ed9243707ce9d7"
)
WAVE13_ACQUISITION_CHECKER_RAW_SHA256 = (
    "0ea506ac073e854a04bfc22c6b3a4d25afd957d9c4043af1e55c6b876eb87612"
)
WAVE13_ACQUISITION_RUNNER_RAW_SHA256 = (
    "482a73740a4efeda92450efbb1ddf97caf53ed06e5dee98a03b4414c5ee3055c"
)
WAVE13_READBACK_CLAIM_RAW_SHA256 = (
    "11c1e04dfde8be7d7728f32912154870dc1e0305d0bbb61f1ff4167304bc5274"
)
WAVE13_READBACK_CLAIM_CONTENT_SHA256 = (
    "b65dd43da5fdc5979c979fac45de7dcee4923623570ac9cdfa6e5f1a10b4651d"
)
WAVE13_READBACK_CHECKER_RAW_SHA256 = (
    "8f9bec0f04c4c7a6436c9f9e286419e5296c6e47193ca50f64603fd95a602dbb"
)
WAVE13_READBACK_RECORDER_RAW_SHA256 = (
    "af7ce8c218ccf37afabe0450bf901c3fe453ec0479a3312d1e8ec39ed4cd14a4"
)
WAVE13_READBACK_RECORDER_NORMALIZED_SHA256 = (
    "d73326aa907e36f177ff74f7968089504b1fcff7427141371a319338c93c99c4"
)
WAVE13_RETAINED_BARRIERS = [
...
WAVE13_ABSOLUTE_RESOURCE_LIMITS = {
    "callerBlockedSigalrmRejectedBeforePreflight": True,
    "maximumAggregateModResponseBodyBytes": 4_194_304,
    "maximumAggregateResponseBodyBytes": 71_303_168,
    "maximumAggregateZipResponseBodyBytes": 67_108_864,
...
WAVE13_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave13_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE13_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE13_CONTENT_SHA256[WAVE13_READBACK_PERMIT_PATH],
        "path": WAVE13_READBACK_PERMIT_PATH,
        "rawSha256": WAVE13_CONTROL_SHA256[WAVE13_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
        ...
        "rawSha256": WAVE13_READBACK_RECORDER_RAW_SHA256,
    },
}
WAVE13_DECISION_TOOL_BINDINGS = [
    {
        "normalizedSha256":
        ...
        "role": "current_wave13_decision_checker",
    },
    {
        "path":
        ...
        "role": "current_wave13_decision_tests",
    },
    {
        "normalizedSha256": V11_CHECKER_NORMALIZED_SHA256,
        "path": V11_CHECKER_PATH,
        "rawSha256": V11_CHECKER_RAW_SHA256,
        "role": "immutable_combined_v11_checker",
    },
    {
        "path": V11_TESTS_PATH,
        "rawSha256": V11_TESTS_RAW_SHA256,
        "role": "immutable_combined_v11_tests",
    },
]
WAVE13_ACQUISITION_TOOL_BINDINGS = [
    {
        "path":
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave13_acquisition_v1.py",
        "rawSha256": WAVE13_ACQUISITION_CHECKER_RAW_SHA256,
    },
    {
        "path":
    ...
    },
    {
        ...
        "rawSha256": WAVE13_ACQUISITION_RUNNER_RAW_SHA256,
    },
    {
        "path":
...
WAVE13_READBACK_TOOL_BINDINGS = [
    WAVE13_READBACK_AUTHORITY_BINDING["checker"],
    {
        "path": (
        ...
        "rawSha256":
            "542bbf1335dc2fb5f1a17ecbb057fb42ebf90ad6cb34b79768d5107f6b239e64",
    },
    WAVE13_READBACK_AUTHORITY_BINDING["recorder"],
    {
        "path": (
        ...
        "rawSha256":
            "28187340fc8781997cf97758a78724778412df365690e9663e57dafef6b6fb4c",
    },
]
...
def wave13_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v12_safe_hardened") is True:
        return module
    module.__dict__["_v12_safe_hardened"] = True
...
def wave13_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE13_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE13_CONTROL_SHA256.items()
    ]


def parse_wave13_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE13_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE13_JSON")
        result[path] = value
    return result


def wave13_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE13_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE13_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 416,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE13_EVIDENCE_PATH,
            "rawSha256": WAVE13_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 3_435,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE13_READBACK_CLAIM_PATH,
            "rawSha256": WAVE13_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_255,
            "ownerOnly": True,
...
def validate_wave13_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE13_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE13_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE13_EVIDENCE_PATH]
    readback = control_held.files[WAVE13_READBACK_PATH]
    readback_manifest = control_held.files[WAVE13_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE13_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE13_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE13_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE13_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE13_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE13_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE13_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE13_READBACK_PERMIT_PATH]
    ...
    check(
        type(accepted_files) is list and len(accepted_files) == 8,
        "E_WAVE13_NAMESPACE",
    )
    ...
    check(
        len(expected_accepted_names) == 8
        and all(
            Path(row["path"]).parent.as_posix() == WAVE13_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE13_NAMESPACE",
    )
    ...
    try:
        ...
        check(
            ...
            and accepted_info.st_nlink == 10
            and stat.S_IMODE(accepted_info.st_mode) == 0o700
            and len(accepted_names) == 8
            and set(accepted_names) == expected_accepted_names
            and len(set(normalized_accepted_names)) == 8,
            "E_WAVE13_NAMESPACE",
        )
    finally:
        if accepted_fd >= 0:
...
def validate_wave13_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE13_ATTEMPT_ID,
            "checkerRawSha256": WAVE13_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave13-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE13_CONTENT_SHA256[WAVE13_PERMIT_PATH],
            "requestCount": 8,
            "schemaVersion": "1.0",
            "status": "consumed_active",
            "userActionRequired": False,
        },
        "E_WAVE13_ACQUISITION_CLAIM",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE13_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE13_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE13_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE13_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE13_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave13-acquisition-readback-one-use-claim"
        ...
        "E_WAVE13_READBACK_CLAIM",
    )


def validate_wave13_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE13_EVIDENCE")
    readback = documents[WAVE13_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE13_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave13-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE13_ATTEMPT_ID
        and evidence_document.get("requestCount") == 8
        and evidence_document.get("aggregateResponseBytes") == 5_097_538
        and evidence_document.get("aggregateModResponseBytes") == 411
        and evidence_document.get("aggregateZipResponseBytes") == 5_097_127
        and evidence_document.get("aggregateZipEntryCount") == 1_647
        and evidence_document.get("aggregateZipUncompressedBytes")
        == 20_065_482
        and type(evidence_resources) is list
        and len(evidence_resources) == 8
...
def verify_wave13_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE13_DECISION_PATH],
        WAVE13_CONTENT_SHA256[WAVE13_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE13_PERMIT_PATH],
        WAVE13_CONTENT_SHA256[WAVE13_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE13_CONTENT_SHA256[path],
        )


def validate_v11_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == V11_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V11_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V11_FRONTIER_SHA256
        and predecessor.get("frontierTupleCount") == 4
        and predecessor.get("fixedPointReached") is False
        and predecessor.get("checkerPath") == V11_CHECKER_PATH
        and predecessor.get("checkerRawSha256") == V11_CHECKER_RAW_SHA256
        and predecessor.get("checkerNormalizedSha256")
        == V11_CHECKER_NORMALIZED_SHA256
        and predecessor.get("testsPath") == V11_TESTS_PATH
        and predecessor.get("testsRawSha256") == V11_TESTS_RAW_SHA256
        and predecessor.get("totalFullSourceReconstructionCount") == 20
        and predecessor.get("totalGraphArchiveOpenCount") == 2_310
        ...
        and predecessor.get("v10TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and predecessor.get("v10TestsLiveHeld") is False
        and predecessor.get("wave12NamespaceAnchor")
        == {
            "path": (
                "build/offline-source/pion-ice-v4.3.0/dependencies/"
                ".wave-12-v1.claim"
        ...
        == {
            ...
            "finalNamespaceReverifiedAfterCombinedV11Reconstruction": True,
            "historicalExact26FrozenSnapshotDescriptorSetBound": True,
            "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV11Barrier":
                True,
            "liveTerminalControlMetadataVerifiedAtCombinedV11Barrier": True,
        ...
        == {
            ...
            "sha256": V11_CANDIDATE_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == V11_CANDIDATE_CONTENT_SHA256
        and candidate.get("schemaVersion") == "11.0"
        ...
        == (
            ...
            "wave1_through_wave12_source_bytes"
        )
        ...
        == {
            ...
            "frontierSha256": V11_FRONTIER_SHA256,
        }
        and type(inputs) is dict
        and inputs.get("heldSourceInputCount") == 325
        and inputs.get("combinedInputSetSha256") == V11_INPUT_SET_SHA256
        and sha256_bytes(runner.canonical_json_bytes(source_bindings))
        == V11_INPUT_SET_SHA256
        and sha256_bytes(wave13_digest_bytes(source_bindings))
        == V11_SOURCE_BINDINGS_SHA256
        and len({row["path"] for row in source_bindings}) == 325
        and sum(row["kind"] == "root_zip" for row in source_bindings) == 1
        and sum(row["kind"] == "mod" for row in source_bindings) == 162
        and sum(row["kind"] == "zip" for row in source_bindings) == 162
        ...
        and graph.get("newTupleCount") == 4
        and graph.get("graphSha256") == V11_GRAPH_SHA256
        and type(frontier) is list
        and len(frontier) == 4
        and sha256_bytes(runner.canonical_json_bytes(frontier))
        == V11_FRONTIER_SHA256
        and candidate.get("authority") == V11_AUTHORITY
        and candidate.get("checkerVerification", {}).get(
    ...
    return {
        ...
        "wave12CompletionAppliesToRetainedSnapshot": True,
        "wave12CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave12SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
        "v11TestsBindingScope": "historical_metadata_only_not_live_held",
        "v11TestsLiveHeld": False,
    }


def wave13_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE13_DECISION_PATH]
    permit = documents[WAVE13_PERMIT_PATH]
    receipt = documents[WAVE13_RECEIPT_PATH]
    manifest = documents[WAVE13_MANIFEST_PATH]
    readback_permit = documents[WAVE13_READBACK_PERMIT_PATH]
    readback = documents[WAVE13_READBACK_PATH]
    readback_manifest = documents[WAVE13_READBACK_MANIFEST_PATH]
    verify_wave13_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE13_CONTENT_SHA256[WAVE13_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave13_exact_4_frontier_identity_classified_4_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and decision.get("authority") == WAVE13_DECISION_AUTHORITY
        and decision.get("toolBindings") == WAVE13_DECISION_TOOL_BINDINGS
        and type(resolution) is dict
        and resolution.get("tupleCount") == 4
        and resolution.get("completeIdentityPairCount") == 4
        and resolution.get("blockedTupleCount") == 0
        and resolution.get("graphSelectedTupleCount") == 0
        and resolution.get("versionSpecificNonSelectedTupleCount") == 4
        and resolution.get("compactIdentitySha256")
        == WAVE13_COMPACT_IDENTITY_SHA256
        and resolution.get("fullWitnessSha256")
        == WAVE13_FULL_WITNESS_SHA256
        and type(held_set) is dict
        and held_set.get("sourceBindingCount") == 325
        ...
        and preparation.get("requestCount") == 8
        ...
        and len(identity_tuples) == 4
        and type(source_requests) is list
        and len(source_requests) == 8
        and sha256_bytes(wave13_digest_bytes(source_requests))
        == WAVE13_REQUEST_SET_SHA256,
        "E_WAVE13_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE13_CONTENT_SHA256[WAVE13_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE13_ACQUISITION_AUTHORITY
        and permit.get("toolBindings") == WAVE13_ACQUISITION_TOOL_BINDINGS
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE13_CONTROL_SHA256[WAVE13_DECISION_PATH]
        ...
        == WAVE13_ABSOLUTE_RESOURCE_LIMITS
        and permit.get("zipLimits") == WAVE13_ZIP_LIMITS
        and permit_predecessor
        == {
            "checkerNormalizedSha256": V11_CHECKER_NORMALIZED_SHA256,
            "checkerPath": V11_CHECKER_PATH,
            "checkerRawSha256": V11_CHECKER_RAW_SHA256,
            "combinedInputSetSha256": V11_INPUT_SET_SHA256,
            "contentSha256": V11_CANDIDATE_CONTENT_SHA256,
            "frontierSha256": V11_FRONTIER_SHA256,
            "graphSha256": V11_GRAPH_SHA256,
            "sourceBindingsSha256": V11_SOURCE_BINDINGS_SHA256,
            "testsPath": V11_TESTS_PATH,
            "testsRawSha256": V11_TESTS_RAW_SHA256,
        ...
        and contract.get("requestCount") == 8
        and contract.get("tupleCount") == 4
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE13_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE13_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 8
        and receipt.get("modCount") == 4
        and receipt.get("zipCount") == 4
        and receipt.get("aggregateResponseBytes") == 5_097_538
        and receipt.get("aggregateModResponseBytes") == 411
        and receipt.get("aggregateZipResponseBytes") == 5_097_127
        and receipt.get("aggregateZipEntryCount") == 1_647
        and receipt.get("aggregateZipUncompressedBytes") == 20_065_482
    ...
    check(
        ...
        == {
            ...
            "receiptPath": WAVE13_RECEIPT_PATH,
            "receiptRawSha256": WAVE13_CONTROL_SHA256[WAVE13_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV11")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV11PredecessorBindingRecomputed",
                ...
                "exact8ResourceOrderAndAggregateRecomputed",
                "exact27FrozenFileSnapshotRequired",
                ...
                "v10TestsLiveHeld", "v11TestsLiveHeld",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE13_CONTENT_SHA256[WAVE13_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE13_READBACK_AUTHORITY
        ...
        is True
        and verification_contract.get("exact27FrozenFileSnapshotRequired")
        is True
        ...
        is False
        and verification_contract.get("v10TestsLiveHeld") is False
        and verification_contract.get("v11TestsLiveHeld") is True
        and verification_contract.get(
            "requestResourcesCanonicalSha256Recomputed"
        ) is True
        ...
        and snapshot.get("attemptId") == WAVE13_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE13_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE13_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE13_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-13-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 27
        and snapshot.get("frozenFilesCanonicalSha256")
        == WAVE13_FROZEN_FILE_SET_SHA256
        and snapshot.get("acceptedResourceCount") == 8
        and snapshot.get("selectedTupleCount") == 0
        and snapshot.get("selectedRequestOrdinals") == []
        and snapshot.get("modCount") == 4
        and snapshot.get("zipCount") == 4
        and snapshot.get("aggregateAcceptedBytes") == 5_097_538
        and snapshot.get("aggregateModBytes") == 411
        and snapshot.get("aggregateZipBytes") == 5_097_127
        and snapshot.get("aggregateZipEntryCount") == 1_647
        and snapshot.get("aggregateZipUncompressedBytes") == 20_065_482
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave13_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE13_RECEIPT_PATH,
            "rawSha256": WAVE13_CONTROL_SHA256[WAVE13_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE13_MANIFEST_PATH,
            "rawSha256": WAVE13_CONTROL_SHA256[WAVE13_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE13_ACCEPTED_DIRECTORY
        and accepted.get("mode") == "0700"
        and accepted.get("ownerUid") == os.geteuid()
        and accepted.get("linkCount") == 10
        and accepted.get("exactFileCount") == 8
        and type(accepted_files) is list
        and len(accepted_files) == 8
        and sha256_bytes(
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV11ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE13_CONTENT_SHA256[WAVE13_READBACK_PATH],
        }
        and readback.get("status")
        == "wave13_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE13_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE13_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_255,
            "contentSha256": WAVE13_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == "wave13_acquisition_retained_snapshot_independently_verified"
        ...
        and verified.get("acceptedResourceCount") == 8
        ...
        == 20_065_482
        and verified.get("combinedFixedPointV11ContentSha256")
        == V11_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE13_CONTENT_SHA256[
                WAVE13_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave13_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE13_ATTEMPT_ID
        ...
        == {
            "bytes": 7_315,
            "contentSha256": WAVE13_CONTENT_SHA256[WAVE13_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE13_READBACK_PATH,
            "rawSha256": WAVE13_CONTROL_SHA256[WAVE13_READBACK_PATH],
        }
    ...
    check(
        len(accepted_by_name) == 8
        and len(verified_by_name) == 8
        and len(identity_by_order) == 4,
        "E_WAVE13_RESOURCE",
    )
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave13-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE13_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v11.combined_source_bindings(
        v10,
        v9,
        v8,
        v7,
    ...
    bindings.extend(wave13_request_resources(v4, runner, wave13_documents))
    check(
        len(bindings) == 333
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 166
        and sum(row["kind"] == "zip" for row in bindings) == 166
    ...
    check(
        len({row["path"] for row in bindings}) == 333
        and len(
            {
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 167)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def derive_and_validate_tool_paths(
    ...
    declared_v11_paths = v11.TRANSITIVE_CHECKER_PATHS
    ...
    check(
        ...
        and type(declared_v11_paths) is set
        and declared_v11_paths
        == TRANSITIVE_CHECKER_PATHS - {V11_CHECKER_PATH}
        ...
        == len(
            declared_v11_paths
            | {V11_CHECKER_PATH, v11.V1_PROVIDER_PATH}
        )
    ...
    transitive_paths = direct_binding_paths | declared_v11_paths
    check(
        transitive_paths
...
def execute_reconstruction_protocol_prefix(
    ...
    validate_wave13_completed_namespace(control_held, wave13_documents)
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        v11 = load_v11_checker(v11_held)
        predecessor_candidate = v11.generate_candidate(root)
        v11 = harden_checker_module(v11)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                direct_tool_bindings = [
                    {
                        "role": "current_v12_combined_checker",
                        "path": SELF_PATH,
                ...
                check(
                    v11.PinnedCodeFile is PinnedCodeFile
                    ...
                    and len(direct_tool_paths) == 11
                    and len(transitive_tool_paths) == 13
                ...
                auxiliary_evidence = wave13_auxiliary_evidence_bindings()
                check(
                    len(controls) == 87
                ...
                with runner.HeldInputSet(
                    ...
                    wave13_documents = parse_wave13_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v11_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave13_documents[WAVE13_DECISION_PATH],
                        )
                    )
                    ...
                    wave13_evidence_raw = control_held.raw[WAVE13_EVIDENCE_PATH]
                    wave13_evidence_document = runner.strict_json(
                        wave13_evidence_raw,
                        WAVE13_EVIDENCE_PATH,
                    )
                    validate_wave13_evidence(
                        runner,
                        wave13_evidence_raw,
                        wave13_evidence_document,
                        wave13_documents,
                    )
                    validate_wave13_consumed_claims(
                        runner,
                        control_held.raw[WAVE13_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE13_READBACK_CLAIM_PATH],
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        limits = {
                            **v1.graph_limits(runner),
                            "maximumAggregateUncompressedBytes":
                                V12_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
                        }
                        ...
                        check(
                            first_coverage.get("archiveCount") == 167
                        ...
                        check(
                            ...
                            and sha256_bytes(wave13_digest_bytes(projection))
                            == V12_SOURCE_BINDINGS_SHA256,
                            "E_COMBINED_INPUT",
                        )
                        ...
                        body = {
                            ...
                            "result": (
                                "combined_graph_recomputed_twice_from_exact_"
                                "wave1_through_wave13_source_bytes"
                            ),
                            ...
                            "inputSet": {
                                ...
                                "uniqueModuleVersionTupleCount": 166,
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV11PredecessorExecuted": True,
                                ...
                                "wave13HistoricalExact27FrozenSnapshotDescriptorSetBound":
                                    True,
                                "wave13LiveTerminalControlMetadataVerified":
                                    True,
                                "wave13LiveFinalAndAcceptedInventoriesVerified":
                                    True,
                                "wave13FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave13RetainedFdPreManifestBarrierCount": 3,
                                "wave13CompletionAppliesToRetainedSnapshot":
                                    True,
                                "wave13CurrentPathIdentityGuaranteedThroughManifestPublication":
                                    False,
                                "wave13SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
                                    False,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave13-"
