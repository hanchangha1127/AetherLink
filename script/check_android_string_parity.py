...
REQUIRED_RELEASE_COPY_VALUES = {
    "values": {
        ...
        "error_regenerate_unavailable": "There is no completed assistant response to regenerate.",
        "memory_refresh_state_ready": "Ready to refresh memory.",
        "memory_added": "Memory added.",
        "auto_reconnect_state_pair_first": "Off. Pair with AetherLink Runtime before enabling auto reconnect.",
        "assistant_reasoning_label": "Thinking",
        "assistant_reasoning_state_shown": "Fully shown",
    ...
    "values-ko": {
        ...
        "error_regenerate_unavailable": "다시 생성할 완료된 어시스턴트 응답이 없습니다.",
        "memory_refresh_state_ready": "메모리를 새로고침할 준비가 되었습니다.",
        "memory_added": "메모리를 추가했습니다.",
        "auto_reconnect_state_pair_first": "꺼짐. 자동 재연결을 켜기 전에 AetherLink Runtime과 페어링하세요.",
        "assistant_reasoning_label": "생각",
        "assistant_reasoning_state_shown": "전체 표시됨",
    ...
    "values-ja": {
        ...
        "error_regenerate_unavailable": "再生成できる完了済みのアシスタント応答がありません。",
        "memory_refresh_state_ready": "メモリを更新できます。",
        "memory_added": "メモリを追加しました。",
        "auto_reconnect_state_pair_first": "オフ。自動再接続を有効にする前に AetherLink Runtime とペアリングしてください。",
        "assistant_reasoning_label": "思考",
        "assistant_reasoning_state_shown": "すべて表示済み",
    ...
    "values-zh-rCN": {
        ...
        "error_regenerate_unavailable": "没有可重新生成的已完成助手回复。",
        "memory_refresh_state_ready": "可以刷新记忆。",
        "memory_added": "已添加记忆。",
        "auto_reconnect_state_pair_first": "关闭。启用自动重新连接前，请先与 AetherLink Runtime 配对。",
        "assistant_reasoning_label": "思考",
        "assistant_reasoning_state_shown": "已完整显示",
    ...
    "values-fr": {
        ...
        "error_regenerate_unavailable": "Aucune réponse de l’assistant terminée ne peut être régénérée.",
        "memory_refresh_state_ready": "Prêt à actualiser la mémoire.",
        "memory_added": "Mémoire ajoutée.",
        "auto_reconnect_state_pair_first": "Désactivé. Jumelez AetherLink Runtime avant d’activer la reconnexion automatique.",
        "assistant_reasoning_label": "Réflexion",
        "assistant_reasoning_state_shown": "Entièrement affichée",
