#!/usr/bin/env python3
"""Recompute the exact 357-input Wave1..Wave16 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v14
combined checker, all Wave16 decision/acquisition/readback controls, and the
root archive plus 178 mod and 178 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v15 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v15.py"
...
WAVE16_CONTROL_SHA256 = {
    ...
    WAVE16_READBACK_PATH:
        "0c99847402f6c00638bd2c1a41c5ca34887dbc1e7a30b2decbae19a2fff74cec",
    WAVE16_READBACK_MANIFEST_PATH:
        "e92d202e7a11eaaeca39a0621e9ee7c74569cb644bcade0ac33c6cc3da262978",
}
WAVE16_CONTROL_METADATA = {
    WAVE16_DECISION_PATH: (12_963, 0o644),
    WAVE16_PERMIT_PATH: (17_751, 0o644),
    WAVE16_RECEIPT_PATH: (1_662, 0o600),
    WAVE16_MANIFEST_PATH: (465, 0o600),
    WAVE16_READBACK_PERMIT_PATH: (18_287, 0o644),
    WAVE16_READBACK_PATH: (6_500, 0o600),
    WAVE16_READBACK_MANIFEST_PATH: (2_301, 0o600),
}
WAVE16_CONTENT_SHA256 = {
    WAVE16_DECISION_PATH:
    ...
    WAVE16_READBACK_PATH:
        "6517805cd44879e1ac1f518d98328fa3d0e03d014134a594a3abb3874bf58304",
    WAVE16_READBACK_MANIFEST_PATH:
        "5b88ddbc25d0a2a759e242aacb8a198d8fa5d594f633c7d403afc5eb85eb1b18",
}
...
WAVE16_RESOURCE_SET_SHA256 = (
    "f80997e5ef21d4b556667abc2fa016785bcd234dc7a79dc028f70c7d35a36159"
)
WAVE16_FROZEN_FILE_SET_SHA256 = (
    "b8863a58dd5db814afe94eb101c166e4f5bfb92d9b8197dbe3e32a3b1f0e99c4"
)
WAVE16_ATTEMPT_ID = "fff8d6073748eab6fd1a05c79c57a84f"
WAVE16_READBACK_ATTEMPT_ID = "e7c555246489b1ccd63bf3aca3e27c2f"
WAVE16_COMPACT_IDENTITY_SHA256 = (
    "c26e87fc8722908203c01bdc91fadc26637731792301994820164a2c2c8333de"
)
WAVE16_FULL_WITNESS_SHA256 = (
    "f93d6a39cf668889fc555db8c4bebac264a1f24548f7dd7549a064b049ff14ec"
)
WAVE16_HELD_SOURCE_BINDINGS_SHA256 = (
    "a360afdc5d94502f53f5e393503198bb7ce6adf4d21a0c64245a1b7e49be9eae"
)
WAVE16_ACQUISITION_CLAIM_RAW_SHA256 = (
    "df97f5d9bf8c56f3bbf08635b8332bbc18b25babd0e5f35742fee3657555f4b8"
)
WAVE16_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "a9f913231b9008cc29726831e4bccac2c0fd8b5dd8a07b2ab29addfba579efef"
)
WAVE16_ACQUISITION_CHECKER_RAW_SHA256 = (
    "a153df4c254987ed8b214449333ba56bc5af3612e4eb03f875567498bd58fa48"
)
WAVE16_ACQUISITION_RUNNER_RAW_SHA256 = (
    "2af2c059ad4540516d063caa22f062082db6656d81eebcfdc9422499ea7ed309"
)
WAVE16_READBACK_CLAIM_RAW_SHA256 = (
    "41131c65cdb28b6a69ef360ce8ac5218963375adcef76781c152e303321132f5"
)
WAVE16_READBACK_CLAIM_CONTENT_SHA256 = (
    "16623748f4b14e8c83a8054395318db24225b1f6698c8ba537fd4b769ba8738b"
)
WAVE16_READBACK_CHECKER_RAW_SHA256 = (
    "09f1910aed95d76c20c3ea177b88ba81f8149f29b0c75f2cf1760e162394cebc"
)
WAVE16_READBACK_RECORDER_RAW_SHA256 = (
    "c66702b9938fa026cec68f18fae31e8b58fbeceb8e28e6078c851a54372b7ade"
)
WAVE16_READBACK_RECORDER_NORMALIZED_SHA256 = (
    "0c2e541839f6d83013532e5b7c90f01022a582ab93331fd86866e9c637f3e940"
)
WAVE16_RETAINED_BARRIERS = [
...
WAVE16_ABSOLUTE_RESOURCE_LIMITS = {
...
WAVE16_READBACK_RESOURCE_LIMITS = {
...
WAVE16_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave16_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE16_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE16_CONTENT_SHA256[WAVE16_READBACK_PERMIT_PATH],
        "path": WAVE16_READBACK_PERMIT_PATH,
        "rawSha256": WAVE16_CONTROL_SHA256[WAVE16_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
        ...
        "rawSha256": WAVE16_READBACK_RECORDER_RAW_SHA256,
    },
}
WAVE16_DECISION_TOOL_BINDINGS = [
    {
        "normalizedSha256":
...
WAVE16_ACQUISITION_TOOL_BINDINGS = [
    {
        "path":
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave16_acquisition_v1.py",
        "rawSha256": WAVE16_ACQUISITION_CHECKER_RAW_SHA256,
    },
    {
        "path":
    ...
    },
    {
        ...
        "rawSha256": WAVE16_ACQUISITION_RUNNER_RAW_SHA256,
    },
    {
        "path":
...
WAVE16_READBACK_TOOL_BINDINGS = [
    WAVE16_READBACK_AUTHORITY_BINDING["checker"],
    {
        "path": (
        ...
        "rawSha256":
            "727804ccedf884d750ba18af382d2c54ff222136fce65e77a5990f51cd6b74de",
    },
    WAVE16_READBACK_AUTHORITY_BINDING["recorder"],
    {
        "path": (
        ...
        "rawSha256":
            "6e9e9805415925ea63a4d4a2141a9926becbea51546fe0a4af11baff6de0c52b",
    },
]
...
def wave16_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v15_safe_hardened") is True:
        return module
    module.__dict__["_v15_safe_hardened"] = True
...
def wave16_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE16_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE16_CONTROL_SHA256.items()
    ]


def parse_wave16_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE16_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE16_JSON")
        result[path] = value
    return result


def wave16_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE16_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE16_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 416,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE16_EVIDENCE_PATH,
            "rawSha256": WAVE16_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 2_620,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE16_READBACK_CLAIM_PATH,
            "rawSha256": WAVE16_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_255,
            "ownerOnly": True,
...
def validate_wave16_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE16_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE16_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE16_EVIDENCE_PATH]
    readback = control_held.files[WAVE16_READBACK_PATH]
    readback_manifest = control_held.files[WAVE16_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE16_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE16_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE16_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE16_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE16_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE16_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE16_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE16_READBACK_PERMIT_PATH]
    ...
    check(
        ...
        and all(
            Path(row["path"]).parent.as_posix() == WAVE16_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE16_NAMESPACE",
    )
...
def validate_wave16_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE16_ATTEMPT_ID,
            "checkerRawSha256": WAVE16_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave16-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE16_CONTENT_SHA256[WAVE16_PERMIT_PATH],
            "requestCount": 6,
            "schemaVersion": "1.0",
            "status": "consumed_active",
            "userActionRequired": False,
        },
        "E_WAVE16_ACQUISITION_CLAIM",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE16_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE16_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE16_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE16_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE16_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave16-acquisition-readback-one-use-claim"
        ...
        "E_WAVE16_READBACK_CLAIM",
    )


def validate_wave16_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE16_EVIDENCE")
    readback = documents[WAVE16_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE16_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave16-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE16_ATTEMPT_ID
        and evidence_document.get("requestCount") == 6
        and evidence_document.get("aggregateResponseBytes") == 11_475_644
        and evidence_document.get("aggregateModResponseBytes") == 452
        and evidence_document.get("aggregateZipResponseBytes") == 11_475_192
        and evidence_document.get("aggregateZipEntryCount") == 948
...
def verify_wave16_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE16_DECISION_PATH],
        WAVE16_CONTENT_SHA256[WAVE16_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE16_PERMIT_PATH],
        WAVE16_CONTENT_SHA256[WAVE16_PERMIT_PATH],
...
def validate_v14_predecessor_candidate(
    ...
    check(
        ...
        and predecessor.get("frontierTupleCount") == 3
        ...
        and predecessor.get("totalFullSourceReconstructionCount") == 26
        and predecessor.get("totalGraphArchiveOpenCount") == 3_338
        ...
        == V14_INPUT_SET_SHA256
        and sha256_bytes(wave16_digest_bytes(source_bindings))
        == V14_SOURCE_BINDINGS_SHA256
        ...
        == V14_FRONTIER_SHA256
        and candidate.get("authority") == V14_AUTHORITY
        and candidate.get("checkerVerification", {}).get(
...
def wave16_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE16_DECISION_PATH]
    permit = documents[WAVE16_PERMIT_PATH]
    receipt = documents[WAVE16_RECEIPT_PATH]
    manifest = documents[WAVE16_MANIFEST_PATH]
    readback_permit = documents[WAVE16_READBACK_PERMIT_PATH]
    readback = documents[WAVE16_READBACK_PATH]
    readback_manifest = documents[WAVE16_READBACK_MANIFEST_PATH]
    verify_wave16_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE16_CONTENT_SHA256[WAVE16_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave16_exact_3_frontier_identity_classified_3_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and decision.get("authority") == WAVE16_DECISION_AUTHORITY
        and decision.get("toolBindings") == WAVE16_DECISION_TOOL_BINDINGS
        and type(resolution) is dict
        and resolution.get("tupleCount") == 3
        and resolution.get("completeIdentityPairCount") == 3
        and resolution.get("blockedTupleCount") == 0
        and resolution.get("graphSelectedTupleCount") == 0
        and resolution.get("versionSpecificNonSelectedTupleCount") == 3
        and resolution.get("compactIdentitySha256")
        == WAVE16_COMPACT_IDENTITY_SHA256
        and resolution.get("fullWitnessSha256")
        == WAVE16_FULL_WITNESS_SHA256
        and type(held_set) is dict
        and held_set.get("sourceBindingCount") == 351
        and held_set.get("archiveCount") == 176
        and held_set.get("embeddedRootGoModCount") == 1
        and held_set.get("externalModCount") == 175
        and held_set.get("goSumEntryCount") == 123
        ...
        and sha256_bytes(wave16_digest_bytes(source_requests))
        == WAVE16_REQUEST_SET_SHA256,
        "E_WAVE16_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE16_CONTENT_SHA256[WAVE16_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE16_ACQUISITION_AUTHORITY
        and permit.get("toolBindings") == WAVE16_ACQUISITION_TOOL_BINDINGS
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE16_CONTROL_SHA256[WAVE16_DECISION_PATH]
        ...
        == WAVE16_ABSOLUTE_RESOURCE_LIMITS
        and permit.get("zipLimits") == WAVE16_ZIP_LIMITS
        and permit_predecessor
        == {
            "checkerNormalizedSha256": V14_CHECKER_NORMALIZED_SHA256,
        ...
        and contract.get("requestCount") == 6
        and contract.get("tupleCount") == 3
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE16_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE16_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 6
        and receipt.get("modCount") == 3
        and receipt.get("zipCount") == 3
        and receipt.get("requestCount") == 6
        and receipt.get("dispatchBoundaryCount") == 6
        and receipt.get("responseCommittedCount") == 6
        and receipt.get("validationCommittedCount") == 6
        and receipt.get("persistenceCommittedCount") == 6
        and receipt.get("aggregateResponseBytes") == 11_475_644
        and receipt.get("aggregateModResponseBytes") == 452
        and receipt.get("aggregateZipResponseBytes") == 11_475_192
        and receipt.get("aggregateZipEntryCount") == 948
        and receipt.get("aggregateZipUncompressedBytes") == 46_464_212
    ...
    check(
        ...
        == {
            "attemptId": WAVE16_ATTEMPT_ID,
            "documentType": "aetherlink.wave16-source-acquisition-manifest",
            "manifestWrittenLast": True,
            "receiptPath": WAVE16_RECEIPT_PATH,
            "receiptRawSha256": WAVE16_CONTROL_SHA256[WAVE16_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV14")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV14PredecessorBindingRecomputed",
                ...
                "v13TestsLiveHeld", "v14TestsLiveHeld",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE16_CONTENT_SHA256[WAVE16_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE16_READBACK_AUTHORITY
        ...
        is False
        and verification_contract.get("v13TestsLiveHeld") is False
        and verification_contract.get("v14TestsLiveHeld") is True
        and verification_contract.get(
            "requestResourcesCanonicalSha256Recomputed"
        ) is True
        ...
        and snapshot.get("attemptId") == WAVE16_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE16_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE16_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE16_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-16-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 25
        and snapshot.get("frozenFilesCanonicalSha256")
        == WAVE16_FROZEN_FILE_SET_SHA256
        and snapshot.get("acceptedResourceCount") == 6
        and snapshot.get("selectedTupleCount") == 0
        and snapshot.get("selectedRequestOrdinals") == []
        and snapshot.get("modCount") == 3
        and snapshot.get("zipCount") == 3
        and snapshot.get("aggregateAcceptedBytes") == 11_475_644
        and snapshot.get("aggregateModBytes") == 452
        and snapshot.get("aggregateZipBytes") == 11_475_192
        and snapshot.get("aggregateZipEntryCount") == 948
        and snapshot.get("aggregateZipUncompressedBytes") == 46_464_212
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave16_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE16_RECEIPT_PATH,
            "rawSha256": WAVE16_CONTROL_SHA256[WAVE16_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE16_MANIFEST_PATH,
            "rawSha256": WAVE16_CONTROL_SHA256[WAVE16_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE16_ACCEPTED_DIRECTORY
        and accepted.get("mode") == "0700"
        and accepted.get("ownerUid") == os.geteuid()
        and accepted.get("linkCount") == 8
        and accepted.get("exactFileCount") == 6
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV14ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE16_CONTENT_SHA256[WAVE16_READBACK_PATH],
        }
        and readback.get("status")
        == "wave16_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE16_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE16_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_255,
            "contentSha256": WAVE16_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == "wave16_acquisition_retained_snapshot_independently_verified"
        ...
        == 46_464_212
        and verified.get("combinedFixedPointV14ContentSha256")
        == V14_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE16_CONTENT_SHA256[
                WAVE16_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave16_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE16_ATTEMPT_ID
        ...
        == {
            "bytes": 6_500,
            "contentSha256": WAVE16_CONTENT_SHA256[WAVE16_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE16_READBACK_PATH,
            "rawSha256": WAVE16_CONTROL_SHA256[WAVE16_READBACK_PATH],
        }
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave16-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE16_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v14.combined_source_bindings(
        v13,
        v12,
        v11,
        v10,
    ...
    bindings.extend(wave16_request_resources(v4, runner, wave16_documents))
    check(
        len(bindings) == 357
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 178
        and sum(row["kind"] == "zip" for row in bindings) == 178
    ...
    check(
        len({row["path"] for row in bindings}) == 357
        and len(
            {
                (row["module"], row["version"])
                for row in bindings
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 179)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def derive_and_validate_tool_paths(
    ...
    declared_v14_paths = v14.TRANSITIVE_CHECKER_PATHS
    ...
    check(
        ...
        and type(declared_v14_paths) is set
        and declared_v14_paths
        == TRANSITIVE_CHECKER_PATHS - {V14_CHECKER_PATH}
        ...
        == len(
            declared_v14_paths
            | {V14_CHECKER_PATH, v14.V1_PROVIDER_PATH}
        )
    ...
    transitive_paths = direct_binding_paths | declared_v14_paths
    check(
        transitive_paths
...
def execute_reconstruction_protocol_prefix(
    ...
    validate_wave16_completed_namespace(control_held, wave16_documents)
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        predecessor_candidate = v14.generate_candidate(root)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                check(
                    v14.PinnedCodeFile is PinnedCodeFile
                    ...
                    and len(direct_tool_paths) == 14
                    and len(transitive_tool_paths) == 16
                ...
                auxiliary_evidence = wave16_auxiliary_evidence_bindings()
                check(
                    len(controls) == 108
                ...
                with runner.HeldInputSet(
                    ...
                    wave16_documents = parse_wave16_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v14_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave16_documents[WAVE16_DECISION_PATH],
                        )
                    )
                    ...
                    wave16_evidence_raw = control_held.raw[WAVE16_EVIDENCE_PATH]
                    wave16_evidence_document = runner.strict_json(
                        wave16_evidence_raw,
                        WAVE16_EVIDENCE_PATH,
                    )
                    validate_wave16_evidence(
                        runner,
                        wave16_evidence_raw,
                        wave16_evidence_document,
                        wave16_documents,
                    )
                    validate_wave16_consumed_claims(
                        runner,
                        control_held.raw[WAVE16_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE16_READBACK_CLAIM_PATH],
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        limits = {
                            **v1.graph_limits(runner),
                            "maximumAggregateUncompressedBytes":
                                V15_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
                        }
                        ...
                        check(
                            first_coverage.get("archiveCount") == 179
                        ...
                        check(
                            ...
                            and sha256_bytes(wave16_digest_bytes(projection))
                            == V15_SOURCE_BINDINGS_SHA256,
                            "E_COMBINED_INPUT",
                        )
                        ...
                        body = {
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV14PredecessorExecuted": True,
                                ...
                                "wave16FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave16RetainedFdPreManifestBarrierCount": 3,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave16-"
