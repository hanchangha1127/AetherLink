#!/usr/bin/env python3
"""Record one independent offline readback of the Wave13 v1 acquisition."""
...
if not (
    ...
    raise RuntimeError("Wave13 readback recorder requires `python3 -I -B -S`")
...
if O_NOFOLLOW is None:
    raise RuntimeError("Wave13 readback recorder requires O_NOFOLLOW")
READBACK_CHECKER_PATH = Path(__file__).with_name(
    "check_p2p_nat_g2_pion_rung3_dependency_wave13_"
    "readback_execution_permit_v1.py"
)
EXPECTED_READBACK_CHECKER_RAW = "8f9bec0f04c4c7a6436c9f9e286419e5296c6e47193ca50f64603fd95a602dbb"
...
def load_readback_checker() -> types.ModuleType:
    ...
    module = types.ModuleType("wave13_acquisition_readback_permit_v1")
...
def verify_snapshot(snapshot: FrozenSnapshot) -> dict[str, Any]:
    ...
    permit_path = (
        PERMIT.BASE
        + "/bounded-dependency-source-acquisition-wave13-execution-permit-v1.json"
    )
    ...
    v11 = acquisition_permit["predecessorBindings"]["combinedFixedPointV11"]
    predecessor_authority_rows = [
        {
            "path": v11["checkerPath"],
            "rawSha256": v11["checkerRawSha256"],
        },
        {
            "path": v11["testsPath"],
            "rawSha256": v11["testsRawSha256"],
        },
    ]
    bound_authority_rows = [
        *acquisition_permit["decisionBinding"]["files"],
        *predecessor_authority_rows,
        v11["wave12NamespaceAnchor"],
    ...
    require(
        ...
        == {
            ...
            "checkerNormalizedSha256": (
                PERMIT.EXPECTED_V11_CHECKER_NORMALIZED
            ),
            "testsPath": (
            ...
            "contentSha256": PERMIT.EXPECTED_V11_CONTENT,
            "combinedInputSetSha256": PERMIT.EXPECTED_V11_INPUT_SET,
            "graphSha256": PERMIT.EXPECTED_V11_GRAPH,
            "frontierSha256": PERMIT.EXPECTED_V11_FRONTIER,
    ...
    require(
        len(mod_by_tuple) == 4
        and aggregate_mod == 411
        and aggregate_zip == 5_097_127
        and aggregate == 5_097_538
        and aggregate_zip_entries == 1_647
        and aggregate_zip_uncompressed == 20_065_482
    ...
    return {
        ...
        "combinedFixedPointV11ContentSha256": PERMIT.EXPECTED_V11_CONTENT,
        "compactIdentitySha256": PERMIT.EXPECTED_COMPACT_IDENTITY,
        "fullWitnessSha256": PERMIT.EXPECTED_FULL_WITNESS,
...
def create_readback_claim(
    ...
    claim = content_bound(
        {
            "documentType": "aetherlink.wave13-acquisition-readback-one-use-claim",
            "schemaVersion": "1.0",
            "status": "consumed_active",
    ...
    try:
        ...
        try:
            ...
            receipt = content_bound(
                {
                    "documentType": "aetherlink.wave13-source-acquisition-readback",
                    "schemaVersion": "1.0",
                    "status": (
                        "wave13_acquisition_retained_snapshot_"
            ...
            manifest = content_bound(
                {
                    "documentType": (
                        "aetherlink.wave13-source-acquisition-readback-manifest"
                    ),
                    "schemaVersion": "1.0",
                    "status": (
                        "wave13_acquisition_retained_snapshot_"
...
def _post_success_reporting_failure() -> dict[str, Any]:
    return {
        "documentType": "aetherlink.wave13-acquisition-readback-error",
        "schemaVersion": "1.0",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.preflight:
            preflight()
            result = {
                "documentType": "aetherlink.wave13-acquisition-readback-preflight",
                "schemaVersion": "1.0",
