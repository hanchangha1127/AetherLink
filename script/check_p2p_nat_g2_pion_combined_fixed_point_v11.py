#!/usr/bin/env python3
"""Recompute the exact 325-input Wave1..Wave12 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v10
combined checker, all Wave12 decision/acquisition/readback controls, and the
root archive plus 162 mod and 162 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v11 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v11.py"
...
CHECKER_ID = (
    ...
    "wave7-wave8-wave9-wave10-wave11-wave12-check-v11"
)
...
WAVE12_CONTROL_METADATA = {
    WAVE12_DECISION_PATH: (14_363, 0o644),
    WAVE12_PERMIT_PATH: (18_704, 0o644),
    WAVE12_RECEIPT_PATH: (1_663, 0o600),
    WAVE12_MANIFEST_PATH: (465, 0o600),
    WAVE12_READBACK_PERMIT_PATH: (18_385, 0o644),
    WAVE12_READBACK_PATH: (7_265, 0o600),
    WAVE12_READBACK_MANIFEST_PATH: (2_301, 0o600),
}
WAVE12_CONTENT_SHA256 = {
    WAVE12_DECISION_PATH:
    ...
    WAVE12_READBACK_PATH:
        "5f8f3f70cf8c133196dd9632b850d696a4eb18da1096fe40f942315c0000c31f",
    WAVE12_READBACK_MANIFEST_PATH:
        "67b4c2b3284fac10cc95e27675050316955dbfa842c37effc2e5d8474943c4ba",
}
...
WAVE12_RESOURCE_SET_SHA256 = (
    "38e9b110d8857fe1644a8fc80bb4a584da540981d43ee19b62e3e9e845422a2c"
)
WAVE12_FROZEN_FILE_SET_SHA256 = (
    "3d7365fd16905b8fb3c3d8682e8803c5487b120b3ba8f49b75d16eba2bc354fd"
)
WAVE12_ATTEMPT_ID = "f977ddcf8fc391e5915048b930beccbd"
WAVE12_READBACK_ATTEMPT_ID = "32ab6b747a02382f85f48f65e0c388c5"
WAVE12_COMPACT_IDENTITY_SHA256 = (
    "23b6b188a88c5bdb87abe99325ec7a6d4580605ca69869f2614e36e134c07752"
)
WAVE12_FULL_WITNESS_SHA256 = (
    "2b13a602a2faf12ea2eb5f6d578a562033148ccded4035799756d969b96bdfa0"
)
WAVE12_HELD_SOURCE_BINDINGS_SHA256 = (
    "067808934056712884a75ea669d61189bb5d5d722d2a961c8b8c5d25345bb75c"
)
WAVE12_ACQUISITION_CLAIM_RAW_SHA256 = (
    "58145cf6660a9a6c3ed5ab36ec4f38df388e88d10c5a1e6820ca9416f06b8280"
)
WAVE12_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "edb157c04b1255d87717ef41c2b890115030dfa2800574f7cd34f60d8d1ec251"
)
WAVE12_ACQUISITION_CHECKER_RAW_SHA256 = (
    "b00ea74bf16e02d429ecf9130ac15ffba9b594a0ae105aa620cd2439cda9bcc1"
)
WAVE12_ACQUISITION_RUNNER_RAW_SHA256 = (
    "d954a733dafdb9296d79a5a1bb81d7801393dc8063fcee2a70e41bf85f6961c9"
)
WAVE12_READBACK_CLAIM_RAW_SHA256 = (
    "e7f2cfb9e69533f23f8091ab87c1012e11939cd29717f29a982af7e960d436bc"
)
WAVE12_READBACK_CLAIM_CONTENT_SHA256 = (
    "ae124d323bf22e67026fb93cd7c8c6b61f52ce5fdd456c819bc654aa672e6478"
)
WAVE12_READBACK_CHECKER_RAW_SHA256 = (
    "0f0d410e7fc49e6d08108db117cfc384d506edb5a3a67dede3d1738282dff5b9"
)
WAVE12_READBACK_RECORDER_RAW_SHA256 = (
    "f5f1926227d11967b5f6bddbaebee44c62aaa5ec3c7a945bf7e2b30af71b088a"
)
WAVE12_READBACK_RECORDER_NORMALIZED_SHA256 = (
    "5b382858194540404f87e79cb5f2f3ff400fe3e58425f83f3a8179c561a75a8f"
)
WAVE12_RETAINED_BARRIERS = [
...
WAVE12_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave12_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE12_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE12_CONTENT_SHA256[WAVE12_READBACK_PERMIT_PATH],
        "path": WAVE12_READBACK_PERMIT_PATH,
        "rawSha256": WAVE12_CONTROL_SHA256[WAVE12_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
        ...
        "rawSha256": WAVE12_READBACK_RECORDER_RAW_SHA256,
    },
}
WAVE12_DECISION_TOOL_BINDINGS = [
    {
        "normalizedSha256":
...
WAVE12_ACQUISITION_TOOL_BINDINGS = [
    {
        "path":
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave12_acquisition_v1.py",
        "rawSha256": WAVE12_ACQUISITION_CHECKER_RAW_SHA256,
    },
    {
        "path":
    ...
    },
    {
        ...
        "rawSha256": WAVE12_ACQUISITION_RUNNER_RAW_SHA256,
    },
    {
        "path":
...
WAVE12_READBACK_TOOL_BINDINGS = [
    WAVE12_READBACK_AUTHORITY_BINDING["checker"],
    {
        "path": (
        ...
        "rawSha256":
            "0f4fb148736b913d65f2158fc305f80e6db7ef4143d12d6b2da491952dd1449e",
    },
    WAVE12_READBACK_AUTHORITY_BINDING["recorder"],
    {
        "path": (
        ...
        "rawSha256":
            "bd05044347431572c7c4e8398095b6db91dc334485a2fbcce1015f8a6f4e8168",
    },
]
...
def wave12_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v11_safe_hardened") is True:
        return module
    module.__dict__["_v11_safe_hardened"] = True
...
def wave12_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE12_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE12_CONTROL_SHA256.items()
    ]


def parse_wave12_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE12_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE12_JSON")
        result[path] = value
    return result


def wave12_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE12_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE12_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 416,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE12_EVIDENCE_PATH,
            "rawSha256": WAVE12_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 3_385,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE12_READBACK_CLAIM_PATH,
            "rawSha256": WAVE12_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_255,
            "ownerOnly": True,
...
def validate_wave12_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE12_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE12_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE12_EVIDENCE_PATH]
    readback = control_held.files[WAVE12_READBACK_PATH]
    readback_manifest = control_held.files[WAVE12_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE12_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE12_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE12_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE12_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE12_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE12_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE12_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE12_READBACK_PERMIT_PATH]
    ...
    check(
        ...
        and all(
            Path(row["path"]).parent.as_posix() == WAVE12_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE12_NAMESPACE",
    )
...
def validate_wave12_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE12_ATTEMPT_ID,
            "checkerRawSha256": WAVE12_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave12-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE12_CONTENT_SHA256[WAVE12_PERMIT_PATH],
            "requestCount": 8,
            "schemaVersion": "1.0",
            "status": "consumed_active",
            "userActionRequired": False,
        },
        "E_WAVE12_ACQUISITION_CLAIM",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE12_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE12_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE12_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE12_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE12_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave12-acquisition-readback-one-use-claim"
        ...
        "E_WAVE12_READBACK_CLAIM",
    )


def validate_wave12_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE12_EVIDENCE")
    readback = documents[WAVE12_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE12_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave12-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE12_ATTEMPT_ID
        and evidence_document.get("requestCount") == 8
        and evidence_document.get("aggregateResponseBytes") == 15_036_269
        and evidence_document.get("aggregateModResponseBytes") == 753
        and evidence_document.get("aggregateZipResponseBytes") == 15_035_516
        and evidence_document.get("aggregateZipEntryCount") == 2_547
...
def verify_wave12_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE12_DECISION_PATH],
        WAVE12_CONTENT_SHA256[WAVE12_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE12_PERMIT_PATH],
        WAVE12_CONTENT_SHA256[WAVE12_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE12_CONTENT_SHA256[path],
        )


def validate_v10_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == V10_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V10_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V10_FRONTIER_SHA256
        and predecessor.get("frontierTupleCount") == 4
        and predecessor.get("fixedPointReached") is False
        and predecessor.get("checkerPath") == V10_CHECKER_PATH
        and predecessor.get("checkerRawSha256") == V10_CHECKER_RAW_SHA256
        and predecessor.get("checkerNormalizedSha256")
        == V10_CHECKER_NORMALIZED_SHA256
        and predecessor.get("testsPath") == V10_TESTS_PATH
        and predecessor.get("testsRawSha256") == V10_TESTS_RAW_SHA256
        and predecessor.get("totalFullSourceReconstructionCount") == 18
        and predecessor.get("totalGraphArchiveOpenCount") == 1_984
        ...
        and predecessor.get("v9TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and predecessor.get("v9TestsLiveHeld") is False
        ...
        == {
            ...
            "finalNamespaceReverifiedAfterCombinedV10Reconstruction": True,
            "historicalExact36FrozenSnapshotDescriptorSetBound": True,
            "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV10Barrier":
                True,
            "liveTerminalControlMetadataVerifiedAtCombinedV10Barrier": True,
        ...
        == (
            ...
            "wave5-wave6-wave7-wave8-wave9-wave10-wave11-"
        ...
        and inputs.get("combinedInputSetSha256") == V10_INPUT_SET_SHA256
        and sha256_bytes(runner.canonical_json_bytes(source_bindings))
        == V10_INPUT_SET_SHA256
        and sha256_bytes(wave12_digest_bytes(source_bindings))
        == V10_SOURCE_BINDINGS_SHA256
        and len({row["path"] for row in source_bindings}) == 317
        and sum(row["kind"] == "root_zip" for row in source_bindings) == 1
        and sum(row["kind"] == "mod" for row in source_bindings) == 158
        and sum(row["kind"] == "zip" for row in source_bindings) == 158
        ...
        == V10_FRONTIER_SHA256
        and candidate.get("authority") == V10_AUTHORITY,
        "E_V10_PREDECESSOR",
    )
    return {
        ...
        "wave11CompletionAppliesToRetainedSnapshot": True,
        "wave11CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave11SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
        "v10TestsBindingScope": "historical_metadata_only_not_live_held",
        "v10TestsLiveHeld": False,
    }


def wave12_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE12_DECISION_PATH]
    permit = documents[WAVE12_PERMIT_PATH]
    receipt = documents[WAVE12_RECEIPT_PATH]
    manifest = documents[WAVE12_MANIFEST_PATH]
    readback_permit = documents[WAVE12_READBACK_PERMIT_PATH]
    readback = documents[WAVE12_READBACK_PATH]
    readback_manifest = documents[WAVE12_READBACK_MANIFEST_PATH]
    verify_wave12_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE12_CONTENT_SHA256[WAVE12_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave12_exact_4_frontier_identity_classified_4_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and decision.get("authority") == WAVE12_DECISION_AUTHORITY
        and decision.get("toolBindings") == WAVE12_DECISION_TOOL_BINDINGS
        ...
        and held_set.get("sourceBindingCount") == 317
        ...
        and sha256_bytes(wave12_digest_bytes(source_requests))
        == WAVE12_REQUEST_SET_SHA256,
        "E_WAVE12_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE12_CONTENT_SHA256[WAVE12_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE12_ACQUISITION_AUTHORITY
        and permit.get("toolBindings") == WAVE12_ACQUISITION_TOOL_BINDINGS
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE12_CONTROL_SHA256[WAVE12_DECISION_PATH]
        ...
        == {
            "checkerNormalizedSha256": V10_CHECKER_NORMALIZED_SHA256,
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE12_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE12_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 8
        and receipt.get("modCount") == 4
        and receipt.get("zipCount") == 4
        and receipt.get("aggregateResponseBytes") == 15_036_269
        and receipt.get("aggregateModResponseBytes") == 753
        and receipt.get("aggregateZipResponseBytes") == 15_035_516
        and receipt.get("aggregateZipEntryCount") == 2_547
        and receipt.get("aggregateZipUncompressedBytes") == 55_940_531
    ...
    check(
        ...
        == {
            "attemptId": WAVE12_ATTEMPT_ID,
            "documentType": "aetherlink.wave12-source-acquisition-manifest",
            "manifestWrittenLast": True,
            "receiptPath": WAVE12_RECEIPT_PATH,
            "receiptRawSha256": WAVE12_CONTROL_SHA256[WAVE12_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV10")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV10PredecessorBindingRecomputed",
                ...
                "exact26FrozenFileSnapshotRequired",
                ...
                "v10TestsLiveHeld", "v9TestsLiveHeld",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE12_CONTENT_SHA256[WAVE12_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE12_READBACK_AUTHORITY
        ...
        is True
        and verification_contract.get("exact26FrozenFileSnapshotRequired")
        is True
        ...
        is False
        and verification_contract.get("v9TestsLiveHeld") is False
        and verification_contract.get("v10TestsLiveHeld") is True
        and verification_contract.get(
            "requestResourcesCanonicalSha256Recomputed"
        ) is True
        ...
        and snapshot.get("attemptId") == WAVE12_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE12_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE12_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE12_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-12-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 26
        ...
        and snapshot.get("aggregateAcceptedBytes") == 15_036_269
        and snapshot.get("aggregateModBytes") == 753
        and snapshot.get("aggregateZipBytes") == 15_035_516
        and snapshot.get("aggregateZipEntryCount") == 2_547
        and snapshot.get("aggregateZipUncompressedBytes") == 55_940_531
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave12_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE12_RECEIPT_PATH,
            "rawSha256": WAVE12_CONTROL_SHA256[WAVE12_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE12_MANIFEST_PATH,
            "rawSha256": WAVE12_CONTROL_SHA256[WAVE12_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE12_ACCEPTED_DIRECTORY
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV10ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE12_CONTENT_SHA256[WAVE12_READBACK_PATH],
        }
        and readback.get("status")
        == "wave12_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE12_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE12_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_255,
            "contentSha256": WAVE12_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == "wave12_acquisition_retained_snapshot_independently_verified"
        ...
        == 55_940_531
        and verified.get("combinedFixedPointV10ContentSha256")
        == V10_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE12_CONTENT_SHA256[
                WAVE12_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave12_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE12_ATTEMPT_ID
        ...
        == {
            "bytes": 7_265,
            "contentSha256": WAVE12_CONTENT_SHA256[WAVE12_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE12_READBACK_PATH,
            "rawSha256": WAVE12_CONTROL_SHA256[WAVE12_READBACK_PATH],
        }
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave12-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE12_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v10.combined_source_bindings(
        v9,
        v8,
        v7,
        v6,
    ...
    bindings.extend(wave12_request_resources(v4, runner, wave12_documents))
    check(
        len(bindings) == 325
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 162
        and sum(row["kind"] == "zip" for row in bindings) == 162
    ...
    check(
        len({row["path"] for row in bindings}) == 325
        and len(
            {
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 163)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def derive_and_validate_tool_paths(
    ...
    declared_v10_paths = v10.TRANSITIVE_CHECKER_PATHS
    ...
    check(
        ...
        and type(declared_v10_paths) is set
        and declared_v10_paths
        == TRANSITIVE_CHECKER_PATHS - {V10_CHECKER_PATH}
        ...
        == len(
            declared_v10_paths
            | {V10_CHECKER_PATH, v10.V1_PROVIDER_PATH}
        )
    ...
    transitive_paths = direct_binding_paths | declared_v10_paths
    check(
        transitive_paths
...
def execute_reconstruction_protocol_prefix(
    ...
    validate_wave12_completed_namespace(control_held, wave12_documents)
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        predecessor_candidate = v10.generate_candidate(root)
        v10 = harden_checker_module(v10)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                check(
                    v10.PinnedCodeFile is PinnedCodeFile
                ...
                auxiliary_evidence = wave12_auxiliary_evidence_bindings()
                check(
                    len(controls) == 80
                ...
                with runner.HeldInputSet(
                    ...
                    wave12_documents = parse_wave12_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v10_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave12_documents[WAVE12_DECISION_PATH],
                        )
                    )
                    ...
                    wave12_evidence_raw = control_held.raw[WAVE12_EVIDENCE_PATH]
                    wave12_evidence_document = runner.strict_json(
                        wave12_evidence_raw,
                        WAVE12_EVIDENCE_PATH,
                    )
                    validate_wave12_evidence(
                        runner,
                        wave12_evidence_raw,
                        wave12_evidence_document,
                        wave12_documents,
                    )
                    validate_wave12_consumed_claims(
                        runner,
                        control_held.raw[WAVE12_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE12_READBACK_CLAIM_PATH],
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        limits = {
                            **v1.graph_limits(runner),
                            "maximumAggregateUncompressedBytes":
                                V11_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
                        }
                        ...
                        check(
                            ...
                            and sha256_bytes(wave12_digest_bytes(projection))
                            == V11_SOURCE_BINDINGS_SHA256,
                            "E_COMBINED_INPUT",
                        )
                        ...
                        body = {
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV10PredecessorExecuted": True,
                                ...
                                "wave12HistoricalExact26FrozenSnapshotDescriptorSetBound":
                                    True,
                                "wave12LiveTerminalControlMetadataVerified":
                                    True,
                                "wave12LiveFinalAndAcceptedInventoriesVerified":
                                    True,
                                "wave12FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave12RetainedFdPreManifestBarrierCount": 3,
                                "wave12CompletionAppliesToRetainedSnapshot":
                                    True,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave12-"
