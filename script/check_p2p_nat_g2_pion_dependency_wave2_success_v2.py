#!/usr/bin/env python3
"""Independently read back and record wave-two v2 acquisition success."""
...
def load_authority() -> dict[str, Any]:
    ...
    try:
        ...
        if (
            ...
            != "run_separate_wave2_v2_independent_readback"
...
def check_loaded(authority: Mapping[str, Any]) -> dict[str, Any]:
    ...
    return {
        "status": "wave2_v2_independent_readback_passed_not_recorded",
        ...
        **first,
        ...
        "nextAction": "record_wave2_v2_readback_receipt_then_manifest",
    }
    ...
    try:
        ...
        receipt_payload = {
            **checked,
            ...
            "schemaVersion": "1.0",
            "status": "wave2_v2_independent_readback_complete",
            "result": (
        ...
        manifest = {
            ...
            "schemaVersion": "1.0",
            "status": "wave2_v2_independent_readback_published",
...
def error_document(failure: Any) -> dict[str, Any]:
    return {
        "documentType": (
            "aetherlink.g2-pion-dependency-wave2-v2-readback-error"
        ),
        "schemaVersion": "1.0",
        "status": "failed",
