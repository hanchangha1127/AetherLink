#!/usr/bin/env python3
"""Focused tests for the exact read-only 351-input combined v14 checker."""
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v14 tests require unoptimized "
            "`python3 -I -B -S`"
        )
...
CHECKER_PATH = ROOT / "script/check_p2p_nat_g2_pion_combined_fixed_point_v14.py"


def load_checker():
    spec = importlib.util.spec_from_file_location(
        "combined_fixed_point_v14_tests_target",
        CHECKER_PATH,
    )
...
EXPECTED_WAVE15_RESOURCE_IDENTITY = [
    (1, 171, 'mod', 'golang.org/x/mod', 'v0.25.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/001-5aede784ca073b95cc80.mod', '1fb8ad2f7201cd79bf178578b35aaead1720cab2b8cfea35b99b25b60839f1ef'),
    (2, 171, 'zip', 'golang.org/x/mod', 'v0.25.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/001-5aede784ca073b95cc80.zip', 'f3021e5e6a777c146e469027accf1eb363eea3045ff812099152b20f2618f61c'),
    (3, 172, 'mod', 'golang.org/x/net', 'v0.41.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/002-2a401d22df127014c8ff.mod', 'bad88fe7380902f8265aa65ebe9a5228451626d705d8e59b90be07b0c4498883'),
    (4, 172, 'zip', 'golang.org/x/net', 'v0.41.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/002-2a401d22df127014c8ff.zip', '7c11c9710460316ee6fd4aa77d2b478df31621a11f5c11dec7b51cabd76a54c7'),
    (5, 173, 'mod', 'golang.org/x/sync', 'v0.15.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/003-a5add74f06b2f0c08dac.mod', '720b98f1bf033d6b64a454ca8c29cdca6e9265ab7d70db3b834dff49560f1587'),
    (6, 173, 'zip', 'golang.org/x/sync', 'v0.15.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/003-a5add74f06b2f0c08dac.zip', '74e221ae87caa0f9c7ec8c48c1ca39e9579ed89f094c7944bdda1cacae7d2a00'),
    (7, 174, 'mod', 'golang.org/x/sys', 'v0.33.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/004-5e519f9381da4b6cb760.mod', 'f67e3e18f4c08e60a7e80726ab36b691fdcea5b81ae1c696ff64caf518bcfe3d'),
    (8, 174, 'zip', 'golang.org/x/sys', 'v0.33.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/004-5e519f9381da4b6cb760.zip', '182df79c87135f6dbd0d45656b6527e9221e28899ee44cc6cc7e7a396aedaef9'),
    (9, 175, 'mod', 'golang.org/x/telemetry', 'v0.0.0-20240521205824-bda55230c457', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/005-e5b8406e7a0cdff66df0.mod', 'b71288c1d03a434f8ea16eda80e4ddb0733cbdd4ed996f4ab6616fd5dbf76ab3'),
    (10, 175, 'zip', 'golang.org/x/telemetry', 'v0.0.0-20240521205824-bda55230c457', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/005-e5b8406e7a0cdff66df0.zip', '8e8649337973d064cc44fa858787db7d0eb90f0806807349766d180ed6889f5c'),
]
EXPECTED_WAVE15_FALSE_ROOT_GO_MOD_FILES = set()
EXPECTED_WAVE15_FROZEN_PATH_RAWS = [
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave15-v1.json', '73638ba5aaaad61d146e0b884e71de9609ccddf870cf81c2c01bb42c2bccee19'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave15-v1.md', '227a8c54a9f16881caab3d66193d12e9d03770a0e7bc7de1abb486d8cd698318'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave15_decision_v1.py', 'e6d37beea87041149bc4e79e6e7c7a238c48ff48075c0eedfb250a24006bb3c3'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave15_decision_v1.py', '31e90bdc46760f48d1c04be1993de27442662b11c02701ecf5b4f7d6d5220bc3'),
    ('script/check_p2p_nat_g2_pion_combined_fixed_point_v13.py', '0b0ea7d68ef5fc11b8c0defe56bf443c681a6952a27e2c9b6c41d9702241a80b'),
    ('script/test_p2p_nat_g2_pion_combined_fixed_point_v13.py', 'dffb5e24cfd2ba4c561f5e8c6302c4502a75f917c1ac9d15216fd7f2ac045327'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/.wave-14-v1.claim', 'e67441825a0acd2741bf3a87d46020066a607476c08091c374b4f707059b3d40'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave15-execution-permit-v1.md', 'da3d73960e59940370ffa1819f5052bae6401fd88aa7b102309b43b286819ced'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave15-execution-permit-v1.json', 'c123dd1d9bd1a3cf6901246efcd545fae3b43e301504ed9144ce96c4010f0396'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave15_acquisition_v1.py', '41030a9cefaf31c08ead2ea6f109225c6a45f95c0d816a24a67a1ace8f2e5fe8'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave15_acquisition_v1.py', '5cad5c2c14be0805efd2a53dcaf5c396b795716c4ba72d0d339d39624936fe31'),
    ('script/acquire_p2p_nat_g2_pion_rung3_dependency_wave15_v1_once.py', '88f041c928c15543f60554ae127dbdf2ec657df4071d9dd52f6c6d3638625a55'),
    ('script/test_acquire_p2p_nat_g2_pion_rung3_dependency_wave15_v1_once.py', 'd77088fee276d43238ac021cf6104b7f5235779a8c51f79be230ac46f3a8a2d7'),
    ...
    ('build/offline-source/pion-ice-v4.3.0/dependencies/.wave-15-v1.claim', '88e55eda37f5186f373ca402f574789fde93405ad588cab8f5c865c3831837a5'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/evidence.json', '418447a2af3b57a42136659b06cbb4c8f4ba6c4935899571beef18d348f4c4a3'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/001-5aede784ca073b95cc80.mod', '1fb8ad2f7201cd79bf178578b35aaead1720cab2b8cfea35b99b25b60839f1ef'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/001-5aede784ca073b95cc80.zip', 'f3021e5e6a777c146e469027accf1eb363eea3045ff812099152b20f2618f61c'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/002-2a401d22df127014c8ff.mod', 'bad88fe7380902f8265aa65ebe9a5228451626d705d8e59b90be07b0c4498883'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/002-2a401d22df127014c8ff.zip', '7c11c9710460316ee6fd4aa77d2b478df31621a11f5c11dec7b51cabd76a54c7'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/003-a5add74f06b2f0c08dac.mod', '720b98f1bf033d6b64a454ca8c29cdca6e9265ab7d70db3b834dff49560f1587'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/003-a5add74f06b2f0c08dac.zip', '74e221ae87caa0f9c7ec8c48c1ca39e9579ed89f094c7944bdda1cacae7d2a00'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/004-5e519f9381da4b6cb760.mod', 'f67e3e18f4c08e60a7e80726ab36b691fdcea5b81ae1c696ff64caf518bcfe3d'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/004-5e519f9381da4b6cb760.zip', '182df79c87135f6dbd0d45656b6527e9221e28899ee44cc6cc7e7a396aedaef9'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/005-e5b8406e7a0cdff66df0.mod', 'b71288c1d03a434f8ea16eda80e4ddb0733cbdd4ed996f4ab6616fd5dbf76ab3'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-15-v1/accepted/005-e5b8406e7a0cdff66df0.zip', '8e8649337973d064cc44fa858787db7d0eb90f0806807349766d180ed6889f5c'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave15-receipt-v1.json', '3b0eb40e84e8de636352788127693a500e8cf7332a313c3d7dcbd733e4bfd1c3'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave15-manifest-v1.json', '5b923c19ec4a64bdc0478c55690b5dec239af05e19adba4668fc09f4e5f6229d'),
]
...
def validate_checker_static_surface(source):
    ...
    if (compile_count, exec_count) != (9, 9):
...
def held_toolchain():
    with (
        ...
        v13 = CHECKER.harden_checker_module(
            CHECKER.load_v13_checker(held_v13)
        )
...
@contextmanager
def held_wave15_documents(*, include_held=False):
    with held_toolchain() as chain:
        ...
        bindings = (
            CHECKER.wave15_control_bindings()
            + CHECKER.wave15_auxiliary_evidence_bindings()
        )
        with runner.HeldInputSet(ROOT, bindings) as held:
            documents = CHECKER.parse_wave15_documents(runner, held)
            if include_held:
...
def held_all_documents():
    with held_toolchain() as chain:
        ...
        auxiliary = CHECKER.wave15_auxiliary_evidence_bindings()
        with runner.HeldInputSet(ROOT, controls + auxiliary) as held:
            yield (
                ...
                CHECKER.parse_wave15_documents(runner, held),
            )


def assert_wave15_mutation_fails(
    testcase: unittest.TestCase,
    mutate,
    expected_code: str,
) -> None:
    with held_wave15_documents() as (v4, runner, documents):
        mutated = copy.deepcopy(documents)
        mutate(mutated)
        with (
            mock.patch.object(
                CHECKER,
                "verify_wave15_content_bindings",
            ),
            testcase.assertRaises(
                CHECKER.CombinedCheckFailure,
            ) as caught,
        ):
            CHECKER.wave15_request_resources(v4, runner, mutated)
    testcase.assertEqual(str(caught.exception), expected_code)


def rebind_wave15_selector_hashes(
    runner,
    documents,
) -> tuple[str, str]:
    """Rebind selector-bearing projections so semantic checks run."""

    decision = documents[CHECKER.WAVE15_DECISION_PATH]
    permit = documents[CHECKER.WAVE15_PERMIT_PATH]
    readback_permit = documents[CHECKER.WAVE15_READBACK_PERMIT_PATH]
    readback = documents[CHECKER.WAVE15_READBACK_PATH]
    ...
    request_set_sha256 = CHECKER.sha256_bytes(
        CHECKER.wave15_digest_bytes(source_requests)
    )
...
class CombinedFixedPointV14Tests(unittest.TestCase):
    maxDiff = None
    ...
    def setUpClass(cls):
        unresolved_bootstrap = {
            ...
            "V14_INPUT_SET_SHA256": CHECKER.V14_INPUT_SET_SHA256,
        ...
        if any(
            ...
            raise unittest.SkipTest(
                "V14 exact bootstrap seals remain unresolved; "
                "full reconstruction is intentionally not run"
            )
        original_load_v13 = CHECKER.load_v13_checker
        original_derive_tool_paths = CHECKER.derive_and_validate_tool_paths
        original_os_open = os.open
        cls.actual_python_open_paths = []

        def capturing_load_v13(held):
            module = original_load_v13(held)
        ...
        with (
            mock.patch.object(
                CHECKER,
                "load_v13_checker",
                side_effect=capturing_load_v13,
            ),
            mock.patch.object(
                CHECKER,
    ...
    def test_01_self_predecessor_and_terminal_bytes_are_exact(self):
        ...
        for path, expected in (
            (CHECKER.V13_CHECKER_PATH, CHECKER.V13_CHECKER_RAW_SHA256),
            (CHECKER.V13_TESTS_PATH, CHECKER.V13_TESTS_RAW_SHA256),
        ):
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
        for path, expected in CHECKER.WAVE15_CONTROL_SHA256.items():
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
    ...
    def test_03_exact_351_input_composition_and_hashes(self):
        inputs = self.candidate["inputSet"]
        rows = inputs["sourceBindings"]
        expected_counts = {
            "heldSourceInputCount": 351,
            "resourceCount": 350,
            "modCount": 175,
            "zipCount": 175,
            ...
            "aggregateRawByteSize": 327_603_241,
        }
        for key, value in expected_counts.items():
            self.assertEqual(inputs[key], value, key)
        self.assertEqual(len(rows), 351)
        self.assertEqual(len({row["path"] for row in rows}), 351)
        self.assertEqual(
        ...
        self.assertEqual(
            hashlib.sha256(CHECKER.wave15_digest_bytes(rows)).hexdigest(),
            EXPECTED_V14_SOURCE_BINDINGS_SHA256,
        )
        self.assertEqual(
            CHECKER.V14_SOURCE_BINDINGS_SHA256,
        ...
        self.assertEqual(pair_orders, list(range(1, 176)))
        self.assertEqual(
            sorted(
                {
                    row["tupleOrder"]
    ...
    def test_04_reconstruction_and_archive_counters_are_not_stale(self):
        ...
        self.assertEqual(
            (
                ...
                CHECKER.V14_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
            ),
            (176, 67_904, 1_250_144_441, 1_250_144_441),
        )
        self.assertEqual(
            (
        ...
        self.assertEqual(
            ...
            (352, 2_986, 3_338, 3_338),
        )
        self.assertEqual(
            verification["underlyingIndependentGraphAlgorithmCount"],
            52,
        )
        self.assertEqual(verification["hardenedCheckerModuleCount"], 13)
        self.assertEqual(verification["providerFacadeLoadCount"], 13)
        self.assertEqual(counters["heldTerminalEvidenceCount"], 101)
        self.assertEqual(counters["heldAuxiliaryEvidenceCount"], 3)
        self.assertEqual(counters["heldToolInputCount"], 13)
        self.assertEqual(counters["transitiveDistinctToolPathCount"], 15)
        for key in (
    ...
    def test_05_live_and_historical_boundaries_are_explicit(self):
        ...
        self.assertTrue(verification["pinnedV13PredecessorExecuted"])
        self.assertEqual(
            verification["v13TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(verification["v13TestsLiveHeld"])
        self.assertTrue(
            verification[
        ...
        self.assertTrue(
            verification["wave15LiveTerminalControlMetadataVerified"]
        )
        self.assertTrue(
            verification["wave15LiveFinalAndAcceptedInventoriesVerified"]
        )
        self.assertTrue(
            verification["wave15CompletionAppliesToRetainedSnapshot"]
        )
        self.assertFalse(
            verification[
        ...
        self.assertFalse(predecessor["v13TestsLiveHeld"])

    def test_06_wave15_terminal_resources_are_exact(self):
        with held_wave15_documents() as (v4, runner, documents):
            resources = CHECKER.wave15_request_resources(
                v4,
                runner,
                documents,
            )
            snapshot = documents[CHECKER.WAVE15_READBACK_PERMIT_PATH][
            ...
            verified_resources = documents[CHECKER.WAVE15_READBACK_PATH][
                "verified"
            ]["resources"]
        ...
        self.assertEqual(len(EXPECTED_WAVE15_FROZEN_PATH_RAWS), 29)
        self.assertEqual(snapshot["frozenFileCount"], 29)
        ...
        self.assertEqual(
            ...
            (5_065_246, 452, 5_064_794, 1_645, 19_962_377),
        )
        self.assertTrue(
            documents[CHECKER.WAVE15_READBACK_PERMIT_PATH][
        ...
        self.assertEqual(
            ...
            EXPECTED_WAVE15_FALSE_ROOT_GO_MOD_FILES,
        )
    ...
    def test_07_combined_input_inventory_is_recomputed(self):
        ...
        self.assertEqual((len(controls), len(auxiliary)), (101, 3))
        self.assertEqual(len(rows), 351)
        self.assertEqual(
            hashlib.sha256(
        ...
        self.assertEqual(
            hashlib.sha256(
                CHECKER.wave15_digest_bytes(projection)
            ).hexdigest(),
            EXPECTED_V14_SOURCE_BINDINGS_SHA256,
        )

    def test_08_unknown_authority_and_tool_pin_fail_closed(self):
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_PERMIT_PATH][
                "authority"
        ...
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_DECISION_PATH][
                "toolBindings"
        ...
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "toolBindings"
        ...
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
            "E_WAVE15_READBACK",
        )
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_MANIFEST_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
        ...
        for key in ("acquisitionClaim", "evidence"):
            assert_wave15_mutation_fails(
                ...
                lambda docs, target=key: docs[
                    CHECKER.WAVE15_READBACK_PERMIT_PATH
    ...
    def test_08_each_wave15_accepted_raw_binding_tamper_fails_closed(self):
        with held_wave15_documents() as (v4, runner, documents):
            accepted = documents[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acceptedDirectory"]["files"]
            self.assertEqual(len(accepted), 10)
            for index in range(10):
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                    "frozenAcquisitionSnapshot"
    ...
    def test_09_stale_wave14_snapshot_and_v12_predecessor_fail_closed(self):
        def substitute_resource_same_cardinality(documents):
            rows = documents[CHECKER.WAVE15_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            rows[0] = copy.deepcopy(rows[2])

        def substitute_authority_same_cardinality(documents):
            rows = documents[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acquisitionAuthority"]
            rows[0] = copy.deepcopy(rows[1])

        def substitute_v12_predecessor(documents):
            predecessors = documents[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["predecessorBindings"]
            predecessors["combinedFixedPointV12"] = predecessors.pop(
                "combinedFixedPointV13"
            )

        def add_v12_predecessor_sibling(documents, path, nested=False):
            container = documents[path]
            if nested:
                container = container["frozenAcquisitionSnapshot"]
            predecessors = container["predecessorBindings"]
            predecessors["combinedFixedPointV12"] = copy.deepcopy(
                predecessors["combinedFixedPointV13"]
            )
        ...
        assert_wave15_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ].__setitem__("frozenFileCount", 27),
            "E_WAVE15_READBACK_PERMIT",
        )
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acceptedDirectory"].__setitem__("exactFileCount", 8),
            "E_WAVE15_READBACK_PERMIT",
        )
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ].__setitem__("acceptedResourceCount", 8),
            "E_WAVE15_READBACK_PERMIT",
        )
        assert_wave15_mutation_fails(
            self,
        ...
        assert_wave15_mutation_fails(
            self,
            substitute_v12_predecessor,
            "E_WAVE15_READBACK_PERMIT",
        )
        for path, nested, expected in (
            (CHECKER.WAVE15_DECISION_PATH, False, "E_WAVE15_DECISION"),
            (CHECKER.WAVE15_PERMIT_PATH, False, "E_WAVE15_PERMIT"),
            (
                CHECKER.WAVE15_READBACK_PERMIT_PATH,
                True,
                "E_WAVE15_READBACK_PERMIT",
        ...
        for path, nested, expected in (
            ...
            for key, value in (
                ("path", "build/offline-source/stale-wave14.claim"),
                ("rawSha256", "0" * 64),
            ):
                assert_wave15_mutation_fails(
                    self,
                    ...
                    anchor_key=key, anchor_value=value: (
                        ...
                        )["predecessorBindings"]["combinedFixedPointV13"][
        ...
        for path, key, value, expected in (
            ...
            def mutate_limit(
                ...
                if target == CHECKER.WAVE15_PERMIT_PATH:
                    section = (
                        "zipLimits"
    ...
    def test_10_selected_tuple_and_live_hold_overclaim_fail_closed(self):
        ...
        assert_wave15_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH][
                "verificationContract"
            ].__setitem__("v13TestsLiveHeld", False),
            "E_WAVE15_READBACK_PERMIT",
        )

    def test_10_all_wave15_selectors_and_false_root_mods_are_exact(self):
        with held_wave15_documents() as (v4, runner, documents):
            baseline = documents[CHECKER.WAVE15_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            verified = documents[CHECKER.WAVE15_READBACK_PATH]["verified"][
                "resources"
            ]
            ...
            self.assertEqual(zip_root_indexes, [1, 3, 5, 7, 9])
                ...
                for index in range(count):
                    for value in (True, 0, "false", None, missing):
                        ...
                        resources_sha256, request_set_sha256 = (
                            rebind_wave15_selector_hashes(runner, mutated)
                        )
                        with (
                            self.subTest(
                            ...
                            CHECKER.wave15_request_resources(
                                v4,
                                runner,
                                mutated,
                            )
            ...
            for index in zip_root_indexes:
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE15_READBACK_PATH]["verified"][
                    "resources"
    ...
    def test_11_post_success_reporting_contract_is_pinned(self):
        ...
        assert_wave15_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE15_READBACK_PERMIT_PATH].__setitem__(
    ...
    def test_12_terminal_modes_sizes_and_namespace_are_live(self):
        with held_wave15_documents(include_held=True) as (
            _,
            _,
            documents,
            held,
        ):
            CHECKER.validate_wave15_completed_namespace(held, documents)
            for path, (size, mode) in CHECKER.WAVE15_CONTROL_METADATA.items():
    ...
    def test_13_legacy_wave9_compatibility_remains_exact_and_bounded(self):
        with held_all_documents() as value:
            chain = value[0]
            d9 = value[-7]
            _, _, _, _, _, v8, _, _, _, v4, _, runner = chain
    ...
    def test_14_static_surface_rejects_dynamic_process_network_and_write_bypass(
        ...
        self.assertEqual(len(compile_calls), 9)
        self.assertEqual(len(exec_calls), 9)
        self.assertEqual(
    ...
    def test_16_error_document_requests_no_credentials(self):
        ...
        self.assertEqual(value["schemaVersion"], "14.0")
    ...
    def test_17_v13_predecessor_is_exact_and_mutations_fail_closed(self):
        predecessor = self.predecessor_candidate
        self.assertEqual(
            predecessor["contentBinding"]["sha256"],
            CHECKER.V13_CANDIDATE_CONTENT_SHA256,
        )
        self.assertEqual(
            predecessor["inputSet"]["combinedInputSetSha256"],
            CHECKER.V13_INPUT_SET_SHA256,
        )
        self.assertEqual(
            predecessor["graphDiscovery"]["graphSha256"],
            CHECKER.V13_GRAPH_SHA256,
        )
        self.assertEqual(
            predecessor["derivedResult"]["frontierSha256"],
            CHECKER.V13_FRONTIER_SHA256,
        )
        self.assertEqual(
            predecessor["checkerVerification"]["v12TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(
            predecessor["checkerVerification"]["v12TestsLiveHeld"]
        )
        with held_wave15_documents() as (_, runner, documents):
            decision = documents[CHECKER.WAVE15_DECISION_PATH]
            verified = CHECKER.validate_v13_predecessor_candidate(
                runner,
                predecessor,
                decision,
            )
            ...
            with self.assertRaises(
                ...
                CHECKER.validate_v13_predecessor_candidate(
                    runner,
                    predecessor,
                    stale_key_decision,
                )
            self.assertEqual(str(caught.exception), "E_V13_PREDECESSOR")
            for key in (
                "contentSha256",
            ...
            for key, value in (
                ...
                with self.subTest(wave14_namespace_anchor=key):
                    ...
                    mutated_decision["predecessorBindings"][
                        "combinedFixedPointV13"
                    ]["wave14NamespaceAnchor"][key] = value
                    with self.assertRaises(
                        CHECKER.CombinedCheckFailure,
                    ) as caught:
                        CHECKER.validate_v13_predecessor_candidate(
    ...
    def test_18_live_protocol_order_and_tool_holds_are_observed(self):
        ...
        with (
            mock.patch.object(
                CHECKER,
                "validate_wave15_completed_namespace",
    ...
    def test_20_tool_path_derivation_rejects_duplicate_missing_and_extra(self):
        ...
        self.assertEqual(len(direct_paths), 13)
        self.assertEqual(len(transitive_paths), 15)
...
class CombinedFixedPointV14FastBoundaryTests(unittest.TestCase):
    def test_v14_regression_seals_are_resolved_and_fresh(self):
        self.assertEqual(
            (
                CHECKER.V14_INPUT_SET_SHA256,
                CHECKER.V14_SOURCE_BINDINGS_SHA256,
