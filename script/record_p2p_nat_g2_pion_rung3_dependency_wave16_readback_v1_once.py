#!/usr/bin/env python3
"""Record one independent offline readback of the Wave16 v1 acquisition."""
...
if not (
    ...
    raise RuntimeError("Wave16 readback recorder requires `python3 -I -B -S`")
...
if O_NOFOLLOW is None:
    raise RuntimeError("Wave16 readback recorder requires O_NOFOLLOW")
READBACK_CHECKER_PATH = Path(__file__).with_name(
    "check_p2p_nat_g2_pion_rung3_dependency_wave16_"
    "readback_execution_permit_v1.py"
)
EXPECTED_READBACK_CHECKER_RAW = "09f1910aed95d76c20c3ea177b88ba81f8149f29b0c75f2cf1760e162394cebc"
...
def load_readback_checker() -> types.ModuleType:
    ...
    module = types.ModuleType("wave16_acquisition_readback_permit_v1")
...
def verify_snapshot(snapshot: FrozenSnapshot) -> dict[str, Any]:
    ...
    v14 = acquisition_permit["predecessorBindings"]["combinedFixedPointV14"]
    predecessor_authority_rows = [
        {
            "path": v14["checkerPath"],
            "rawSha256": v14["checkerRawSha256"],
        },
        {
            "path": v14["testsPath"],
            "rawSha256": v14["testsRawSha256"],
        },
    ]
    bound_authority_rows = [
        *acquisition_permit["decisionBinding"]["files"],
        *predecessor_authority_rows,
        v14["wave15NamespaceAnchor"],
    ...
    require(
        ...
        == {
            ...
            "checkerNormalizedSha256": (
                PERMIT.EXPECTED_V14_CHECKER_NORMALIZED
            ),
            "testsPath": (
            ...
            "contentSha256": PERMIT.EXPECTED_V14_CONTENT,
            "combinedInputSetSha256": PERMIT.EXPECTED_V14_INPUT_SET,
            "graphSha256": PERMIT.EXPECTED_V14_GRAPH,
            "frontierSha256": PERMIT.EXPECTED_V14_FRONTIER,
    ...
    require(
        len(resources) == 6
        and [row["requestOrdinal"] for row in resources] == list(range(1, 7))
        and [row["kind"] for row in resources] == ["mod", "zip"] * 3
    ...
    require(
        ...
        and aggregate_zip == 11_475_192
        and aggregate == 11_475_644
        and aggregate_zip_entries == 948
        and aggregate_zip_uncompressed == 46_464_212
    ...
    evidence_expected = {
        "documentType": "aetherlink.wave16-source-acquisition-evidence",
        "schemaVersion": "1.0",
        "attemptId": PERMIT.ATTEMPT_ID,
        "requestCount": 6,
    ...
    receipt_expected = {
        "documentType": "aetherlink.wave16-source-acquisition-receipt",
        "schemaVersion": "1.0",
    ...
    return {
        ...
        "combinedFixedPointV14ContentSha256": PERMIT.EXPECTED_V14_CONTENT,
        "compactIdentitySha256": PERMIT.EXPECTED_COMPACT_IDENTITY,
        "fullWitnessSha256": PERMIT.EXPECTED_FULL_WITNESS,
...
def create_readback_claim(
    ...
    claim = content_bound(
        {
            "documentType": "aetherlink.wave16-acquisition-readback-one-use-claim",
            "schemaVersion": "1.0",
            "status": "consumed_active",
    ...
    try:
        ...
        try:
            ...
            receipt = content_bound(
                {
                    "documentType": "aetherlink.wave16-source-acquisition-readback",
                    "schemaVersion": "1.0",
                    "status": (
                        "wave16_acquisition_retained_snapshot_"
            ...
            manifest = content_bound(
                {
                    "documentType": (
                        "aetherlink.wave16-source-acquisition-readback-manifest"
                    ),
                    "schemaVersion": "1.0",
                    "status": (
                        "wave16_acquisition_retained_snapshot_"
...
def _post_success_reporting_failure() -> dict[str, Any]:
    return {
        "documentType": "aetherlink.wave16-acquisition-readback-error",
        "schemaVersion": "1.0",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.preflight:
            preflight()
            result = {
                "documentType": "aetherlink.wave16-acquisition-readback-preflight",
                "schemaVersion": "1.0",
