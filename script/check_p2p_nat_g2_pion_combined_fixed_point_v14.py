#!/usr/bin/env python3
"""Recompute the exact 351-input Wave1..Wave15 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v13
combined checker, all Wave15 decision/acquisition/readback controls, and the
root archive plus 175 mod and 175 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v14 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v14.py"
...
CHECKER_ID = (
    ...
    "wave7-wave8-wave9-wave10-wave11-wave12-wave13-wave14-wave15-check-v14"
)
...
WAVE15_DECISION_PATH = (
    f"{BASE}/bounded-dependency-source-identity-and-acquisition-"
    "decision-wave15-v1.json"
)
WAVE15_PERMIT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-"
    "execution-permit-v1.json"
)
WAVE15_RECEIPT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-receipt-v1.json"
)
WAVE15_MANIFEST_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-manifest-v1.json"
)
WAVE15_READBACK_PERMIT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-"
    "readback-execution-permit-v1.json"
)
WAVE15_READBACK_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-readback-v1.json"
)
WAVE15_READBACK_MANIFEST_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-"
    "readback-manifest-v1.json"
)
WAVE15_ACCEPTED_DIRECTORY = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    "wave-15-v1/accepted"
)
WAVE15_ACQUISITION_CLAIM_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/.wave-15-v1.claim"
)
WAVE15_EVIDENCE_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    "wave-15-v1/evidence.json"
)
WAVE15_READBACK_CLAIM_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    ".wave-15-v1-readback.claim"
)
WAVE15_FAILURE_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave15-failure-v1.json"
)
WAVE15_STAGING_PREFIX = ".wave-15-v1-staging-"
WAVE15_READBACK_TEMP_PREFIXES = (
    ".bounded-dependency-source-acquisition-wave15-readback-v1.json.tmp-",
    (
        ".bounded-dependency-source-acquisition-wave15-readback-"
        "manifest-v1.json.tmp-"
    ),
)

WAVE15_CONTROL_SHA256 = {
    WAVE15_DECISION_PATH:
    ...
    WAVE15_RECEIPT_PATH:
        "3b0eb40e84e8de636352788127693a500e8cf7332a313c3d7dcbd733e4bfd1c3",
    WAVE15_MANIFEST_PATH:
        "5b923c19ec4a64bdc0478c55690b5dec239af05e19adba4668fc09f4e5f6229d",
    WAVE15_READBACK_PERMIT_PATH:
        "0fdeaf4d105d920e7b0cd62b6fb8f5151b6489d3d7de26d1ce0ab1f3b6924f76",
    WAVE15_READBACK_PATH:
        "37391299894779216822c2233ddf38952b70a57212d79dc5121947496882ba54",
    WAVE15_READBACK_MANIFEST_PATH:
        "81899da33323fd14f949dbb8a2683b7d543f190eabd9ba71b5e5de4822f43a7d",
}
WAVE15_CONTROL_METADATA = {
    WAVE15_DECISION_PATH: (15_895, 0o644),
    WAVE15_PERMIT_PATH: (20_175, 0o644),
    WAVE15_RECEIPT_PATH: (1_666, 0o600),
    WAVE15_MANIFEST_PATH: (465, 0o600),
    WAVE15_READBACK_PERMIT_PATH: (19_272, 0o644),
    WAVE15_READBACK_PATH: (8_071, 0o600),
    WAVE15_READBACK_MANIFEST_PATH: (2_301, 0o600),
}
WAVE15_CONTENT_SHA256 = {
    WAVE15_DECISION_PATH:
    ...
    WAVE15_READBACK_PATH:
        "5c53c45bf91e6c8d13c5b383ccaf5c7a4892e63689d6d7c497cc7c9c14f391d7",
    WAVE15_READBACK_MANIFEST_PATH:
        "84b4775178c3a33da3155c39fbe436f31915c36085c3d05fbc7b0987e95d1023",
}
WAVE15_REQUEST_SET_SHA256 = (
    "106a3f88983749e5272783fc7ce1293473a8dacf2e86ef7effc374707fec0d04"
)
WAVE15_PERMIT_RESOURCES_SHA256 = (
    "2898a6d51c5c660f0c714524b862c5f715cb1d6971b57cfc737c666953068603"
)
WAVE15_RESOURCE_SET_SHA256 = (
    "9255922769ca442cdc555467158bd4a1c1399398d4ee1f5ced42a677b35f140d"
)
WAVE15_FROZEN_FILE_SET_SHA256 = (
    "b7df25872029064c136ab99be564cd2013fef7047ecb9588175909f3b31951d8"
)
WAVE15_ATTEMPT_ID = "c5db51cfd9a295b448927cca36d1ea07"
WAVE15_READBACK_ATTEMPT_ID = "fb2b53eb42982732b0344695065c625d"
WAVE15_COMPACT_IDENTITY_SHA256 = (
    "b9fc13d747fc092cf312ffdf4c792c078f4c79c783b2426a00388ae2f98d915b"
)
WAVE15_FULL_WITNESS_SHA256 = (
    "92fc2c418b2cda6984f51d09a0c8f8e95633539ee1542c91a03cc679011e7ee7"
)
WAVE15_HELD_SOURCE_BINDINGS_SHA256 = (
    "fbd023d2ee5f372ef90d06d92e48c7dfa9828212e38bf942e1741aca322b9996"
)
WAVE15_ACQUISITION_CLAIM_RAW_SHA256 = (
    "88e55eda37f5186f373ca402f574789fde93405ad588cab8f5c865c3831837a5"
)
WAVE15_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "418447a2af3b57a42136659b06cbb4c8f4ba6c4935899571beef18d348f4c4a3"
)
WAVE15_ACQUISITION_CHECKER_RAW_SHA256 = (
    "41030a9cefaf31c08ead2ea6f109225c6a45f95c0d816a24a67a1ace8f2e5fe8"
)
WAVE15_ACQUISITION_RUNNER_RAW_SHA256 = (
    "88f041c928c15543f60554ae127dbdf2ec657df4071d9dd52f6c6d3638625a55"
)
WAVE15_READBACK_CLAIM_RAW_SHA256 = (
    "d2663e7a1e4f363c7cc7257c4c9bba6c7f4f490fde6965f93aeebe6ee144d30e"
)
WAVE15_READBACK_CLAIM_CONTENT_SHA256 = (
    "83cd4d149137bf246bfd1d361a0ed198b3459feeb10d997cf788b5dc62bc639d"
)
WAVE15_READBACK_CHECKER_RAW_SHA256 = (
    "438e4ead11f62e6e25eee0486ff661a13cd93a2ef3f944507076385f825a0e6e"
)
WAVE15_READBACK_RECORDER_RAW_SHA256 = (
    "bb099063b495256f80af8bfebbd8241f3172450f6f7fafc8b42f7f7169f7be8f"
)
WAVE15_READBACK_RECORDER_NORMALIZED_SHA256 = (
    "7365f1b5c084d031e96c6b0cbdf3870ab790de910f1cc6a55717359623bd9d10"
)
WAVE15_RETAINED_BARRIERS = [
...
WAVE15_ABSOLUTE_RESOURCE_LIMITS = {
    "callerBlockedSigalrmRejectedBeforePreflight": True,
    "maximumAggregateModResponseBodyBytes": 5_242_880,
    "maximumAggregateResponseBodyBytes": 89_128_960,
    "maximumAggregateZipResponseBodyBytes": 83_886_080,
...
WAVE15_ZIP_LIMITS = {
    ...
    "maximumEntryCountAcrossAllZips": 100_000,
    "maximumEntryCountPerZip": 20_000,
    "maximumEntryNameBytes": 1_024,
    "maximumSingleEntryBytes": 134_217_728,
    "maximumUncompressedBytesAcrossAllZips": 671_088_640,
    "maximumUncompressedBytesPerZip": 134_217_728,
}
WAVE15_READBACK_RESOURCE_LIMITS = {
    "maximumAcceptedResourceCount": 10,
    "maximumAggregateAcceptedBytes": 89_128_960,
    "maximumAggregateModBytes": 5_242_880,
    "maximumAggregateZipBytes": 83_886_080,
    "maximumModBytes": 1_048_576,
    "maximumPackageFileBytes": 8_388_608,
    "maximumZipBytes": 16_777_216,
    "maximumZipEntriesAcrossAll": 100_000,
    "maximumZipEntriesPerZip": 20_000,
    "maximumZipEntryBytes": 134_217_728,
    "maximumZipEntryNameBytes": 1_024,
    "maximumZipUncompressedBytesAcrossAll": 671_088_640,
...
WAVE15_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave15_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE15_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE15_CONTENT_SHA256[WAVE15_READBACK_PERMIT_PATH],
        "path": WAVE15_READBACK_PERMIT_PATH,
        "rawSha256": WAVE15_CONTROL_SHA256[WAVE15_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
            "script/record_p2p_nat_g2_pion_rung3_dependency_wave15_"
            "readback_v1_once.py"
        ),
        "rawSha256": WAVE15_READBACK_RECORDER_RAW_SHA256,
    },
}
WAVE15_DECISION_TOOL_BINDINGS = [
    {
        "normalizedSha256":
...
WAVE15_ACQUISITION_TOOL_BINDINGS = [
    {
        "path":
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave15_acquisition_v1.py",
        "rawSha256": WAVE15_ACQUISITION_CHECKER_RAW_SHA256,
    },
    {
        "path":
            "script/test_p2p_nat_g2_pion_rung3_dependency_wave15_acquisition_v1.py",
        "rawSha256":
            "5cad5c2c14be0805efd2a53dcaf5c396b795716c4ba72d0d339d39624936fe31",
    },
    {
        "path":
            "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave15_v1_once.py",
        "rawSha256": WAVE15_ACQUISITION_RUNNER_RAW_SHA256,
    },
    {
        "path":
            "script/test_acquire_p2p_nat_g2_pion_rung3_dependency_wave15_v1_once.py",
        "rawSha256":
            "d77088fee276d43238ac021cf6104b7f5235779a8c51f79be230ac46f3a8a2d7",
    },
]
WAVE15_READBACK_TOOL_BINDINGS = [
    WAVE15_READBACK_AUTHORITY_BINDING["checker"],
    {
        "path": (
            "script/test_p2p_nat_g2_pion_rung3_dependency_wave15_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256":
            "d09e558dfa64f78799518928587a4150e0ca62f8d02e62c9c9125daed55ed75b",
    },
    WAVE15_READBACK_AUTHORITY_BINDING["recorder"],
    {
        "path": (
            "script/test_record_p2p_nat_g2_pion_rung3_dependency_wave15_"
            "readback_v1_once.py"
        ),
        "rawSha256":
            "3b91948a421431e4dfeaa055a47f0c0427a8fab993db1a15773748bfd0972c55",
    },
]
...
def wave15_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v14_safe_hardened") is True:
        return module
    module.__dict__["_v14_safe_hardened"] = True
...
def wave15_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE15_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE15_CONTROL_SHA256.items()
    ]


def parse_wave15_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE15_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE15_JSON")
        result[path] = value
    return result


def wave15_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE15_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE15_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 417,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE15_EVIDENCE_PATH,
            "rawSha256": WAVE15_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 4_191,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE15_READBACK_CLAIM_PATH,
            "rawSha256": WAVE15_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_255,
            "ownerOnly": True,
...
def validate_wave15_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE15_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE15_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE15_EVIDENCE_PATH]
    readback = control_held.files[WAVE15_READBACK_PATH]
    readback_manifest = control_held.files[WAVE15_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE15_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE15_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE15_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE15_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE15_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE15_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE15_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE15_READBACK_PERMIT_PATH]
    ...
    check(
        type(accepted_files) is list and len(accepted_files) == 10,
        "E_WAVE15_NAMESPACE",
    )
    ...
    check(
        len(expected_accepted_names) == 10
        and all(
            Path(row["path"]).parent.as_posix() == WAVE15_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE15_NAMESPACE",
    )
    ...
    try:
        ...
        check(
            ...
            and accepted_info.st_nlink == 12
            and stat.S_IMODE(accepted_info.st_mode) == 0o700
            and len(accepted_names) == 10
            and set(accepted_names) == expected_accepted_names
            and len(set(normalized_accepted_names)) == 10,
            "E_WAVE15_NAMESPACE",
        )
    finally:
        if accepted_fd >= 0:
...
def validate_wave15_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE15_ATTEMPT_ID,
            "checkerRawSha256": WAVE15_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave15-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE15_CONTENT_SHA256[WAVE15_PERMIT_PATH],
            "requestCount": 10,
            "schemaVersion": "1.0",
            "status": "consumed_active",
            "userActionRequired": False,
        },
        "E_WAVE15_ACQUISITION_CLAIM",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE15_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE15_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE15_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE15_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE15_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave15-acquisition-readback-one-use-claim"
        ...
        "E_WAVE15_READBACK_CLAIM",
    )


def validate_wave15_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE15_EVIDENCE")
    readback = documents[WAVE15_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE15_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave15-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE15_ATTEMPT_ID
        and evidence_document.get("requestCount") == 10
        and evidence_document.get("aggregateResponseBytes") == 5_065_246
        and evidence_document.get("aggregateModResponseBytes") == 452
        and evidence_document.get("aggregateZipResponseBytes") == 5_064_794
        and evidence_document.get("aggregateZipEntryCount") == 1_645
        and evidence_document.get("aggregateZipUncompressedBytes")
        == 19_962_377
        and type(evidence_resources) is list
        and len(evidence_resources) == 10
...
def verify_wave15_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE15_DECISION_PATH],
        WAVE15_CONTENT_SHA256[WAVE15_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE15_PERMIT_PATH],
        WAVE15_CONTENT_SHA256[WAVE15_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE15_CONTENT_SHA256[path],
        )


def validate_v13_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == V13_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V13_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V13_FRONTIER_SHA256
        and predecessor.get("frontierTupleCount") == 5
        and predecessor.get("fixedPointReached") is False
        and predecessor.get("checkerPath") == V13_CHECKER_PATH
        and predecessor.get("checkerRawSha256") == V13_CHECKER_RAW_SHA256
        and predecessor.get("checkerNormalizedSha256")
        == V13_CHECKER_NORMALIZED_SHA256
        and predecessor.get("testsPath") == V13_TESTS_PATH
        and predecessor.get("testsRawSha256") == V13_TESTS_RAW_SHA256
        and predecessor.get("totalFullSourceReconstructionCount") == 24
        and predecessor.get("totalGraphArchiveOpenCount") == 2_986
        ...
        and predecessor.get("v12TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and predecessor.get("v12TestsLiveHeld") is False
        and predecessor.get("wave14NamespaceAnchor")
        == {
            "path": (
                "build/offline-source/pion-ice-v4.3.0/dependencies/"
                ".wave-14-v1.claim"
        ...
        == {
            ...
            "finalNamespaceReverifiedAfterCombinedV13Reconstruction": True,
            "historicalExact27FrozenSnapshotDescriptorSetBound": True,
            "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV13Barrier":
                True,
            "liveTerminalControlMetadataVerifiedAtCombinedV13Barrier": True,
        ...
        == V13_FRONTIER_SHA256
        and candidate.get("authority") == V13_AUTHORITY
        and candidate.get("checkerVerification", {}).get(
        ...
        and candidate.get("operationCounters", {}).get("archiveOpenCount")
        == 2_986,
        "E_V13_PREDECESSOR",
    )
    return {
        ...
        "wave14CompletionAppliesToRetainedSnapshot": True,
        "wave14CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave14SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
        "v13TestsBindingScope": "historical_metadata_only_not_live_held",
        "v13TestsLiveHeld": False,
    }


def wave15_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE15_DECISION_PATH]
    permit = documents[WAVE15_PERMIT_PATH]
    receipt = documents[WAVE15_RECEIPT_PATH]
    manifest = documents[WAVE15_MANIFEST_PATH]
    readback_permit = documents[WAVE15_READBACK_PERMIT_PATH]
    readback = documents[WAVE15_READBACK_PATH]
    readback_manifest = documents[WAVE15_READBACK_MANIFEST_PATH]
    verify_wave15_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE15_CONTENT_SHA256[WAVE15_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave15_exact_5_frontier_identity_classified_5_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and decision.get("authority") == WAVE15_DECISION_AUTHORITY
        and decision.get("toolBindings") == WAVE15_DECISION_TOOL_BINDINGS
        and type(resolution) is dict
        and resolution.get("tupleCount") == 5
        and resolution.get("completeIdentityPairCount") == 5
        and resolution.get("blockedTupleCount") == 0
        and resolution.get("graphSelectedTupleCount") == 0
        and resolution.get("versionSpecificNonSelectedTupleCount") == 5
        and resolution.get("compactIdentitySha256")
        == WAVE15_COMPACT_IDENTITY_SHA256
        and resolution.get("fullWitnessSha256")
        == WAVE15_FULL_WITNESS_SHA256
        and type(held_set) is dict
        and held_set.get("sourceBindingCount") == 341
        and held_set.get("archiveCount") == 171
        and held_set.get("embeddedRootGoModCount") == 1
        and held_set.get("externalModCount") == 170
        and held_set.get("goSumEntryCount") == 120
        and held_set.get("allInputsHeldThroughFinalBarrier") is True
        and held_set.get("allInputsReadTwiceBeforeUse") is True
        ...
        and preparation.get("requestCount") == 10
        ...
        and len(source_requests) == 10
        and sha256_bytes(wave15_digest_bytes(source_requests))
        == WAVE15_REQUEST_SET_SHA256,
        "E_WAVE15_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE15_CONTENT_SHA256[WAVE15_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE15_ACQUISITION_AUTHORITY
        and permit.get("toolBindings") == WAVE15_ACQUISITION_TOOL_BINDINGS
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE15_CONTROL_SHA256[WAVE15_DECISION_PATH]
        ...
        == WAVE15_ABSOLUTE_RESOURCE_LIMITS
        and permit.get("zipLimits") == WAVE15_ZIP_LIMITS
        and permit_predecessor
        == {
            "checkerNormalizedSha256": V13_CHECKER_NORMALIZED_SHA256,
        ...
        and contract.get("requestCount") == 10
        and contract.get("tupleCount") == 5
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE15_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE15_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 10
        and receipt.get("modCount") == 5
        and receipt.get("zipCount") == 5
        and receipt.get("requestCount") == 10
        and receipt.get("dispatchBoundaryCount") == 10
        and receipt.get("responseCommittedCount") == 10
        and receipt.get("validationCommittedCount") == 10
        and receipt.get("persistenceCommittedCount") == 10
        and receipt.get("aggregateResponseBytes") == 5_065_246
        and receipt.get("aggregateModResponseBytes") == 452
        and receipt.get("aggregateZipResponseBytes") == 5_064_794
        and receipt.get("aggregateZipEntryCount") == 1_645
        and receipt.get("aggregateZipUncompressedBytes") == 19_962_377
    ...
    check(
        ...
        == {
            "attemptId": WAVE15_ATTEMPT_ID,
            "documentType": "aetherlink.wave15-source-acquisition-manifest",
            "manifestWrittenLast": True,
            "receiptPath": WAVE15_RECEIPT_PATH,
            "receiptRawSha256": WAVE15_CONTROL_SHA256[WAVE15_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV13")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV13PredecessorBindingRecomputed",
                ...
                "exact10ResourceOrderAndAggregateRecomputed",
                "exact29FrozenFileSnapshotRequired",
                ...
                "v12TestsLiveHeld", "v13TestsLiveHeld",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE15_CONTENT_SHA256[WAVE15_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE15_READBACK_AUTHORITY
        ...
        is True
        and verification_contract.get("exact29FrozenFileSnapshotRequired")
        is True
        ...
        is False
        and verification_contract.get("v12TestsLiveHeld") is False
        and verification_contract.get("v13TestsLiveHeld") is True
        and verification_contract.get(
            "requestResourcesCanonicalSha256Recomputed"
        ) is True
        ...
        and snapshot.get("attemptId") == WAVE15_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE15_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE15_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE15_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-15-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 29
        and snapshot.get("frozenFilesCanonicalSha256")
        == WAVE15_FROZEN_FILE_SET_SHA256
        and snapshot.get("acceptedResourceCount") == 10
        and snapshot.get("selectedTupleCount") == 0
        and snapshot.get("selectedRequestOrdinals") == []
        and snapshot.get("modCount") == 5
        and snapshot.get("zipCount") == 5
        and snapshot.get("aggregateAcceptedBytes") == 5_065_246
        and snapshot.get("aggregateModBytes") == 452
        and snapshot.get("aggregateZipBytes") == 5_064_794
        and snapshot.get("aggregateZipEntryCount") == 1_645
        and snapshot.get("aggregateZipUncompressedBytes") == 19_962_377
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave15_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE15_RECEIPT_PATH,
            "rawSha256": WAVE15_CONTROL_SHA256[WAVE15_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE15_MANIFEST_PATH,
            "rawSha256": WAVE15_CONTROL_SHA256[WAVE15_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE15_ACCEPTED_DIRECTORY
        and accepted.get("mode") == "0700"
        and accepted.get("ownerUid") == os.geteuid()
        and accepted.get("linkCount") == 12
        and accepted.get("exactFileCount") == 10
        and type(accepted_files) is list
        and len(accepted_files) == 10
        and sha256_bytes(
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV13ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE15_CONTENT_SHA256[WAVE15_READBACK_PATH],
        }
        and readback.get("status")
        == "wave15_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE15_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE15_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_255,
            "contentSha256": WAVE15_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == "wave15_acquisition_retained_snapshot_independently_verified"
        ...
        and verified.get("acceptedResourceCount") == 10
        ...
        == 19_962_377
        and verified.get("combinedFixedPointV13ContentSha256")
        == V13_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE15_CONTENT_SHA256[
                WAVE15_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave15_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE15_ATTEMPT_ID
        ...
        == {
            "bytes": 8_071,
            "contentSha256": WAVE15_CONTENT_SHA256[WAVE15_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE15_READBACK_PATH,
            "rawSha256": WAVE15_CONTROL_SHA256[WAVE15_READBACK_PATH],
        }
    ...
    check(
        len(accepted_by_name) == 10
        and len(verified_by_name) == 10
        and len(identity_by_order) == 5,
        "E_WAVE15_RESOURCE",
    )
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave15-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE15_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v13.combined_source_bindings(
        v12,
        v11,
        v10,
        v9,
    ...
    bindings.extend(wave15_request_resources(v4, runner, wave15_documents))
    check(
        len(bindings) == 351
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 175
        and sum(row["kind"] == "zip" for row in bindings) == 175
    ...
    check(
        len({row["path"] for row in bindings}) == 351
        and len(
            {
                (row["module"], row["version"])
                for row in bindings
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 176)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def derive_and_validate_tool_paths(
    ...
    declared_v13_paths = v13.TRANSITIVE_CHECKER_PATHS
    ...
    check(
        ...
        and type(declared_v13_paths) is set
        and declared_v13_paths
        == TRANSITIVE_CHECKER_PATHS - {V13_CHECKER_PATH}
        ...
        == len(
            declared_v13_paths
            | {V13_CHECKER_PATH, v13.V1_PROVIDER_PATH}
        )
    ...
    transitive_paths = direct_binding_paths | declared_v13_paths
    check(
        transitive_paths
...
def execute_reconstruction_protocol_prefix(
    ...
    validate_wave15_completed_namespace(control_held, wave15_documents)
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        predecessor_candidate = v13.generate_candidate(root)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                direct_tool_bindings = [
                    {
                        "role": "current_v14_combined_checker",
                        "path": SELF_PATH,
                ...
                check(
                    v13.PinnedCodeFile is PinnedCodeFile
                    ...
                    and len(direct_tool_paths) == 13
                    and len(transitive_tool_paths) == 15
                ...
                auxiliary_evidence = wave15_auxiliary_evidence_bindings()
                check(
                    len(controls) == 101
                ...
                with runner.HeldInputSet(
                    ...
                    wave15_documents = parse_wave15_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v13_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave15_documents[WAVE15_DECISION_PATH],
                        )
                    )
                    ...
                    wave15_evidence_raw = control_held.raw[WAVE15_EVIDENCE_PATH]
                    wave15_evidence_document = runner.strict_json(
                        wave15_evidence_raw,
                        WAVE15_EVIDENCE_PATH,
                    )
                    validate_wave15_evidence(
                        runner,
                        wave15_evidence_raw,
                        wave15_evidence_document,
                        wave15_documents,
                    )
                    validate_wave15_consumed_claims(
                        runner,
                        control_held.raw[WAVE15_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE15_READBACK_CLAIM_PATH],
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        limits = {
                            **v1.graph_limits(runner),
                            "maximumAggregateUncompressedBytes":
                                V14_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
                        }
                        ...
                        check(
                            first_coverage.get("archiveCount") == 176
                            and first_coverage.get("aggregateEntryCount")
                            == 67_904
                            and first_coverage.get(
                        ...
                        check(
                            ...
                            and sha256_bytes(wave15_digest_bytes(projection))
                            == V14_SOURCE_BINDINGS_SHA256,
                            "E_COMBINED_INPUT",
                        )
                        ...
                        body = {
                            ...
                            "inputSet": {
                                ...
                                "uniqueModuleVersionTupleCount": 175,
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV13PredecessorExecuted": True,
                                ...
                                "wave15FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave15RetainedFdPreManifestBarrierCount": 3,
                                "wave15CompletionAppliesToRetainedSnapshot":
                                    True,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave15-"
