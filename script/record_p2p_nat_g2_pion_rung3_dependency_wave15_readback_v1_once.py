#!/usr/bin/env python3
"""Record one independent offline readback of the Wave15 v1 acquisition."""
...
if not (
    ...
    raise RuntimeError("Wave15 readback recorder requires `python3 -I -B -S`")
...
if O_NOFOLLOW is None:
    raise RuntimeError("Wave15 readback recorder requires O_NOFOLLOW")
READBACK_CHECKER_PATH = Path(__file__).with_name(
    "check_p2p_nat_g2_pion_rung3_dependency_wave15_"
    "readback_execution_permit_v1.py"
)
EXPECTED_READBACK_CHECKER_RAW = "438e4ead11f62e6e25eee0486ff661a13cd93a2ef3f944507076385f825a0e6e"
...
MAX_ZIP_UNCOMPRESSED_BYTES_ACROSS_ALL = 640 * 1024 * 1024
MAX_ZIP_FILES_ACROSS_ALL = 100_000
...
def load_readback_checker() -> types.ModuleType:
    ...
    module = types.ModuleType("wave15_acquisition_readback_permit_v1")
...
def verify_snapshot(snapshot: FrozenSnapshot) -> dict[str, Any]:
    ...
    permit_path = (
        PERMIT.BASE
        + "/bounded-dependency-source-acquisition-wave15-execution-permit-v1.json"
    )
    ...
    v13 = acquisition_permit["predecessorBindings"]["combinedFixedPointV13"]
    predecessor_authority_rows = [
        {
            "path": v13["checkerPath"],
            "rawSha256": v13["checkerRawSha256"],
        },
        {
            "path": v13["testsPath"],
            "rawSha256": v13["testsRawSha256"],
        },
    ]
    bound_authority_rows = [
        *acquisition_permit["decisionBinding"]["files"],
        *predecessor_authority_rows,
        v13["wave14NamespaceAnchor"],
    ...
    require(
        ...
        and acquisition_permit["requestContract"]["tupleCount"] == 5
        and acquisition_permit["requestContract"]["requestCount"] == 10
        ...
        == {
            ...
            "checkerNormalizedSha256": (
                PERMIT.EXPECTED_V13_CHECKER_NORMALIZED
            ),
            "testsPath": (
            ...
            "contentSha256": PERMIT.EXPECTED_V13_CONTENT,
            "combinedInputSetSha256": PERMIT.EXPECTED_V13_INPUT_SET,
            "graphSha256": PERMIT.EXPECTED_V13_GRAPH,
            "frontierSha256": PERMIT.EXPECTED_V13_FRONTIER,
    ...
    require(
        len(resources) == 10
        and [row["requestOrdinal"] for row in resources] == list(range(1, 11))
        and [row["kind"] for row in resources] == ["mod", "zip"] * 5
    ...
    require(
        len(mod_by_tuple) == 5
        and aggregate_mod == 452
        and aggregate_zip == 5_064_794
        and aggregate == 5_065_246
        and aggregate_zip_entries == 1_645
        and aggregate_zip_uncompressed == 19_962_377
    ...
    evidence_expected = {
        "documentType": "aetherlink.wave15-source-acquisition-evidence",
        "schemaVersion": "1.0",
        "attemptId": PERMIT.ATTEMPT_ID,
        "requestCount": 10,
    ...
    receipt_expected = {
        "documentType": "aetherlink.wave15-source-acquisition-receipt",
        "schemaVersion": "1.0",
        ...
        "modCount": 5,
        "zipCount": 5,
        "acceptedResourceCount": 10,
        "aggregateResponseBytes": aggregate,
        "aggregateModResponseBytes": aggregate_mod,
        "aggregateZipResponseBytes": aggregate_zip,
        "aggregateZipEntryCount": aggregate_zip_entries,
        "aggregateZipUncompressedBytes": aggregate_zip_uncompressed,
        "dispatchBoundaryCount": 10,
        "responseCommittedCount": 10,
        "responseCommittedBytes": aggregate,
        "validationCommittedCount": 10,
        "persistenceCommittedCount": 10,
    ...
    return {
        ...
        "combinedFixedPointV13ContentSha256": PERMIT.EXPECTED_V13_CONTENT,
        "compactIdentitySha256": PERMIT.EXPECTED_COMPACT_IDENTITY,
        "fullWitnessSha256": PERMIT.EXPECTED_FULL_WITNESS,
...
def create_readback_claim(
    ...
    claim = content_bound(
        {
            "documentType": "aetherlink.wave15-acquisition-readback-one-use-claim",
            "schemaVersion": "1.0",
            "status": "consumed_active",
    ...
    try:
        ...
        try:
            ...
            receipt = content_bound(
                {
                    "documentType": "aetherlink.wave15-source-acquisition-readback",
                    "schemaVersion": "1.0",
                    "status": (
                        "wave15_acquisition_retained_snapshot_"
            ...
            manifest = content_bound(
                {
                    "documentType": (
                        "aetherlink.wave15-source-acquisition-readback-manifest"
                    ),
                    "schemaVersion": "1.0",
                    "status": (
                        "wave15_acquisition_retained_snapshot_"
...
def _post_success_reporting_failure() -> dict[str, Any]:
    return {
        "documentType": "aetherlink.wave15-acquisition-readback-error",
        "schemaVersion": "1.0",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.preflight:
            preflight()
            result = {
                "documentType": "aetherlink.wave15-acquisition-readback-preflight",
                "schemaVersion": "1.0",
