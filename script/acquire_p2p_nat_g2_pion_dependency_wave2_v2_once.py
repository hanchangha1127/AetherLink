#!/usr/bin/env python3
"""Acquire the exact G2 Pion dependency wave-two v2 MOD+ZIP set exactly once.
...
EXPECTED_PERMIT_STATUS = (
    "wave2_v2_dependency_source_acquisition_authorized_not_consumed"
)
...
EXPECTED_PERMIT_NEXT_ACTION = (
    "execute_bound_dependency_source_wave2_v2_once"
)
EXPECTED_PERMIT_ID = (
...
def load_authority(
    *,
    ...
    try:
        ...
        runner_binding = tool_bindings.get("wave2_v2_runner")
        if (
...
def validate_readback_terminal(
    ...
    if (
        ...
        != (
            "publish_wave2_v2_readback_manifest_then_rerun_"
        ...
        != "wave2_v2_independent_readback_published"
...
def preflight() -> dict[str, Any]:
    ...
    try:
        ...
        if classification == "clean":
            ...
            next_action = "run_separate_wave2_v2_independent_readback"
        ...
        return {
            "documentType": (
                "aetherlink.g2-pion-dependency-wave2-v2-runner-preflight"
            ),
            "schemaVersion": "1.0",
            "status": status,
...
def failure_document(
    ...
    *,
    ...
    return {
        ...
        "schemaVersion": "1.0",
        "status": "wave2_v2_acquisition_failed_permit_consumed",
...
def _execute_once_with_umask() -> dict[str, Any]:
    ...
    try:
        ...
        receipt = {
            "documentType": (
                "aetherlink.g2-pion-dependency-wave2-v2-acquisition-receipt"
            ),
            "schemaVersion": "1.0",
            ...
            **{name: counters[name] for name in COMMON.COUNTER_NAMES},
            ...
            "externalAuthenticationRequired": False,
            "userActionRequired": False,
            "nextAction": "run_separate_wave2_v2_independent_readback",
        }
        ...
        manifest = {
            "documentType": (
                "aetherlink.g2-pion-dependency-wave2-v2-acquisition-manifest"
            ),
            "schemaVersion": "1.0",
            "status": (
                "wave2_v2_acquisition_publication_complete_pending_"
        ...
        return {
            "documentType": (
                "aetherlink.g2-pion-dependency-wave2-v2-runner-result"
            ),
            "schemaVersion": "1.0",
            "status": "acquired_pending_independent_readback",
            **{name: counters[name] for name in COMMON.COUNTER_NAMES},
...
def error_document(failure: Any) -> dict[str, Any]:
    ...
    return {
        "documentType": (
            "aetherlink.g2-pion-dependency-wave2-v2-runner-error"
        ),
        "schemaVersion": "1.0",
        "status": (
