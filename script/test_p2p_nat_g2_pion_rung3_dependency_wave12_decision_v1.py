#!/usr/bin/env python3
"""Focused adversarial tests for the read-only Wave12 decision checker."""
...
if not (
    ...
    raise RuntimeError("Wave12 decision tests require `python3 -I -B -S`")
...
DECISION_PATH = (
    ...
    "bounded-dependency-source-identity-and-acquisition-decision-wave12-v1.json"
)
READER_PATH = (
    "docs/security-hardening/production-p2p-nat-v1/"
    "g2-pion-restricted-fork-v1/rung-three/"
    "bounded-dependency-source-identity-and-acquisition-decision-wave12-v1.md"
)
...
EXPECTED_V10_PIN_ORACLE = {
    ...
    "totalGraphArchiveOpenCount": 1_984,
}

EXPECTED_WAVE11_NAMESPACE_ANCHOR = {
    "path":
...
EXPECTED_OPERATION_COUNTER_ORACLE = {
    ...
    "totalFullSourceReconstructionCount": 18,
    "predecessorGraphArchiveOpenCount": 1_666,
    "currentV10GraphArchiveOpenCount": 318,
    "totalV10GraphArchiveOpenCount": 1_984,
    "identityWitnessScanCount": 2,
    "identityWitnessArchiveOpenCount": 318,
    "overallDecisionExecutionArchiveOpenCount": 2_302,
...
def load_checker(raw: bytes) -> types.ModuleType:
    ...
    module = types.ModuleType("wave12_decision_checker_test_subject")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(path),
            "__loader__": None,
            "__name__": "wave12_decision_checker_test_subject",
            "__package__": None,
        }
    )
    exec(
...
EXPECTED_CHECKER_CALL_COUNT = 736
EXPECTED_CHECKER_CALL_SURFACE_SHA256 = (
    "3f56941404df7e99cd179bef910a56c638bb002f940f1dfa4e3ce14f0baefc3a"
)
EXPECTED_CHECKER_FULL_AST_SHA256 = (
    "52317f3b8aa1cce210c41dda112909e06b801768046c44ae26324397f5819a35"
)
        ...
        if isinstance(call.func, ast.Name) and call.func.id in {
            ...
            if call.func.id == "compile":
                ...
                valid = (
                    ...
                    and call.args[1].id == "V10_CHECKER_PATH"
...
class UnitBoundaryTests(unittest.TestCase):
    ...
    def test_07_frontier_and_request_order_are_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            EXPECTED_V10_PIN_ORACLE["frontierSha256"],
        )
        self.assertNotEqual(
    ...
    def test_07c_v10_predecessor_pins_are_independent(self) -> None:
        actual = {
            "checkerPath": CHECKER.V10_CHECKER_PATH,
            "checkerRawSha256": CHECKER.V10_CHECKER_RAW_SHA256,
            "checkerNormalizedSha256":
                CHECKER.V10_CHECKER_NORMALIZED_SHA256,
            "testsPath": CHECKER.V10_TESTS_PATH,
            "testsRawSha256": CHECKER.V10_TESTS_RAW_SHA256,
            "contentSha256": CHECKER.V10_CANDIDATE_CONTENT_SHA256,
            "combinedInputSetSha256": CHECKER.V10_INPUT_SET_SHA256,
            "sourceBindingsSha256":
                CHECKER.V10_SOURCE_BINDINGS_SHA256,
            "graphSha256": CHECKER.V10_GRAPH_SHA256,
            "frontierSha256": CHECKER.V10_FRONTIER_SHA256,
            "fixedPointReached": False,
            "frontierTupleCount": CHECKER.EXPECTED_FRONTIER_COUNT,
            "totalFullSourceReconstructionCount": 18,
            "totalGraphArchiveOpenCount": 1_984,
        }
        self.assertEqual(actual, EXPECTED_V10_PIN_ORACLE)
        checker_raw = (
            ROOT / EXPECTED_V10_PIN_ORACLE["checkerPath"]
        ).read_bytes()
        tests_raw = (
            ROOT / EXPECTED_V10_PIN_ORACLE["testsPath"]
        ).read_bytes()
        self.assertEqual(
            sha256(checker_raw),
            EXPECTED_V10_PIN_ORACLE["checkerRawSha256"],
        )
        self.assertEqual(
            sha256(independent_normalized_checker_bytes(checker_raw)),
            EXPECTED_V10_PIN_ORACLE["checkerNormalizedSha256"],
        )
        self.assertEqual(
            sha256(tests_raw),
            EXPECTED_V10_PIN_ORACLE["testsRawSha256"],
        )
...
class HardeningBoundaryTests(unittest.TestCase):
    ...
    def test_wave12_namespace_rejects_stale_and_portable_aliases(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            try:
                CHECKER.validate_wave12_namespace_absent(*fds)
                cases = (
                    (dependency, ".WAVE-12-v1.claim"),
                    (
                        docs,
                        "bounded-dependency-source-acquisition-"
                        "wave12-execution-permit-v1.json",
                    ),
                    (
                        scripts,
                        "check_p2p_nat_g2_pion_rung3_dependency_"
                        "wave12_acquisition_v1.py",
                    ),
                )
        ...
        with mock.patch.object(
            ...
            with self.assertRaises(
                ...
                CHECKER.validate_wave12_namespace_absent(1, 2, 3)
        self.assertEqual(caught.exception.code, "E_WAVE12_NAMESPACE")
...
class LiveRepositoryTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.package_raw = {
            ...
            CHECKER.V10_CHECKER_PATH:
                (ROOT / CHECKER.V10_CHECKER_PATH).read_bytes(),
            CHECKER.V10_TESTS_PATH:
                (ROOT / CHECKER.V10_TESTS_PATH).read_bytes(),
        }
    ...
    def test_08_self_reader_tests_and_v10_pins(self) -> None:
        self.assertEqual(
            sha256(
        ...
        self.assertEqual(
            sha256(self.package_raw[CHECKER.V10_CHECKER_PATH]),
            EXPECTED_V10_PIN_ORACLE["checkerRawSha256"],
        )
        self.assertEqual(
            sha256(self.package_raw[CHECKER.V10_TESTS_PATH]),
            EXPECTED_V10_PIN_ORACLE["testsRawSha256"],
        )
    ...
    def test_10_authority_scope_and_counters_are_closed(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                EXPECTED_V10_PIN_ORACLE["checkerNormalizedSha256"],
                EXPECTED_V10_PIN_ORACLE["testsRawSha256"],
                EXPECTED_V10_PIN_ORACLE["contentSha256"],
                EXPECTED_V10_PIN_ORACLE["combinedInputSetSha256"],
                EXPECTED_V10_PIN_ORACLE["sourceBindingsSha256"],
                EXPECTED_V10_PIN_ORACLE["graphSha256"],
                EXPECTED_V10_PIN_ORACLE["frontierSha256"],
                EXPECTED_V10_PIN_ORACLE["frontierTupleCount"],
            ),
        )
        self.assertEqual(
            (
        ...
        cases = (
            ...
            (
                lambda value:
                    value["predecessorBindings"][
                        "combinedFixedPointV10"
                    ]["wave11NamespaceAnchor"].__setitem__(
                        "rawSha256",
                        "0" * 64,
                    ),
                "E_DECISION_LINEAGE",
            ...
            (
                lambda value:
                    value["predecessorBindings"][
                        "combinedFixedPointV10"
                    ].__setitem__("v9TestsLiveHeld", True),
                "E_DECISION_LINEAGE",
            ),
            (
                lambda value:
