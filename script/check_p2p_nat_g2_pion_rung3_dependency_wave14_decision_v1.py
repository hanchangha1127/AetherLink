#!/usr/bin/env python3
"""Validate the read-only Wave14 identity and acquisition decision.

Run only with ``python3 -I -B -S``.  The checker executes the exact pinned
combined-v12 candidate, then scans the retained 333 inputs twice using only the
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "Wave14 decision checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
CHECKER_ID = "g2-pion-ice-v4.3.0-wave14-identity-acquisition-decision-check-v1"
DECISION_ID = (
    "g2-pion-ice-v4.3.0-rung3-bounded-dependency-source-identity-and-"
    "acquisition-decision-wave14-v1"
)
DEPENDENCY_ROOT = "build/offline-source/pion-ice-v4.3.0/dependencies"
NAMESPACE_ANCHOR_PATH = f"{DEPENDENCY_ROOT}/.wave-13-v1.claim"
NAMESPACE_ANCHOR_RAW_SHA256 = (
    "085fdfae86d88a53526c836e61f956b89694c67cf54ea95b9ef43cb2a8566cc2"
)
WAVE14_CLAIM_PATH = f"{DEPENDENCY_ROOT}/.wave-14-v1.claim"
WAVE14_STAGING_PREFIX = ".wave-14-v1-staging-"
WAVE14_ACCEPTED_PATH = f"{DEPENDENCY_ROOT}/wave-14-v1/accepted"
...
EXPECTED_GO_SUM_ENTRY_COUNT = 116
...
EXPECTED_NON_CLAIMS = (
    ...
    "wave14_dependency_source_not_acquired",
...
def portable_name(value: str) -> str:
    require(type(value) is str, "E_WAVE14_NAMESPACE")
    return unicodedata.normalize("NFC", value).casefold()


def validate_wave14_namespace_absent(
    ...
    try:
        ...
        raise DecisionFailure("E_WAVE14_NAMESPACE") from error
    require(
    ...
    for name in dependency_names:
        ...
        require(
            not normalized.startswith(".wave-14-v1")
            and not normalized.startswith("wave-14-v1"),
            "E_WAVE14_NAMESPACE",
        )
    ...
    for name in docs_names:
        ...
        require(
            not normalized.startswith(
                "bounded-dependency-source-acquisition-wave14"
            ),
            "E_WAVE14_NAMESPACE",
        )
    ...
    for name in script_names:
        normalized = portable_name(name)
        if "p2p_nat_g2_pion" in normalized and "wave14" in normalized:
            require(
...
class BootstrapPinnedCodeFile:
    """Immediate-ownership bootstrap pin matching combined-v12 semantics."""
...
def load_v12_checker(
    held: BootstrapPinnedCodeFile,
) -> types.ModuleType:
    module = types.ModuleType("aetherlink_combined_v12_pinned")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(ROOT / V12_CHECKER_PATH),
            "__loader__": None,
            "__name__": "aetherlink_combined_v12_pinned",
            "__package__": None,
        }
    )
    try:
        ...
        raise DecisionFailure("E_V12_LOAD") from error
    for name in (
        "PinnedCodeFile",
        "SafeHeldInputSet",
        "generate_candidate",
...
def require_closed_identity(scan: Mapping[str, Any]) -> None:
    ...
    require(
        ...
        and scan["archiveCount"] == 167
        and scan["externalModCount"] == 166
...
def validate_v12_candidate(
    candidate: Mapping[str, Any],
) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    require(type(candidate) is dict, "E_V12_CANDIDATE")
    ...
    require(
        ...
        and inputs.get("resourceCount") == 332
        and inputs.get("modCount") == 166
        and inputs.get("zipCount") == 166
        ...
        and inputs.get("uniqueModuleVersionTupleCount") == 166
        and inputs.get("aggregateRawByteSize") == 307_486_547
    ...
    require(
        ...
        == 44
        and verification.get("pinnedV11PredecessorExecuted") is True
        and verification.get("v11TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and verification.get("v11TestsLiveHeld") is False
        and type(predecessor_verification) is dict
        and predecessor_verification.get("v11TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and predecessor_verification.get("v11TestsLiveHeld") is False
        ...
        and verification.get("wave13RetainedFdPreManifestBarrierCount")
        == 3
        and verification.get("wave13CompletionAppliesToRetainedSnapshot")
        is True
        and verification.get(
        ...
        and verification.get("hardenedCheckerModuleCount") == 11
        and verification.get("providerFacadeLoadCount") == 11
        ...
        and counters.get("directArchiveOpenCount") == 334
        and counters.get("inheritedArchiveOpenCount") == 2_310
        and counters.get("totalArchiveOpenCount") == 2_644
        and counters.get("archiveOpenCount") == 2_644
        and counters.get("heldSourceInputCount") == 333
        and counters.get("heldTerminalEvidenceCount") == 87
        and counters.get("heldAuxiliaryEvidenceCount") == 3
        and counters.get("heldToolInputCount") == 11
        and counters.get("transitiveDistinctToolPathCount") == 13
        and counters.get("stableReadPassesPerHeldInput") == 2
        and counters.get("directFullSourceReconstructionCount") == 2
        and counters.get("inheritedFullSourceReconstructionCount") == 20
        and counters.get("totalFullSourceReconstructionCount") == 22
        ...
        and len(tool_bindings) == 11
        and type(terminal_bindings) is list
        and len(terminal_bindings) == 87
...
def expected_tool_bindings(
    ...
    require(
        ...
        == TESTS_RAW_SHA256
        and sha256_bytes(package_raw[V12_CHECKER_PATH])
        == V12_CHECKER_RAW_SHA256
        and sha256_bytes(
            package_raw[V12_TESTS_PATH]
        )
        == V12_TESTS_RAW_SHA256,
        "E_TOOL_IDENTITY",
    )
    ...
    *,
    ...
    return {
        "documentType": (
            ...
            "identity-and-acquisition-decision-wave14"
        ),
        "schemaVersion": "1.0",
        ...
        "date": "2026-07-27",
        "status": (
            "wave14_exact_4_frontier_identity_classified_"
        ...
        "predecessorBindings": {
            "combinedFixedPointV12": {
                ...
                "fixedPointReached": False,
                "frontierTupleCount": EXPECTED_FRONTIER_COUNT,
                "totalFullSourceReconstructionCount": 22,
                "totalGraphArchiveOpenCount": 2644,
                ...
                "retainedSnapshotBoundary": {
                    ...
                    "liveTerminalControlMetadataVerifiedAtCombinedV12Barrier":
                        True,
                    "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV12Barrier":
                        True,
                    "finalNamespaceReverifiedAfterCombinedV12Reconstruction":
                        True,
        ...
        "sourceAcquisitionPreparation": {
            ...
            "modulePathEncoding":
                "current_wave14_lowercase_ascii_direct_proxy_path",
            "claimPath": WAVE14_CLAIM_PATH,
            "stagingDirectoryPrefix": WAVE14_STAGING_PREFIX,
            "acceptedDirectoryPath": WAVE14_ACCEPTED_PATH,
        ...
        "operationCounters": {
            "combinedV12CandidateInvocationCount": 1,
            "predecessorFullSourceReconstructionCount": 20,
            "directV12FullSourceReconstructionCount": 2,
            "totalFullSourceReconstructionCount": 22,
            "predecessorGraphArchiveOpenCount": 2310,
            "currentV12GraphArchiveOpenCount": 334,
            "totalV12GraphArchiveOpenCount": 2644,
            "identityWitnessScanCount": 2,
            "identityWitnessArchiveOpenCount": 334,
            "overallDecisionExecutionArchiveOpenCount": 2978,
        ...
        "closure": {
            "wave14IdentityResolved": True,
            "wave14AcquisitionReady": True,
            "wave14AcquisitionComplete": False,
        ...
        "nextAction": (
            "prepare_separate_one_use_8_resource_wave14_source_"
...
def validate_semantic_decision(
    ...
    combined = (
        predecessors.get("combinedFixedPointV12")
    ...
    require(
        exact_keys(predecessors, {"combinedFixedPointV12"})
        ...
        and combined["v11TestsLiveHeld"] is False
        and all(
    ...
    require(
        ...
        and held["sourceBindingCount"] == 333
        and held["sourceBindingsSha256"]
        == V12_SOURCE_BINDINGS_SHA256
        and held["archiveCount"] == 167
        and held["externalModCount"] == 166
    ...
    require(
        ...
        == "current_wave14_lowercase_ascii_direct_proxy_path"
        and preparation["claimPath"] == WAVE14_CLAIM_PATH
        and preparation["stagingDirectoryPrefix"]
        == WAVE14_STAGING_PREFIX
        and preparation["acceptedDirectoryPath"]
        == WAVE14_ACCEPTED_PATH
...
def evaluate(
    ...
    *,
    ...
    with ExitStack() as stack:
        ...
        v12_tests_held = stack.enter_context(
            v12.PinnedCodeFile(
                root,
                V12_TESTS_PATH,
                V12_TESTS_RAW_SHA256,
        ...
        package_raw = {
            ...
            V12_CHECKER_PATH: v12_held.raw,
            V12_TESTS_PATH: v12_tests_held.raw,
        }
        held: list[Any] = [
            self_held,
            v12_held,
        ...
        validate_wave14_namespace_absent(
            namespace_anchor_held.parent_fd,
            reader_held.parent_fd,
            self_held.parent_fd,
        )
        identity_barrier(root, held)
        candidate = v12.generate_candidate(root)
        identity_barrier(root, held)
        wave_rows, source_bindings = validate_v12_candidate(candidate)
        v12 = v12.harden_checker_module(v12)
        ...
        require(
            type(runner) is v12.ReadOnlyProviderFacade
            and v11.PinnedCodeFile is v12.PinnedCodeFile
            and v10.PinnedCodeFile is v12.PinnedCodeFile
            and v9.PinnedCodeFile is v12.PinnedCodeFile
            and v8.PinnedCodeFile is v12.PinnedCodeFile
            and v7.PinnedCodeFile is v12.PinnedCodeFile
            and v6.PinnedCodeFile is v12.PinnedCodeFile
            and v5.PinnedCodeFile is v12.PinnedCodeFile
            and v4.PinnedCodeFile is v12.PinnedCodeFile
            and v1.PinnedRunnerFile is v12.SafePinnedRunnerFile,
            "E_SAFE_RUNTIME",
        )
        ...
        require(
            ...
            == source_bindings
            and len(full_source_bindings) == 333
            and all(
                type(row) is dict
    ...
    return expected, {
        "documentType":
            "aetherlink.wave14-identity-acquisition-decision-check",
        "schemaVersion": "1.0",
        "status":
...
def error_document(code: str) -> dict[str, Any]:
    return {
        "documentType":
            "aetherlink.wave14-identity-acquisition-decision-error",
        "schemaVersion": "1.0",
