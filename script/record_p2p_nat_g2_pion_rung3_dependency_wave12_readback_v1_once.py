#!/usr/bin/env python3
"""Record one independent offline readback of the Wave12 v1 acquisition."""
...
if not (
    ...
    raise RuntimeError("Wave12 readback recorder requires `python3 -I -B -S`")
...
if O_NOFOLLOW is None:
    raise RuntimeError("Wave12 readback recorder requires O_NOFOLLOW")
...
EXPECTED_READBACK_CHECKER_RAW = "0f0d410e7fc49e6d08108db117cfc384d506edb5a3a67dede3d1738282dff5b9"
...
def load_readback_checker() -> types.ModuleType:
    ...
    module = types.ModuleType("wave12_acquisition_readback_permit_v1")
...
def verify_snapshot(snapshot: FrozenSnapshot) -> dict[str, Any]:
    ...
    v10 = acquisition_permit["predecessorBindings"]["combinedFixedPointV10"]
    predecessor_authority_rows = [
        {
            "path": v10["checkerPath"],
            "rawSha256": v10["checkerRawSha256"],
        },
        {
            "path": v10["testsPath"],
            "rawSha256": v10["testsRawSha256"],
        },
    ]
    ...
    require(
        ...
        == {
            ...
            "checkerNormalizedSha256": (
                PERMIT.EXPECTED_V10_CHECKER_NORMALIZED
            ),
            "testsPath": (
            ...
            "contentSha256": PERMIT.EXPECTED_V10_CONTENT,
            "combinedInputSetSha256": PERMIT.EXPECTED_V10_INPUT_SET,
            "graphSha256": PERMIT.EXPECTED_V10_GRAPH,
            "frontierSha256": PERMIT.EXPECTED_V10_FRONTIER,
    ...
    require(
        ...
        and aggregate_zip == 15_035_516
        and aggregate == 15_036_269
        and aggregate_zip_entries == 2_547
        and aggregate_zip_uncompressed == 55_940_531
    ...
    evidence_expected = {
        "documentType": "aetherlink.wave12-source-acquisition-evidence",
        "schemaVersion": "1.0",
        "attemptId": PERMIT.ATTEMPT_ID,
        "requestCount": 8,
    ...
    receipt_expected = {
        "documentType": "aetherlink.wave12-source-acquisition-receipt",
        "schemaVersion": "1.0",
    ...
    return {
        ...
        "combinedFixedPointV10ContentSha256": PERMIT.EXPECTED_V10_CONTENT,
        "compactIdentitySha256": PERMIT.EXPECTED_COMPACT_IDENTITY,
        "fullWitnessSha256": PERMIT.EXPECTED_FULL_WITNESS,
...
def create_readback_claim(
    ...
    claim = content_bound(
        {
            "documentType": "aetherlink.wave12-acquisition-readback-one-use-claim",
            "schemaVersion": "1.0",
            "status": "consumed_active",
    ...
    try:
        ...
        try:
            ...
            receipt = content_bound(
                {
                    "documentType": "aetherlink.wave12-source-acquisition-readback",
                    "schemaVersion": "1.0",
                    "status": (
            ...
            manifest = content_bound(
                {
                    "documentType": (
                        "aetherlink.wave12-source-acquisition-readback-manifest"
                    ),
                    "schemaVersion": "1.0",
                    "status": (
                        "wave12_acquisition_retained_snapshot_"
...
def _post_success_reporting_failure() -> dict[str, Any]:
    return {
        "documentType": "aetherlink.wave12-acquisition-readback-error",
        "schemaVersion": "1.0",
...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    try:
        ...
        if args.preflight:
            preflight()
            result = {
                "documentType": "aetherlink.wave12-acquisition-readback-preflight",
                "schemaVersion": "1.0",
