...
echo "Covered shared release version ledger addendum: Android release and macOS package metadata consume one strictly increasing 1.0.0+1 ledger while development IDs remain unchanged."
