...
PY
	...
	run swift test --filter 'LocalRuntimeMessageRouterTests/testHelloRejectsInvalidAllowedPayloadTypesBeforeChallengeCreation|LocalRuntimeMessageRouterTests/testHelloCapabilityCountBoundAccepts64AndRejects65|LocalRuntimeMessageRouterTests/testAuthResponseRejectsBlankAllowedFieldsBeforeAuthentication'
