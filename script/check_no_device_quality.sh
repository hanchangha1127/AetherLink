...
echo "Covered Android scanner addendum: Android QR scanner compact pairing-state render smoke, Android QR scanner scan-target accessibility label, Android QR scanner invalid-code recovery."
...
echo "Not covered by this no-device gate: physical install, camera QR scan, real device haptics, launcher/Dock screenshots, physical/live-backend streamed chat/cancel, and real different-network runtime connectivity."
