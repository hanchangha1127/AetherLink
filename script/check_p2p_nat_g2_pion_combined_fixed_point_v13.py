#!/usr/bin/env python3
"""Recompute the exact 341-input Wave1..Wave14 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v12
combined checker, all Wave14 decision/acquisition/readback controls, and the
root archive plus 170 mod and 170 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v13 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v13.py"
...
CHECKER_ID = (
    ...
    "wave7-wave8-wave9-wave10-wave11-wave12-wave13-wave14-check-v13"
)
...
WAVE14_CONTROL_SHA256 = {
    ...
    WAVE14_READBACK_PERMIT_PATH:
        "ec37dd4a09d9de27832900050428d4283496bffc845d97f2b9425664eaee06f7",
    WAVE14_READBACK_PATH:
        "feef3aa3b18731325bd2a2102810e668692d95276783f06fa5d7a0d8c513472e",
    WAVE14_READBACK_MANIFEST_PATH:
        "34475b96fb5c8756683dee7788a3519f6c5b85fed29e90a9d9934e5e223a15ff",
}
WAVE14_CONTROL_METADATA = {
    WAVE14_DECISION_PATH: (14_365, 0o644),
    WAVE14_PERMIT_PATH: (18_884, 0o644),
    WAVE14_RECEIPT_PATH: (1_663, 0o600),
    WAVE14_MANIFEST_PATH: (465, 0o600),
    WAVE14_READBACK_PERMIT_PATH: (18_781, 0o644),
    WAVE14_READBACK_PATH: (7_265, 0o600),
    WAVE14_READBACK_MANIFEST_PATH: (2_301, 0o600),
}
WAVE14_CONTENT_SHA256 = {
    WAVE14_DECISION_PATH:
    ...
    WAVE14_READBACK_PERMIT_PATH:
        "36c03068055da804099572f71d908e10720c3eb524c4cd19b0e889d076d8632f",
    WAVE14_READBACK_PATH:
        "10e139640cfd028b693890f66d3be084c4f9ae1b6662c27f4a41e605e7e426de",
    WAVE14_READBACK_MANIFEST_PATH:
        "d10dfcf908d0fceff1730c061a8096acf19c5e00552097f8777f34aa2f066bda",
}
WAVE14_REQUEST_SET_SHA256 = (
    "505587c90ec32b1dea879b1e034450de091874a2ff9db9993532f1b14d9dc3aa"
)
WAVE14_PERMIT_RESOURCES_SHA256 = (
    "ba1741c181b834c42c2501232fc8d99e5dfae3e02fb1d927fdb56f3248d20b6e"
)
WAVE14_RESOURCE_SET_SHA256 = (
    "23a5e8e4efaa6d0cf63549eaa686e5b9e365d38b832be5f5f14e0e8722a327ec"
)
WAVE14_FROZEN_FILE_SET_SHA256 = (
    "905f7a4e90abbe1fb311385e001fac94a1dee32235b408a794e663eb049458ec"
)
WAVE14_ATTEMPT_ID = "7fef20e6c3931b698f32b2a71f8a596a"
WAVE14_READBACK_ATTEMPT_ID = "177051373b1754fd638b5f57df2d6515"
WAVE14_COMPACT_IDENTITY_SHA256 = (
    "a59b37276b85f5da5cbf2c39a560c7834582cf1f590e050d53e016ed80fb6185"
)
WAVE14_FULL_WITNESS_SHA256 = (
    "cf39e4c68e001b3d687df829e7d7903d4ebea69b11ee60f21d5385f9591fa542"
)
WAVE14_HELD_SOURCE_BINDINGS_SHA256 = (
    "bf043a07c5fa6d26f28de9954b8f676e583f625ccf28ca5a39d6fe23c6678592"
)
WAVE14_ACQUISITION_CLAIM_RAW_SHA256 = (
    "e67441825a0acd2741bf3a87d46020066a607476c08091c374b4f707059b3d40"
)
WAVE14_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "cd8b5528f0080d5405bfb021e163afde4a8a88b1e5d74542396bc5e1269dc343"
)
WAVE14_ACQUISITION_CHECKER_RAW_SHA256 = (
    "a19f4f9c89f92f694b4de2d54646a9033af3872f4f8fb461e667b31463255b9f"
)
WAVE14_ACQUISITION_RUNNER_RAW_SHA256 = (
    "2a8add24b10cf8b1995b60a66f499c298e18fb513514dd1933f5ea04a2b36c2c"
)
WAVE14_READBACK_CLAIM_RAW_SHA256 = (
    "2ee48efdbed1a6342a6f0a36b35b59c5a9f6271b704fa0314b3c73ea0c1c5ab5"
)
WAVE14_READBACK_CLAIM_CONTENT_SHA256 = (
    "57b75a53220597e35c40c8f1f85d911b4f1deca8ffca96bf6a11630df8a047b0"
)
WAVE14_READBACK_CHECKER_RAW_SHA256 = (
    "d7956fbef75adaa4e6609896d04f871668923392f26af2d33e54c113007d754b"
)
WAVE14_READBACK_RECORDER_RAW_SHA256 = (
    "ff2310ee1475d66c8c727760859e2f7f999eecdcf2dedca5175b7cf1f69e6ec5"
)
WAVE14_READBACK_RECORDER_NORMALIZED_SHA256 = (
    "f8ae1cc17b1c9e1fcc0772cd077c99c0eecff565f4ee9bd551fa9411d40a14e5"
)
WAVE14_RETAINED_BARRIERS = [
...
WAVE14_ABSOLUTE_RESOURCE_LIMITS = {
...
WAVE14_READBACK_RESOURCE_LIMITS = {
...
WAVE14_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave14_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE14_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE14_CONTENT_SHA256[WAVE14_READBACK_PERMIT_PATH],
        "path": WAVE14_READBACK_PERMIT_PATH,
        "rawSha256": WAVE14_CONTROL_SHA256[WAVE14_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
        ...
        "rawSha256": WAVE14_READBACK_RECORDER_RAW_SHA256,
    },
}
WAVE14_DECISION_TOOL_BINDINGS = [
    {
        "normalizedSha256":
        ...
        "role": "current_wave14_decision_checker",
    },
    {
        "path":
        ...
        "role": "current_wave14_decision_tests",
    },
    {
        "normalizedSha256": V12_CHECKER_NORMALIZED_SHA256,
        "path": V12_CHECKER_PATH,
        "rawSha256": V12_CHECKER_RAW_SHA256,
        "role": "immutable_combined_v12_checker",
    },
    {
        "path": V12_TESTS_PATH,
        "rawSha256": V12_TESTS_RAW_SHA256,
        "role": "immutable_combined_v12_tests",
    },
]
WAVE14_ACQUISITION_TOOL_BINDINGS = [
    {
        "path":
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave14_acquisition_v1.py",
        "rawSha256": WAVE14_ACQUISITION_CHECKER_RAW_SHA256,
    },
    {
        "path":
    ...
    },
    {
        ...
        "rawSha256": WAVE14_ACQUISITION_RUNNER_RAW_SHA256,
    },
    {
        "path":
...
WAVE14_READBACK_TOOL_BINDINGS = [
    WAVE14_READBACK_AUTHORITY_BINDING["checker"],
    {
        "path": (
        ...
        "rawSha256":
            "12a3baa4ee4dd078230f565451bfc7fbd98b623a3e2ec5b824b7b5789fd77b78",
    },
    WAVE14_READBACK_AUTHORITY_BINDING["recorder"],
    {
        "path": (
        ...
        "rawSha256":
            "e8dde2bf95b1b80a6102b17b1b89461285679d3d09efb6e22b2476a3598aae0f",
    },
]
...
def wave14_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v13_safe_hardened") is True:
        return module
    module.__dict__["_v13_safe_hardened"] = True
...
def wave14_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE14_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE14_CONTROL_SHA256.items()
    ]


def parse_wave14_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE14_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE14_JSON")
        result[path] = value
    return result


def wave14_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE14_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE14_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 416,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE14_EVIDENCE_PATH,
            "rawSha256": WAVE14_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 3_385,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE14_READBACK_CLAIM_PATH,
            "rawSha256": WAVE14_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_255,
            "ownerOnly": True,
...
def validate_wave14_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE14_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE14_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE14_EVIDENCE_PATH]
    readback = control_held.files[WAVE14_READBACK_PATH]
    readback_manifest = control_held.files[WAVE14_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE14_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE14_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE14_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE14_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE14_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE14_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE14_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE14_READBACK_PERMIT_PATH]
    ...
    check(
        ...
        and all(
            Path(row["path"]).parent.as_posix() == WAVE14_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE14_NAMESPACE",
    )
...
def validate_wave14_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE14_ATTEMPT_ID,
            "checkerRawSha256": WAVE14_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave14-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE14_CONTENT_SHA256[WAVE14_PERMIT_PATH],
            "requestCount": 8,
            "schemaVersion": "1.0",
            "status": "consumed_active",
            "userActionRequired": False,
        },
        "E_WAVE14_ACQUISITION_CLAIM",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE14_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE14_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE14_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE14_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE14_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave14-acquisition-readback-one-use-claim"
        ...
        "E_WAVE14_READBACK_CLAIM",
    )


def validate_wave14_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE14_EVIDENCE")
    readback = documents[WAVE14_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE14_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave14-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE14_ATTEMPT_ID
        and evidence_document.get("requestCount") == 8
        and evidence_document.get("aggregateResponseBytes") == 15_051_448
        and evidence_document.get("aggregateModResponseBytes") == 753
        and evidence_document.get("aggregateZipResponseBytes") == 15_050_695
        and evidence_document.get("aggregateZipEntryCount") == 2_571
...
def verify_wave14_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE14_DECISION_PATH],
        WAVE14_CONTENT_SHA256[WAVE14_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE14_PERMIT_PATH],
        WAVE14_CONTENT_SHA256[WAVE14_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE14_CONTENT_SHA256[path],
        )


def validate_v12_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == V12_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V12_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V12_FRONTIER_SHA256
        and predecessor.get("frontierTupleCount") == 4
        and predecessor.get("fixedPointReached") is False
        and predecessor.get("checkerPath") == V12_CHECKER_PATH
        and predecessor.get("checkerRawSha256") == V12_CHECKER_RAW_SHA256
        and predecessor.get("checkerNormalizedSha256")
        == V12_CHECKER_NORMALIZED_SHA256
        and predecessor.get("testsPath") == V12_TESTS_PATH
        and predecessor.get("testsRawSha256") == V12_TESTS_RAW_SHA256
        and predecessor.get("totalFullSourceReconstructionCount") == 22
        and predecessor.get("totalGraphArchiveOpenCount") == 2_644
        ...
        and predecessor.get("v11TestsBindingScope")
        == "historical_metadata_only_not_live_held"
        and predecessor.get("v11TestsLiveHeld") is False
        and predecessor.get("wave13NamespaceAnchor")
        == {
            "path": (
                "build/offline-source/pion-ice-v4.3.0/dependencies/"
                ".wave-13-v1.claim"
        ...
        == {
            ...
            "finalNamespaceReverifiedAfterCombinedV12Reconstruction": True,
            "historicalExact27FrozenSnapshotDescriptorSetBound": True,
            "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV12Barrier":
                True,
            "liveTerminalControlMetadataVerifiedAtCombinedV12Barrier": True,
        ...
        == {
            ...
            "sha256": V12_CANDIDATE_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == V12_CANDIDATE_CONTENT_SHA256
        and candidate.get("schemaVersion") == "12.0"
        ...
        == {
            ...
            "frontierSha256": V12_FRONTIER_SHA256,
        }
        and type(inputs) is dict
        and inputs.get("heldSourceInputCount") == 333
        and inputs.get("combinedInputSetSha256") == V12_INPUT_SET_SHA256
        and sha256_bytes(runner.canonical_json_bytes(source_bindings))
        == V12_INPUT_SET_SHA256
        and sha256_bytes(wave14_digest_bytes(source_bindings))
        == V12_SOURCE_BINDINGS_SHA256
        and len({row["path"] for row in source_bindings}) == 333
        and sum(row["kind"] == "root_zip" for row in source_bindings) == 1
        and sum(row["kind"] == "mod" for row in source_bindings) == 166
        and sum(row["kind"] == "zip" for row in source_bindings) == 166
        ...
        and graph.get("graphSha256") == V12_GRAPH_SHA256
        ...
        == V12_FRONTIER_SHA256
        and candidate.get("authority") == V12_AUTHORITY
        and candidate.get("checkerVerification", {}).get(
    ...
    return {
        ...
        "wave13CompletionAppliesToRetainedSnapshot": True,
        "wave13CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave13SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
        "v12TestsBindingScope": "historical_metadata_only_not_live_held",
        "v12TestsLiveHeld": False,
    }


def wave14_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE14_DECISION_PATH]
    permit = documents[WAVE14_PERMIT_PATH]
    receipt = documents[WAVE14_RECEIPT_PATH]
    manifest = documents[WAVE14_MANIFEST_PATH]
    readback_permit = documents[WAVE14_READBACK_PERMIT_PATH]
    readback = documents[WAVE14_READBACK_PATH]
    readback_manifest = documents[WAVE14_READBACK_MANIFEST_PATH]
    verify_wave14_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE14_CONTENT_SHA256[WAVE14_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave14_exact_4_frontier_identity_classified_4_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and decision.get("authority") == WAVE14_DECISION_AUTHORITY
        and decision.get("toolBindings") == WAVE14_DECISION_TOOL_BINDINGS
        ...
        and held_set.get("sourceBindingCount") == 333
        ...
        and sha256_bytes(wave14_digest_bytes(source_requests))
        == WAVE14_REQUEST_SET_SHA256,
        "E_WAVE14_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE14_CONTENT_SHA256[WAVE14_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE14_ACQUISITION_AUTHORITY
        and permit.get("toolBindings") == WAVE14_ACQUISITION_TOOL_BINDINGS
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE14_CONTROL_SHA256[WAVE14_DECISION_PATH]
        ...
        == WAVE14_ABSOLUTE_RESOURCE_LIMITS
        and permit.get("zipLimits") == WAVE14_ZIP_LIMITS
        and permit_predecessor
        == {
            "checkerNormalizedSha256": V12_CHECKER_NORMALIZED_SHA256,
            "checkerPath": V12_CHECKER_PATH,
            "checkerRawSha256": V12_CHECKER_RAW_SHA256,
            "combinedInputSetSha256": V12_INPUT_SET_SHA256,
            "contentSha256": V12_CANDIDATE_CONTENT_SHA256,
            "frontierSha256": V12_FRONTIER_SHA256,
            "graphSha256": V12_GRAPH_SHA256,
            "sourceBindingsSha256": V12_SOURCE_BINDINGS_SHA256,
            "testsPath": V12_TESTS_PATH,
            "testsRawSha256": V12_TESTS_RAW_SHA256,
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE14_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE14_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 8
        and receipt.get("modCount") == 4
        and receipt.get("zipCount") == 4
        and receipt.get("aggregateResponseBytes") == 15_051_448
        and receipt.get("aggregateModResponseBytes") == 753
        and receipt.get("aggregateZipResponseBytes") == 15_050_695
        and receipt.get("aggregateZipEntryCount") == 2_571
        and receipt.get("aggregateZipUncompressedBytes") == 55_954_414
    ...
    check(
        ...
        == {
            ...
            "receiptPath": WAVE14_RECEIPT_PATH,
            "receiptRawSha256": WAVE14_CONTROL_SHA256[WAVE14_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV12")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV12PredecessorBindingRecomputed",
                ...
                "v11TestsLiveHeld", "v12TestsLiveHeld",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE14_CONTENT_SHA256[WAVE14_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE14_READBACK_AUTHORITY
        ...
        is False
        and verification_contract.get("v11TestsLiveHeld") is False
        and verification_contract.get("v12TestsLiveHeld") is True
        and verification_contract.get(
            "requestResourcesCanonicalSha256Recomputed"
        ) is True
        ...
        and snapshot.get("attemptId") == WAVE14_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE14_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE14_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE14_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-14-v1-staging-",
        }
        ...
        and snapshot.get("aggregateAcceptedBytes") == 15_051_448
        and snapshot.get("aggregateModBytes") == 753
        and snapshot.get("aggregateZipBytes") == 15_050_695
        and snapshot.get("aggregateZipEntryCount") == 2_571
        and snapshot.get("aggregateZipUncompressedBytes") == 55_954_414
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave14_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE14_RECEIPT_PATH,
            "rawSha256": WAVE14_CONTROL_SHA256[WAVE14_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE14_MANIFEST_PATH,
            "rawSha256": WAVE14_CONTROL_SHA256[WAVE14_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE14_ACCEPTED_DIRECTORY
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV12ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE14_CONTENT_SHA256[WAVE14_READBACK_PATH],
        }
        and readback.get("status")
        == "wave14_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE14_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE14_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_255,
            "contentSha256": WAVE14_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == 55_954_414
        and verified.get("combinedFixedPointV12ContentSha256")
        == V12_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE14_CONTENT_SHA256[
                WAVE14_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave14_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE14_ATTEMPT_ID
        ...
        == {
            "bytes": 7_265,
            "contentSha256": WAVE14_CONTENT_SHA256[WAVE14_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE14_READBACK_PATH,
            "rawSha256": WAVE14_CONTROL_SHA256[WAVE14_READBACK_PATH],
        }
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave14-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE14_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v12.combined_source_bindings(
        v11,
        v10,
        v9,
        v8,
    ...
    bindings.extend(wave14_request_resources(v4, runner, wave14_documents))
    check(
        len(bindings) == 341
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 170
        and sum(row["kind"] == "zip" for row in bindings) == 170
    ...
    check(
        len({row["path"] for row in bindings}) == 341
        and len(
            {
                (row["module"], row["version"])
                for row in bindings
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 171)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def derive_and_validate_tool_paths(
    ...
    declared_v12_paths = v12.TRANSITIVE_CHECKER_PATHS
    ...
    check(
        ...
        and type(declared_v12_paths) is set
        and declared_v12_paths
        == TRANSITIVE_CHECKER_PATHS - {V12_CHECKER_PATH}
        ...
        == len(
            declared_v12_paths
            | {V12_CHECKER_PATH, v12.V1_PROVIDER_PATH}
        )
    ...
    transitive_paths = direct_binding_paths | declared_v12_paths
    check(
        transitive_paths
...
def execute_reconstruction_protocol_prefix(
    ...
    validate_wave14_completed_namespace(control_held, wave14_documents)
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        v12 = load_v12_checker(v12_held)
        predecessor_candidate = v12.generate_candidate(root)
        v12 = harden_checker_module(v12)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                direct_tool_bindings = [
                    {
                        "role": "current_v13_combined_checker",
                        "path": SELF_PATH,
                ...
                check(
                    v12.PinnedCodeFile is PinnedCodeFile
                    ...
                    and len(direct_tool_paths) == 12
                    and len(transitive_tool_paths) == 14
                ...
                auxiliary_evidence = wave14_auxiliary_evidence_bindings()
                check(
                    len(controls) == 94
                ...
                with runner.HeldInputSet(
                    ...
                    wave14_documents = parse_wave14_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v12_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave14_documents[WAVE14_DECISION_PATH],
                        )
                    )
                    ...
                    wave14_evidence_raw = control_held.raw[WAVE14_EVIDENCE_PATH]
                    wave14_evidence_document = runner.strict_json(
                        wave14_evidence_raw,
                        WAVE14_EVIDENCE_PATH,
                    )
                    validate_wave14_evidence(
                        runner,
                        wave14_evidence_raw,
                        wave14_evidence_document,
                        wave14_documents,
                    )
                    validate_wave14_consumed_claims(
                        runner,
                        control_held.raw[WAVE14_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE14_READBACK_CLAIM_PATH],
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        limits = {
                            **v1.graph_limits(runner),
                            "maximumAggregateUncompressedBytes":
                                V13_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
                        }
                        ...
                        check(
                            first_coverage.get("archiveCount") == 171
                        ...
                        check(
                            ...
                            and sha256_bytes(wave14_digest_bytes(projection))
                            == V13_SOURCE_BINDINGS_SHA256,
                            "E_COMBINED_INPUT",
                        )
                        ...
                        body = {
                            ...
                            "inputSet": {
                                ...
                                "uniqueModuleVersionTupleCount": 170,
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV12PredecessorExecuted": True,
                                ...
                                "wave14FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave14RetainedFdPreManifestBarrierCount": 3,
                                "wave14CompletionAppliesToRetainedSnapshot":
                                    True,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave14-"
