#!/usr/bin/env python3
"""Validate the read-only Wave8 identity and acquisition decision.

Run only with ``python3 -I -B -S``.  The checker executes the exact pinned
combined-v6 candidate, then scans the retained 229 inputs twice using only the
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "Wave8 decision checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
DECLARATION_WITNESS_SHA256 = (
    "396fb96d1f1e08d215f24d4b1e95408bf0e988f86a2d4cb6ff033424f54e90be"
)
GO_MOD_H1_WITNESS_SHA256 = (
    "a77198b7cc5de96f62cd670d807fb96f4ca89ca8b9ed0e06768508b5b25999cf"
)
MODULE_ZIP_H1_WITNESS_SHA256 = (
    "b4277b3ec845c0f2159f10e9e5c5c93cf7ec1ac55fd6e57edfdc671789716e68"
)
CHECKER_ID = "g2-pion-ice-v4.3.0-wave8-identity-acquisition-decision-check-v1"
DECISION_ID = (
    "g2-pion-ice-v4.3.0-rung3-bounded-dependency-source-identity-and-"
    "acquisition-decision-wave8-v1"
)
DEPENDENCY_ROOT = "build/offline-source/pion-ice-v4.3.0/dependencies"
WAVE8_CLAIM_PATH = f"{DEPENDENCY_ROOT}/.wave-8-v1.claim"
WAVE8_STAGING_PREFIX = ".wave-8-v1-staging-"
WAVE8_ACCEPTED_PATH = f"{DEPENDENCY_ROOT}/wave-8-v1/accepted"
...
EXPECTED_IDENTITY = [
    ("github.com/davecgh/go-spew", "v1.1.0",
     ...
     "h1:ZDRjVQ15GmhC3fiQ8ni8+OwkZQO4DARzQgrnXU1Liz8=", 1, 6, 1),
    ("github.com/stretchr/objx", "v0.1.0",
     "h1:HFkY916IF+rwdDfMAkV7OtwuqBVzrE8GR6GFx+wExME=",
     "h1:4G4v2dO3VZwixGIRoQ5Lfboy6nUhCyYzaqnIAPPhYs4=", 1, 6, 1),
    ("golang.org/x/crypto", "v0.43.0",
     "h1:BFbav4mRNlXJL4wNeejLpWxB7wMbc79PdRGhWKncxR0=",
     "h1:dduJYIi3A3KOfdGOHX8AVZ/jGiyPa3IbBozJ5kNuE04=", 1, 1, 1),
    ("golang.org/x/mod", "v0.6.0-dev.0.20220419223038-86c51ed26bb4",
     "h1:jJ57K6gSWd91VN4djpZkiMVwK6gcyfeH4XE8wZrZaV4=",
     "h1:6zppjxzCulZykYSLyVDYbneBfbaBIQPYMevg0bEwv2s=", 1, 11, 1),
    ("golang.org/x/net", "v0.0.0-20220722155237-a158d28d115b",
     "h1:XRhObCWvk6IyKnWLug+ECip1KBveYUHfp+8e9klMJ9c=",
     "h1:PxfKdU9lEEDYjdIzOtC4qFWgkU2rGHdKlKowJSMN9h0=", 1, 11, 1),
    ("golang.org/x/sync", "v0.0.0-20220722155255-886fb9371eb4",
     "h1:RxMgew5VJxzue5/jJTE5uejpjVlOe/izrB70Jof72aM=",
     "h1:uVc8UZUe6tr40fFVnUP5Oj+veunVezqYl9z7DYw9xzw=", 1, 11, 1),
    ("golang.org/x/sys", "v0.0.0-20220722155257-8c9f86f7a55f",
     "h1:oPkhp1MJrh7nUepCBck5+mAzfO9JrbApNNgaTdGDITg=",
     "h1:v4INt8xihDGvnrfjMDVXGxw9wrfxYyCjk0KbXjhR55s=", 1, 11, 1),
    ("golang.org/x/term", "v0.36.0",
     "h1:Qu394IJq6V6dCBRgwqshf3mPF85AqzYEzofzRdZkWss=",
     "h1:zMPR+aF8gfksFprF/Nc/rd1wRS1EI6nDBGyWAvDzx2Q=", 1, 1, 1),
    ("golang.org/x/term", "v0.5.0",
     "h1:jMB1sMXY+tzblOD4FWmEbocvup2/aLOaQEp7JmGp78k=",
     "h1:n2a8QNdAb0sZNpU9R1ALUXBbY+w51fCQDN+7EdxNBsY=", 1, 8, 1),
    ("golang.org/x/text", "v0.3.7",
     "h1:u+2+/6zg+i71rQMx5EYifcz6MCKuco9NR6JIITiCfzQ=",
     "h1:olpwvP2KacW1ZWvsR7uQhoyTYvKAupfQrRGBFM352Gk=", 1, 11, 1),
    ("golang.org/x/text", "v0.30.0",
     "h1:yDdHFIX9t+tORqspjENWgzaCVXgk0yYnYuSZ8UzzBVM=",
     "h1:yznKA/E9zq54KzlzBEAWn1NXSQ8DIp/NYMy88xJjl4k=", 1, 1, 1),
    ("golang.org/x/text", "v0.7.0",
     "h1:mrYo+phRRbMaCq/xk9113O4dZlRixOauAjOtrjsXDZ8=",
     "h1:4BRB4x83lYWy72KwLD/qYDuTu7q9PjSagHvijDw7cLo=", 1, 8, 1),
    ("golang.org/x/tools", "v0.37.0",
     "h1:MBN5QPQtLMHVdvsbtarmTNukZDdgwdwlO5qGacAzF0w=",
     "h1:DVSRzp7FwePZW356yEAChSdNcQo6Nsp+fex1SUW09lE=", 1, 1, 1),
    ("gopkg.in/yaml.v3", "v3.0.0-20200313102051-9f266ea9e77c",
     "h1:K4uyk7z7BCEPqu6E+C64Yfv1cQ7kz7rIZviUmN+EgEM=",
     "h1:dUUwHk2QECo/6vqA44rthZ8ie2QXMNeKRTHCNY2nXvo=", 1, 6, 2),
]
...
EXPECTED_NON_CLAIMS = (
    ...
    "wave8_dependency_source_not_acquired",
...
class BootstrapPinnedCodeFile:
    """Immediate-ownership bootstrap pin matching combined-v6 semantics."""
...
def load_v6_checker(
    ...
    module = types.ModuleType("aetherlink_combined_v6_pinned")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(ROOT / V6_CHECKER_PATH),
            "__loader__": None,
            "__name__": "aetherlink_combined_v6_pinned",
            "__package__": None,
        }
    )
    try:
        ...
        raise DecisionFailure("E_V6_LOAD") from error
    for name in (
        "PinnedCodeFile",
        "SafeHeldInputSet",
        "generate_candidate",
...
def build_identity_rows(
    *,
    ...
    require(len(wave_rows) == 14, "E_TARGETS")
...
def scan_source_identity(
    *,
    ...
    require(len(targets) == len(wave_rows) == 14, "E_TARGETS")
...
def require_closed_identity(scan: Mapping[str, Any]) -> None:
    ...
    require(
        len(rows) == 14
        and scan["archiveCount"] == 115
        and scan["externalModCount"] == 114
        and scan["embeddedRootGoModCount"] == 1
        and scan["goSumEntryCount"] == 81
        and sum(row["declarationCount"] for row in rows) == 14
        and sum(
...
def validate_v6_candidate(
    candidate: Mapping[str, Any],
) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    require(type(candidate) is dict, "E_V6_CANDIDATE")
    ...
    require(
        ...
        == (
            ...
            "wave4-wave5-wave6-wave7-fixed-point-candidate"
        )
    ...
    require(
        ...
        and inputs.get("modCount") == 114
        and inputs.get("zipCount") == 114
        and inputs.get("uniqueModuleVersionTupleCount") == 114
    ...
    require(
        ...
        and counters.get("directArchiveOpenCount") == 230
        and counters.get("inheritedArchiveOpenCount") == 600
        and counters.get("totalArchiveOpenCount") == 830
        and counters.get("heldSourceInputCount") == 229
        and counters.get("heldTerminalEvidenceCount") == 45
        and counters.get("heldAuxiliaryEvidenceCount") == 1
...
def expected_tool_bindings(
    ...
    require(
        ...
        == TESTS_RAW_SHA256
        and sha256_bytes(package_raw[V6_CHECKER_PATH])
        == V6_CHECKER_RAW_SHA256
        and sha256_bytes(
            package_raw[V6_TESTS_PATH]
        )
        == V6_TESTS_RAW_SHA256,
        "E_TOOL_IDENTITY",
    )
    return [
        {
            "role": "current_wave8_decision_checker",
            "path": SELF_PATH,
            "normalizedSha256": SELF_NORMALIZED_SHA256,
        },
        {
            "role": "current_wave8_decision_tests",
            "path": TESTS_PATH,
            "rawSha256": TESTS_RAW_SHA256,
        },
        {
            "role": "immutable_combined_v6_checker",
            "path": V6_CHECKER_PATH,
            "rawSha256": V6_CHECKER_RAW_SHA256,
            "normalizedSha256": V6_CHECKER_NORMALIZED_SHA256,
        },
        {
            "role": "immutable_combined_v6_tests",
            "path": V6_TESTS_PATH,
            "rawSha256": V6_TESTS_RAW_SHA256,
        },
    ]
    ...
    *,
    ...
    return {
        "documentType": (
            ...
            "identity-and-acquisition-decision-wave8"
        ),
        "schemaVersion": "1.0",
        ...
        "date": "2026-07-26",
        "status": (
            "wave8_exact_14_frontier_identity_classified_"
            "14_complete_0_blocked_acquisition_ready_not_authorized"
        ),
        "result": (
            "exact_14_version_vertices_0_selected_14_nonselected_"
            "14_complete_h1_pairs_acquisition_ready_not_authorized"
        ),
        ...
        "heldSourceInputSet": {
            ...
            "sourceBindingsSha256": V6_SOURCE_BINDINGS_SHA256,
        ...
        "sourceAcquisitionPreparation": {
            ...
            "modulePathEncoding":
                "current_wave8_lowercase_ascii_direct_proxy_path",
            "claimPath": WAVE8_CLAIM_PATH,
            "stagingDirectoryPrefix": WAVE8_STAGING_PREFIX,
            "acceptedDirectoryPath": WAVE8_ACCEPTED_PATH,
        ...
        "operationCounters": {
            "combinedV6CandidateInvocationCount": 1,
            "predecessorFullSourceReconstructionCount": 8,
            "directV6FullSourceReconstructionCount": 2,
            "totalFullSourceReconstructionCount": 10,
            "predecessorGraphArchiveOpenCount": 600,
            "currentV6GraphArchiveOpenCount": 230,
            "totalV6GraphArchiveOpenCount": 830,
            "identityWitnessScanCount": 2,
            "identityWitnessArchiveOpenCount": 230,
            "overallDecisionExecutionArchiveOpenCount": 1060,
        ...
        "closure": {
            "wave8IdentityResolved": True,
            "wave8AcquisitionReady": True,
            "wave8AcquisitionComplete": False,
        ...
        "nextAction": (
            "prepare_separate_one_use_28_resource_wave8_source_"
...
def validate_semantic_decision(
    ...
    combined = (
        predecessors.get("combinedFixedPointV6")
    ...
    require(
        exact_keys(predecessors, {"combinedFixedPointV6"})
    ...
    require(
        ...
        and held["sourceBindingCount"] == 229
        and held["sourceBindingsSha256"]
        == V6_SOURCE_BINDINGS_SHA256
        and held["archiveCount"] == 115
        and held["externalModCount"] == 114
        and held["embeddedRootGoModCount"] == 1
        and held["goSumEntryCount"] == 81
    ...
    require(
        ...
        and identity["tupleCount"] == 14
        and identity["graphSelectedTupleCount"] == 0
        and identity["versionSpecificNonSelectedTupleCount"] == 14
        and identity["parentDeclarationCount"] == 14
        and identity["moduleZipH1WitnessCount"] == 15
        and identity["goModH1WitnessCount"] == 93
        and identity["completeIdentityPairCount"] == 14
    ...
    require(
        ...
        and preparation["requestCount"] == 28
        ...
        == "current_wave8_lowercase_ascii_direct_proxy_path"
        and preparation["claimPath"] == WAVE8_CLAIM_PATH
        and preparation["stagingDirectoryPrefix"]
        == WAVE8_STAGING_PREFIX
...
def evaluate(
    ...
    *,
    ...
    with ExitStack() as stack:
        ...
        v6_tests_held = stack.enter_context(
            v6.PinnedCodeFile(
                root,
                V6_TESTS_PATH,
                V6_TESTS_RAW_SHA256,
        ...
        package_raw = {
            ...
            V6_CHECKER_PATH: v6_held.raw,
            V6_TESTS_PATH: v6_tests_held.raw,
        }
        held: list[Any] = [
            self_held,
            v6_held,
        ...
        candidate = v6.generate_candidate(root)
        identity_barrier(root, held)
        wave_rows, source_bindings = validate_v6_candidate(candidate)
        ...
        v5 = v6.harden_checker_module(
            v6.load_v5_checker(v5_held)
        )
        ...
        require(
            type(runner) is v6.ReadOnlyProviderFacade
            and v5.PinnedCodeFile is v6.PinnedCodeFile
            and v4.PinnedCodeFile is v6.PinnedCodeFile
            and v1.PinnedRunnerFile is v6.SafePinnedRunnerFile,
            "E_SAFE_RUNTIME",
        )
        ...
        require(
            ...
            == source_bindings
            and len(full_source_bindings) == 229
            and all(
                type(row) is dict
    ...
    return expected, {
        ...
        "schemaVersion": "1.0",
        "status":
            "validated_14_of_14_acquisition_ready_not_authorized",
        "validationPassed": True,
        "tupleCount": 14,
        "parentDeclarationCount": 14,
        "moduleZipH1WitnessCount": 15,
        "goModH1WitnessCount": 93,
        "completeIdentityPairCount": 14,
        "blockedTupleCount": 0,
...
def error_document(code: str) -> dict[str, Any]:
    return {
        "documentType":
            "aetherlink.wave8-identity-acquisition-decision-error",
        "schemaVersion": "1.0",
