#!/usr/bin/env python3
"""Recompute the exact 199-input Wave1..Wave6 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v4
combined checker, all Wave6 decision/acquisition/readback controls, and the
root archive plus 99 mod and 99 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v5 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v5.py"
...
WAVE6_CONTROL_SHA256 = {
    ...
    WAVE6_READBACK_PERMIT_PATH:
        "4650e7460beae9814e384bed0f178ba29b782c2903aec04a3e1f81216106ccb3",
    WAVE6_READBACK_PATH:
...
WAVE6_CONTENT_SHA256 = {
    ...
    WAVE6_READBACK_PERMIT_PATH:
        "6909f5d725f412aa4036a8eac6851586bc2246a959b17c5fa1ecd15a0eac67c9",
    WAVE6_READBACK_PATH:
        "a24624ea8f24e82e7d9245e24bd78fbcf3d2e928280681a1359c3135490a831d",
    WAVE6_READBACK_MANIFEST_PATH:
        "f21f75216247fffdf8197df107c2b433968c3b36e4e87a235c8a86e847a6c730",
}
WAVE6_REQUEST_SET_SHA256 = (
    "d1ea9ec1fab702b1bf405f13e1d7aaeb9a5354ff7f98a0d916870def124372a1"
)
WAVE6_PERMIT_RESOURCES_SHA256 = (
    "9fe734b3800d051abe4c4df0cbf7e5545594da90588c625b253a2535f1310cb0"
)
WAVE6_RESOURCE_SET_SHA256 = (
    "61b02eaa698ddcbbac9aa4ed839e43705817d8d5204f28b81e6c3f5ab050acbf"
)
WAVE6_FROZEN_FILE_SET_SHA256 = (
    "0ed9a600805e18eda7b19d9f98f63234bef0c1929633fba5ab775493e5a93fb0"
)
WAVE6_ATTEMPT_ID = "5e0828c2e5dc1ce7ef2a06dd235d5076"
WAVE6_READBACK_ATTEMPT_ID = "7fc50276e880013e1ace73920397ba3f"
WAVE6_COMPACT_IDENTITY_SHA256 = (
    "f93cb8006e2c391934ffa820b2d03b3ba99075481b1437c3fe27e068242e35fe"
)
WAVE6_FULL_WITNESS_SHA256 = (
    "d3ea9f3c934911e7d5a7624cdba27ef71be222a6764f65a9b41664fa1e96937e"
)
WAVE6_HELD_SOURCE_BINDINGS_SHA256 = (
    "c8d5515eb4514216b43dd1192e86d33f849ae6e6085046a6e28a024386623acc"
)
WAVE6_ACQUISITION_CLAIM_RAW_SHA256 = (
    "2e657773cf20e29bbe92f87a8e9e4dc5e7e9478ed73189c8ccfd18e47b8e1ed3"
)
WAVE6_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "14bd7bba6db0cfd4bb949e73b94330bb5afb0a3ec05388a96771288a01f348db"
)
WAVE6_ACQUISITION_CHECKER_RAW_SHA256 = (
    "659d7d1a4d780df66002f5064751b152b02c7c245877fa8ea035f519c781944e"
)
WAVE6_ACQUISITION_RUNNER_RAW_SHA256 = (
    "e8f7a092c8ca671e040c62c8d5b9d9587bb4bbcb305889c9036d6535d65c6c46"
)
WAVE6_READBACK_CLAIM_RAW_SHA256 = (
    "754c494fe5f939629387165de26f9747fe4f8bd1d5009b66ef27bf06fa208e6c"
)
WAVE6_READBACK_CLAIM_CONTENT_SHA256 = (
    "c4aa626c20cc0f6ece6970a4e1e8e37353e716c6ee873f4be5fe4cb560a72c4e"
)
WAVE6_READBACK_CHECKER_RAW_SHA256 = (
    "9d5be82523dc4d5a5e2d65c1f8ad72dbd5c935a4fe5181ad1e5e747283081dfa"
)
WAVE6_READBACK_RECORDER_RAW_SHA256 = (
    "b034515cf605ebc910fabcc8b00fd616550ddba464661038d4686c43575c18ae"
)
WAVE6_RETAINED_BARRIERS = [
...
WAVE6_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave6_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE6_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE6_CONTENT_SHA256[WAVE6_READBACK_PERMIT_PATH],
        "path": WAVE6_READBACK_PERMIT_PATH,
        "rawSha256": WAVE6_CONTROL_SHA256[WAVE6_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
        ...
        "rawSha256": WAVE6_READBACK_RECORDER_RAW_SHA256,
    },
}
...
def wave6_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v5_safe_hardened") is True:
        return module
    module.__dict__["_v5_safe_hardened"] = True
...
def load_v4_checker(held: PinnedCodeFile) -> types.ModuleType:
    module = types.ModuleType("aetherlink_combined_fixed_point_v4_pinned")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(ROOT / V4_CHECKER_PATH),
            "__loader__": None,
            "__name__": "aetherlink_combined_fixed_point_v4_pinned",
            "__package__": None,
        }
    )
    try:
        ...
        raise CombinedCheckFailure("E_V4_CHECKER_LOAD") from error
    for name in (
        "PinnedCodeFile",
        "load_v1_checker",
        ...
        "parse_wave3_documents",
        "parse_wave4_documents",
        "parse_wave5_documents",
        "combined_source_bindings",
        "reconstruct_graph_v3",
    ...
    check(
        module.SELF_PATH == V4_CHECKER_PATH
        and sha256_bytes(held.raw) == V4_CHECKER_RAW_SHA256,
        "E_V4_CHECKER_API",
    )
    return harden_checker_module(module)


def wave6_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
        ...
        for path, digest in WAVE6_CONTROL_SHA256.items()
    ]


def parse_wave6_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE6_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE6_JSON")
        result[path] = value
    return result


def verify_wave6_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    ...
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE6_DECISION_PATH],
        WAVE6_CONTENT_SHA256[WAVE6_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE6_PERMIT_PATH],
        WAVE6_CONTENT_SHA256[WAVE6_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE6_CONTENT_SHA256[path],
        )


def validate_v4_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == WAVE6_HELD_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V4_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V4_FRONTIER_SHA256
        ...
        == {
            ...
            "sha256": V4_CANDIDATE_CONTENT_SHA256,
        }
        ...
        == (
            ...
            "wave5-fixed-point-candidate"
        )
        and candidate.get("status")
        == "combined_graph_discovery_complete_next_wave_required"
        and candidate.get("result")
        == (
            "combined_graph_recomputed_twice_from_exact_wave1_wave2_"
            "wave3_wave4_and_wave5_source_bytes"
        )
        ...
        and "derivedResult" not in candidate
        and type(inputs) is dict
        and inputs.get("heldSourceInputCount") == 163
        and inputs.get("combinedInputSetSha256") == V4_INPUT_SET_SHA256
        and sha256_bytes(runner.canonical_json_bytes(source_bindings))
        == V4_INPUT_SET_SHA256
        and sha256_bytes(wave6_digest_bytes(source_bindings))
        == WAVE6_HELD_SOURCE_BINDINGS_SHA256
        and len({row["path"] for row in source_bindings}) == 163
        and sum(row["kind"] == "root_zip" for row in source_bindings) == 1
        and sum(row["kind"] == "mod" for row in source_bindings) == 81
        and sum(row["kind"] == "zip" for row in source_bindings) == 81
        ...
        and graph.get("graphSha256") == V4_GRAPH_SHA256
        and type(frontier) is list
        and len(frontier) == 18
        and sha256_bytes(runner.canonical_json_bytes(frontier))
        == V4_FRONTIER_SHA256
        and candidate.get("authority") == V4_AUTHORITY,
        "E_V4_PREDECESSOR",
    )
    return {
        ...
        "wave6CompletionAppliesToRetainedSnapshot": True,
        "wave6CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave6SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
    }


def wave6_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE6_DECISION_PATH]
    permit = documents[WAVE6_PERMIT_PATH]
    receipt = documents[WAVE6_RECEIPT_PATH]
    manifest = documents[WAVE6_MANIFEST_PATH]
    readback_permit = documents[WAVE6_READBACK_PERMIT_PATH]
    readback = documents[WAVE6_READBACK_PATH]
    readback_manifest = documents[WAVE6_READBACK_MANIFEST_PATH]
    verify_wave6_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE6_CONTENT_SHA256[WAVE6_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave6_exact_18_frontier_identity_classified_18_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and type(resolution) is dict
        and resolution.get("tupleCount") == 18
        and resolution.get("completeIdentityPairCount") == 18
        and resolution.get("blockedTupleCount") == 0
        and resolution.get("graphSelectedTupleCount") == 0
        and resolution.get("versionSpecificNonSelectedTupleCount") == 18
        and resolution.get("compactIdentitySha256")
        == WAVE6_COMPACT_IDENTITY_SHA256
        and resolution.get("fullWitnessSha256")
        == WAVE6_FULL_WITNESS_SHA256
        and type(held_set) is dict
        and held_set.get("sourceBindingCount") == 163
        ...
        and len(identity_tuples) == 18
        and type(source_requests) is list
        and len(source_requests) == 36
        and sha256_bytes(wave6_digest_bytes(source_requests))
        == WAVE6_REQUEST_SET_SHA256,
        "E_WAVE6_DECISION",
    )
    ...
    check(
        exact_keys(
            ...
            (
                ...
                "oneUseContract", "permitId", "primitiveBindings",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE6_CONTENT_SHA256[WAVE6_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE6_ACQUISITION_AUTHORITY
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE6_CONTROL_SHA256[WAVE6_DECISION_PATH]
        ...
        and contract.get("requestCount") == 36
        and contract.get("tupleCount") == 18
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE6_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE6_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 36
        and receipt.get("modCount") == 18
        and receipt.get("zipCount") == 18
        and receipt.get("aggregateResponseBytes") == 36_115_415
        and receipt.get("aggregateModResponseBytes") == 2_220
        and receipt.get("aggregateZipResponseBytes") == 36_113_195
        and receipt.get("aggregateZipEntryCount") == 7_758
        and receipt.get("aggregateZipUncompressedBytes") == 138_523_078
    ...
    check(
        manifest
        == {
            "attemptId": WAVE6_ATTEMPT_ID,
            "documentType": "aetherlink.wave6-source-acquisition-manifest",
            "manifestWrittenLast": True,
            "receiptPath": WAVE6_RECEIPT_PATH,
            "receiptRawSha256": WAVE6_CONTROL_SHA256[WAVE6_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "modCount", "selectedTupleCount", "zipCount",
            ),
        )
        and exact_keys(
            ...
            (
                ...
                "exact36ResourceOrderAndAggregateRecomputed",
                "exact54FrozenFileSnapshotRequired",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE6_CONTENT_SHA256[WAVE6_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE6_READBACK_AUTHORITY
        ...
        is True
        and verification_contract.get("exact54FrozenFileSnapshotRequired")
        is True
        ...
        and snapshot.get("attemptId") == WAVE6_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE6_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE6_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE6_HELD_SOURCE_BINDINGS_SHA256,
            "sourceRequestSetCanonicalSha256":
                WAVE6_REQUEST_SET_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-6-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 54
        and snapshot.get("frozenFilesCanonicalSha256")
        == WAVE6_FROZEN_FILE_SET_SHA256
        and snapshot.get("acceptedResourceCount") == 36
        and snapshot.get("selectedTupleCount") == 0
        and snapshot.get("modCount") == 18
        and snapshot.get("zipCount") == 18
        and snapshot.get("aggregateAcceptedBytes") == 36_115_415
        and snapshot.get("aggregateModBytes") == 2_220
        and snapshot.get("aggregateZipBytes") == 36_113_195
        and snapshot.get("aggregateZipEntryCount") == 7_758
        and snapshot.get("aggregateZipUncompressedBytes") == 138_523_078
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave6_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "rawSha256": WAVE6_ACQUISITION_CLAIM_RAW_SHA256,
        }
        and evidence
        == {
            "bytes": 13_995,
            ...
            "path": (
                "build/offline-source/pion-ice-v4.3.0/dependencies/"
                "wave-6-v1/evidence.json"
            ),
            "rawSha256": WAVE6_ACQUISITION_EVIDENCE_RAW_SHA256,
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE6_RECEIPT_PATH,
            "rawSha256": WAVE6_CONTROL_SHA256[WAVE6_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE6_MANIFEST_PATH,
            "rawSha256": WAVE6_CONTROL_SHA256[WAVE6_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE6_ACCEPTED_DIRECTORY
        and accepted.get("mode") == "0700"
        and accepted.get("ownerUid") == os.geteuid()
        and accepted.get("linkCount") == 38
        and accepted.get("exactFileCount") == 36
        and type(accepted_files) is list
        and len(accepted_files) == 36
        and sha256_bytes(
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE6_CONTENT_SHA256[WAVE6_READBACK_PATH],
        }
        and readback.get("status")
        == "wave6_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE6_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE6_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_251,
            "contentSha256": WAVE6_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
                "build/offline-source/pion-ice-v4.3.0/dependencies/"
                ".wave-6-v1-readback.claim"
            ),
            "rawSha256": WAVE6_READBACK_CLAIM_RAW_SHA256,
        }
        ...
        == "wave6_acquisition_retained_snapshot_independently_verified"
        ...
        and verified.get("acceptedResourceCount") == 36
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE6_CONTENT_SHA256[
                WAVE6_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave6_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE6_ATTEMPT_ID
        and readback_manifest.get("readbackAttemptId")
        == WAVE6_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 17_644,
            "contentSha256": WAVE6_CONTENT_SHA256[WAVE6_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE6_READBACK_PATH,
            "rawSha256": WAVE6_CONTROL_SHA256[WAVE6_READBACK_PATH],
        }
    ...
    check(
        len(accepted_by_name) == 36
        and len(verified_by_name) == 36
        and len(identity_by_order) == 18,
        "E_WAVE6_RESOURCE",
    )
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave6-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE6_ACCEPTED_DIRECTORY}/{name}"
...
def combined_source_bindings(
    ...
    bindings = v4.combined_source_bindings(
        v1,
        runner,
        v1_documents,
        wave3_documents,
    ...
    bindings.extend(wave6_request_resources(v4, runner, wave6_documents))
    check(
        len(bindings) == 199
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 99
        and sum(row["kind"] == "zip" for row in bindings) == 99
    ...
    check(
        len({row["path"] for row in bindings}) == 199
        and len(
            {
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 100)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        v4 = load_v4_checker(v4_held)
        predecessor_candidate = v4.generate_candidate(root)
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                with runner.HeldInputSet(root, controls) as control_held:
                    ...
                    wave6_documents = parse_wave6_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v4_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave6_documents[WAVE6_DECISION_PATH],
                        )
                    )
                    ...
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        check(
                            type(fixed_point) is bool
                            and type(frontier) is list
                            and first_graph.get("newTupleCount")
                            == len(frontier)
                            and derived_result["fixedPointReached"]
                            is first_graph["fixedPointReached"]
                            and derived_result["frontierTupleCount"]
                            == len(first_graph["exactFrontier"])
                            and derived_result["frontierSha256"]
                            == sha256_bytes(
                                runner.canonical_json_bytes(
                                    first_graph["exactFrontier"]
                                )
                            ),
                            "E_DERIVED_RESULT",
                        )
                        ...
                        body = {
                            "documentType": (
                                ...
                                "wave3-wave4-wave5-wave6-fixed-point-candidate"
                            ),
                            "schemaVersion": "5.0",
                            ...
                            "inputSet": {
                                ...
                                "uniqueModuleVersionTupleCount": 99,
                            ...
                            "toolBindings": [
                                {
                                    "role": "current_v5_combined_checker",
                                    "path": SELF_PATH,
                                    "normalizedSha256":
                                        SELF_NORMALIZED_SHA256,
                                },
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV4PredecessorExecuted": True,
                                ...
                                "wave6Exact54FrozenFileSnapshotBound": True,
                                "wave6RetainedFdPreManifestBarrierCount": 3,
                                "wave6CompletionAppliesToRetainedSnapshot":
                                    True,
                                "wave6CurrentPathIdentityGuaranteedThroughManifestPublication":
                                    False,
                                "wave6SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
                                    False,
                            ...
                            "operationCounters": {
                                ...
                                "transitiveDistinctToolPathCount": 6,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave6-"
