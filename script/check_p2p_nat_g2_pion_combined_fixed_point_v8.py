#!/usr/bin/env python3
"""Recompute the exact 277-input Wave1..Wave9 graph without publishing.

Run only with ``python3 -I -B -S``. The checker pins the immutable v7
combined checker, all Wave9 decision/acquisition/readback controls, and the
root archive plus 138 mod and 138 zip inputs. Every source input is opened
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v8 checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
SELF_PATH = "script/check_p2p_nat_g2_pion_combined_fixed_point_v8.py"
...
WAVE9_DECISION_PATH = (
    ...
    "decision-wave9-v1.json"
)
WAVE9_PERMIT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-"
    "execution-permit-v1.json"
)
WAVE9_RECEIPT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-receipt-v1.json"
)
WAVE9_MANIFEST_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-manifest-v1.json"
)
WAVE9_READBACK_PERMIT_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-"
    "readback-execution-permit-v1.json"
)
WAVE9_READBACK_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-readback-v1.json"
)
WAVE9_READBACK_MANIFEST_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-"
    "readback-manifest-v1.json"
)
WAVE9_ACCEPTED_DIRECTORY = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    "wave-9-v1/accepted"
)
WAVE9_ACQUISITION_CLAIM_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/.wave-9-v1.claim"
)
WAVE9_EVIDENCE_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    "wave-9-v1/evidence.json"
)
WAVE9_READBACK_CLAIM_PATH = (
    "build/offline-source/pion-ice-v4.3.0/dependencies/"
    ".wave-9-v1-readback.claim"
)
WAVE9_FAILURE_PATH = (
    f"{BASE}/bounded-dependency-source-acquisition-wave9-failure-v1.json"
)
WAVE9_STAGING_PREFIX = ".wave-9-v1-staging-"
WAVE9_READBACK_TEMP_PREFIXES = (
    ".bounded-dependency-source-acquisition-wave9-readback-v1.json.tmp-",
    (
        ".bounded-dependency-source-acquisition-wave9-readback-"
        "manifest-v1.json.tmp-"
    ),
)

WAVE9_CONTROL_SHA256 = {
    WAVE9_DECISION_PATH:
...
WAVE9_CONTROL_METADATA = {
    WAVE9_DECISION_PATH: (22_532, 0o644),
    WAVE9_PERMIT_PATH: (25_996, 0o644),
    WAVE9_RECEIPT_PATH: (1_670, 0o600),
    WAVE9_MANIFEST_PATH: (463, 0o600),
    WAVE9_READBACK_PERMIT_PATH: (20_555, 0o644),
    WAVE9_READBACK_PATH: (12_109, 0o600),
    WAVE9_READBACK_MANIFEST_PATH: (2_296, 0o600),
}
WAVE9_CONTENT_SHA256 = {
    WAVE9_DECISION_PATH:
    ...
    WAVE9_READBACK_PATH:
        "c5bebaa0a16449ea7fe28a2e20f3a72eae52d881084444a4bed489e804e0394d",
    WAVE9_READBACK_MANIFEST_PATH:
        "ace0f4c968ffa93db3b5a5bedeac866e583d88125f757e3d3e3719e5487aac4e",
}
WAVE9_REQUEST_SET_SHA256 = (
    "e3922164eda6657d447f1b75ff49268265338efe35440dad39a237d1ddf643bc"
)
WAVE9_PERMIT_RESOURCES_SHA256 = (
    "8758566447b9300880837d7316cf6fac319f50ec90549cb41aa36600ef2171f9"
)
WAVE9_RESOURCE_SET_SHA256 = (
    "a325c4e436dbdb0c2e40cd212784e8f1533890a8f291cc2a4e1b43b9bf45f442"
)
WAVE9_FROZEN_FILE_SET_SHA256 = (
    "5dbc73ac26b39374fe44d181ae1c70a94d63caf3a340c9c5d4e5cbd844c15572"
)
WAVE9_ATTEMPT_ID = "df64a4816a083806020580efe953b9a7"
WAVE9_READBACK_ATTEMPT_ID = "2d61a0483984e9a2f77665dd3c624cb2"
WAVE9_COMPACT_IDENTITY_SHA256 = (
    "db31bdd4d1ae0c97ba88094502f7c0dc5e0f554e72c5f68503d917005f762753"
)
WAVE9_FULL_WITNESS_SHA256 = (
    "ee3657522619b1960c535fc3a9644441adb15cee473286bfd2871096fb719afe"
)
WAVE9_HELD_SOURCE_BINDINGS_SHA256 = (
    "527c2e6dc235d269c92e52915135c1b2beec113cb751198ca7142c5e63d79148"
)
WAVE9_ACQUISITION_CLAIM_RAW_SHA256 = (
    "84957554fe937841165f38a2418613e4e740082bea4f55538b21324dfe6d45f4"
)
WAVE9_ACQUISITION_EVIDENCE_RAW_SHA256 = (
    "566c1e5970d761839a6a75b953524dff7fcf1c00c68a114ab9f9af853587813b"
)
WAVE9_ACQUISITION_CHECKER_RAW_SHA256 = (
    "cffa859723fb1688bea5cf7188885fe43443dd63c59d01c8805dfc61870b69a6"
)
WAVE9_ACQUISITION_RUNNER_RAW_SHA256 = (
    "b99f29546a050be951f9d07ced2a9c554b2c63b151a92dc6dca4dea241dcc87a"
)
WAVE9_READBACK_CLAIM_RAW_SHA256 = (
    "af0dab21e05292511bb105545750a61048f9d4b23e7ec7b9e7e1de5f1e7e41a7"
)
WAVE9_READBACK_CLAIM_CONTENT_SHA256 = (
    "04e7d6a6581aed6333893f93a2e635d49a090189130e417823af4742dfa9f527"
)
WAVE9_READBACK_CHECKER_RAW_SHA256 = (
    "012128231fbb7dd5ac0de4139af5fd98b5da21301ae298c61109eb9eeed0bd65"
)
WAVE9_READBACK_RECORDER_RAW_SHA256 = (
    "07d11c8b2122f2d462eba33dd538fc0a7fd1fa399f331c58867fd25de77fddf5"
)
WAVE9_RETAINED_BARRIERS = [
...
WAVE9_ACQUISITION_AUTHORITY = {
    ...
    "tokenRequired": False,
    "userActionRequired": False,
    "wave9PublicProxy20GetAcquisitionAuthorizedOnce": True,
}
WAVE9_READBACK_AUTHORITY = {
    "authenticationRequired": False,
    "compileAuthorized": False,
...
WAVE9_READBACK_AUTHORITY_BINDING = {
    "checker": {
        "path": (
            "script/check_p2p_nat_g2_pion_rung3_dependency_wave9_"
            "readback_execution_permit_v1.py"
        ),
        "rawSha256": WAVE9_READBACK_CHECKER_RAW_SHA256,
    },
    "permit": {
        "contentSha256": WAVE9_CONTENT_SHA256[WAVE9_READBACK_PERMIT_PATH],
        "path": WAVE9_READBACK_PERMIT_PATH,
        "rawSha256": WAVE9_CONTROL_SHA256[WAVE9_READBACK_PERMIT_PATH],
    },
    "recorder": {
        "path": (
            "script/record_p2p_nat_g2_pion_rung3_dependency_wave9_"
            "readback_v1_once.py"
        ),
        "rawSha256": WAVE9_READBACK_RECORDER_RAW_SHA256,
    },
}
...
def wave9_digest_bytes(value: Any) -> bytes:
    return json.dumps(
        value,
        ensure_ascii=False,
        sort_keys=True,
...
def harden_checker_module(module: types.ModuleType) -> types.ModuleType:
    ...
    if module.__dict__.get("_v8_safe_hardened") is True:
        return module
    module.__dict__["_v8_safe_hardened"] = True
...
def wave9_control_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": path,
            "rawSha256": digest,
            "maximumBytes": JSON_MAXIMUM_BYTES,
            "ownerOnly": WAVE9_CONTROL_METADATA[path][1] == 0o600,
            "kind": "terminal_evidence",
        }
        for path, digest in WAVE9_CONTROL_SHA256.items()
    ]


def parse_wave9_documents(
    runner: types.ModuleType,
    held: Any,
) -> dict[str, dict[str, Any]]:
    result: dict[str, dict[str, Any]] = {}
    for path in WAVE9_CONTROL_SHA256:
        value = runner.strict_json(held.raw[path], path)
        check(type(value) is dict, "E_WAVE9_JSON")
        result[path] = value
    return result


def wave9_auxiliary_evidence_bindings() -> list[dict[str, Any]]:
    return [
        {
            "path": WAVE9_ACQUISITION_CLAIM_PATH,
            "rawSha256": WAVE9_ACQUISITION_CLAIM_RAW_SHA256,
            "maximumBytes": 416,
            "ownerOnly": True,
            "kind": "consumed_acquisition_claim",
        },
        {
            "path": WAVE9_EVIDENCE_PATH,
            "rawSha256": WAVE9_ACQUISITION_EVIDENCE_RAW_SHA256,
            "maximumBytes": 8_263,
            "ownerOnly": True,
            "kind": "frozen_acquisition_evidence",
        },
        {
            "path": WAVE9_READBACK_CLAIM_PATH,
            "rawSha256": WAVE9_READBACK_CLAIM_RAW_SHA256,
            "maximumBytes": 1_251,
            "ownerOnly": True,
...
def validate_wave9_completed_namespace(
    control_held: Any,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    acquisition_claim = control_held.files[WAVE9_ACQUISITION_CLAIM_PATH]
    readback_claim = control_held.files[WAVE9_READBACK_CLAIM_PATH]
    evidence = control_held.files[WAVE9_EVIDENCE_PATH]
    readback = control_held.files[WAVE9_READBACK_PATH]
    readback_manifest = control_held.files[WAVE9_READBACK_MANIFEST_PATH]
    for path, (expected_bytes, expected_mode) in WAVE9_CONTROL_METADATA.items():
    ...
    exact_dependency_names = {
        Path(WAVE9_ACQUISITION_CLAIM_PATH).name,
        Path(WAVE9_READBACK_CLAIM_PATH).name,
    }
    exact_base_names = {
        Path(path).name for path in WAVE9_CONTROL_SHA256
    }
    ...
    check(
        ...
        and not any(
            name.startswith(portable_name(WAVE9_STAGING_PREFIX))
            for name in normalized_dependency_names
        )
        and portable_name(Path(WAVE9_FAILURE_PATH).name)
        not in normalized_base_names
        and not any(
            name.startswith(portable_name(prefix))
            for name in normalized_base_names
            for prefix in WAVE9_READBACK_TEMP_PREFIXES
        )
    ...
    readback_permit = documents[WAVE9_READBACK_PERMIT_PATH]
    ...
    check(
        type(accepted_files) is list and len(accepted_files) == 20,
        "E_WAVE9_NAMESPACE",
    )
    ...
    check(
        len(expected_accepted_names) == 20
        and all(
            Path(row["path"]).parent.as_posix() == WAVE9_ACCEPTED_DIRECTORY
            for row in accepted_files
        ),
        "E_WAVE9_NAMESPACE",
    )
    ...
    try:
        ...
        check(
            ...
            and accepted_info.st_nlink == 22
            and stat.S_IMODE(accepted_info.st_mode) == 0o700
            and len(accepted_names) == 20
            and set(accepted_names) == expected_accepted_names
            and len(set(normalized_accepted_names)) == 20,
            "E_WAVE9_NAMESPACE",
        )
    finally:
        if accepted_fd >= 0:
...
def validate_wave9_consumed_claims(
    runner: types.ModuleType,
    ...
    check(
        ...
        == {
            "attemptId": WAVE9_ATTEMPT_ID,
            "checkerRawSha256": WAVE9_ACQUISITION_CHECKER_RAW_SHA256,
            "documentType": "aetherlink.wave9-source-acquisition-claim",
            "externalAuthenticationRequired": False,
            "permitContentSha256": WAVE9_CONTENT_SHA256[WAVE9_PERMIT_PATH],
            "requestCount": 20,
            "schemaVersion": "1.0",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE9_READBACK_CLAIM_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == WAVE9_READBACK_CLAIM_CONTENT_SHA256
        and readback_claim.get("acquisitionAttemptId") == WAVE9_ATTEMPT_ID
        and readback_claim.get("readbackAttemptId")
        == WAVE9_READBACK_ATTEMPT_ID
        and readback_claim.get("authorityBinding")
        == WAVE9_READBACK_AUTHORITY_BINDING
        and readback_claim.get("documentType")
        == "aetherlink.wave9-acquisition-readback-one-use-claim"
...
def validate_wave9_evidence(
    runner: types.ModuleType,
    raw: bytes,
    evidence_document: Mapping[str, Any],
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    check(type(evidence_document) is dict, "E_WAVE9_EVIDENCE")
    readback = documents[WAVE9_READBACK_PATH]
    ...
    check(
        ...
        and sha256_bytes(raw) == WAVE9_ACQUISITION_EVIDENCE_RAW_SHA256
        and evidence_document.get("documentType")
        == "aetherlink.wave9-source-acquisition-evidence"
        and evidence_document.get("schemaVersion") == "1.0"
        and evidence_document.get("attemptId") == WAVE9_ATTEMPT_ID
        and evidence_document.get("requestCount") == 20
        and evidence_document.get("aggregateResponseBytes") == 16_285_940
        and evidence_document.get("aggregateModResponseBytes") == 1_181
        and evidence_document.get("aggregateZipResponseBytes") == 16_284_759
        and evidence_document.get("aggregateZipEntryCount") == 5_349
        and evidence_document.get("aggregateZipUncompressedBytes")
        == 54_936_288
        and type(evidence_resources) is list
        and len(evidence_resources) == 20
...
def verify_wave9_content_bindings(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> None:
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE9_DECISION_PATH],
        WAVE9_CONTENT_SHA256[WAVE9_DECISION_PATH],
        "decision_without_contentBinding",
    )
    v4.verify_modern_content_binding(
        runner,
        documents[WAVE9_PERMIT_PATH],
        WAVE9_CONTENT_SHA256[WAVE9_PERMIT_PATH],
    ...
    for path in (
        ...
        v4.verify_content_binding(
            runner,
            documents[path],
            WAVE9_CONTENT_SHA256[path],
        )


def validate_v7_predecessor_candidate(
    runner: types.ModuleType,
    ...
    check(
        ...
        == WAVE9_HELD_SOURCE_BINDINGS_SHA256
        and predecessor.get("graphSha256") == V7_GRAPH_SHA256
        and predecessor.get("frontierSha256") == V7_FRONTIER_SHA256
        and predecessor.get("frontierTupleCount") == 10
        and predecessor.get("fixedPointReached") is False
        and predecessor.get("checkerPath") == V7_CHECKER_PATH
        and predecessor.get("checkerRawSha256") == V7_CHECKER_RAW_SHA256
        and predecessor.get("checkerNormalizedSha256")
        == V7_CHECKER_NORMALIZED_SHA256
        and predecessor.get("testsPath") == V7_TESTS_PATH
        and predecessor.get("testsRawSha256") == V7_TESTS_RAW_SHA256
        and predecessor.get("totalFullSourceReconstructionCount") == 12
        and predecessor.get("totalGraphArchiveOpenCount") == 1_088
        ...
        == {
            ...
            "finalNamespaceReverifiedAfterCombinedV7Reconstruction": True,
            "historicalExact46FrozenSnapshotDescriptorSetBound": True,
            "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV7Barrier": True,
            "liveTerminalControlMetadataVerifiedAtCombinedV7Barrier": True,
        ...
        == {
            ...
            "sha256": V7_CANDIDATE_CONTENT_SHA256,
        }
        and sha256_bytes(runner.canonical_json_bytes(without))
        == V7_CANDIDATE_CONTENT_SHA256
        and candidate.get("schemaVersion") == "7.0"
        ...
        == {
            ...
            "frontierSha256": V7_FRONTIER_SHA256,
        }
        and type(inputs) is dict
        and inputs.get("heldSourceInputCount") == 257
        and inputs.get("combinedInputSetSha256") == V7_INPUT_SET_SHA256
        and sha256_bytes(runner.canonical_json_bytes(source_bindings))
        == V7_INPUT_SET_SHA256
        and sha256_bytes(wave9_digest_bytes(source_bindings))
        == WAVE9_HELD_SOURCE_BINDINGS_SHA256
        and len({row["path"] for row in source_bindings}) == 257
        and sum(row["kind"] == "root_zip" for row in source_bindings) == 1
        and sum(row["kind"] == "mod" for row in source_bindings) == 128
        and sum(row["kind"] == "zip" for row in source_bindings) == 128
        ...
        and graph.get("newTupleCount") == 10
        and graph.get("graphSha256") == V7_GRAPH_SHA256
        and type(frontier) is list
        and len(frontier) == 10
        and sha256_bytes(runner.canonical_json_bytes(frontier))
        == V7_FRONTIER_SHA256
        and candidate.get("authority") == V7_AUTHORITY,
        "E_V7_PREDECESSOR",
    )
    return {
        ...
        "wave8CompletionAppliesToRetainedSnapshot": True,
        "wave8CurrentPathIdentityGuaranteedThroughManifestPublication": False,
        "wave8SameUidConcurrentRenameOrReplacementAfterLastBarrierPrevented":
            False,
        "v7TestsBindingScope": "historical_metadata_only_not_live_held",
        "v7TestsLiveHeld": False,
    }


def wave9_request_resources(
    v4: types.ModuleType,
    runner: types.ModuleType,
    documents: Mapping[str, Mapping[str, Any]],
) -> list[dict[str, Any]]:
    decision = documents[WAVE9_DECISION_PATH]
    permit = documents[WAVE9_PERMIT_PATH]
    receipt = documents[WAVE9_RECEIPT_PATH]
    manifest = documents[WAVE9_MANIFEST_PATH]
    readback_permit = documents[WAVE9_READBACK_PERMIT_PATH]
    readback = documents[WAVE9_READBACK_PATH]
    readback_manifest = documents[WAVE9_READBACK_MANIFEST_PATH]
    verify_wave9_content_bindings(v4, runner, documents)
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE9_CONTENT_SHA256[WAVE9_DECISION_PATH],
        }
        and decision.get("status")
        == (
            "wave9_exact_10_frontier_identity_classified_10_complete_"
            "0_blocked_acquisition_ready_not_authorized"
        )
        and type(resolution) is dict
        and resolution.get("tupleCount") == 10
        and resolution.get("completeIdentityPairCount") == 10
        ...
        and held_set.get("sourceBindingCount") == 257
        ...
        and preparation.get("requestCount") == 20
        ...
        and len(identity_tuples) == 10
        and type(source_requests) is list
        and len(source_requests) == 20
        and sha256_bytes(wave9_digest_bytes(source_requests))
        == WAVE9_REQUEST_SET_SHA256,
        "E_WAVE9_DECISION",
    )
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE9_CONTENT_SHA256[WAVE9_PERMIT_PATH],
        }
        and permit.get("status") == "authorized_not_consumed"
        and permit.get("authority") == WAVE9_ACQUISITION_AUTHORITY
        and permit.get("decisionBinding", {}).get("rawSha256")
        == WAVE9_CONTROL_SHA256[WAVE9_DECISION_PATH]
        ...
        == {
            "checkerNormalizedSha256": V7_CHECKER_NORMALIZED_SHA256,
            "checkerPath": V7_CHECKER_PATH,
            "checkerRawSha256": V7_CHECKER_RAW_SHA256,
            "combinedInputSetSha256": V7_INPUT_SET_SHA256,
            "contentSha256": V7_CANDIDATE_CONTENT_SHA256,
            "frontierSha256": V7_FRONTIER_SHA256,
            "graphSha256": V7_GRAPH_SHA256,
            "sourceBindingsSha256": WAVE9_HELD_SOURCE_BINDINGS_SHA256,
            "testsPath": V7_TESTS_PATH,
            "testsRawSha256": V7_TESTS_RAW_SHA256,
        }
        and type(contract) is dict
        and contract.get("requestCount") == 20
        and contract.get("tupleCount") == 10
    ...
    check(
        ...
        and receipt.get("attemptId") == WAVE9_ATTEMPT_ID
        and receipt.get("acceptedPath") == WAVE9_ACCEPTED_DIRECTORY
        and receipt.get("acceptedResourceCount") == 20
        and receipt.get("modCount") == 10
        and receipt.get("zipCount") == 10
        and receipt.get("aggregateResponseBytes") == 16_285_940
        and receipt.get("aggregateModResponseBytes") == 1_181
        and receipt.get("aggregateZipResponseBytes") == 16_284_759
        and receipt.get("aggregateZipEntryCount") == 5_349
        and receipt.get("aggregateZipUncompressedBytes") == 54_936_288
    ...
    check(
        ...
        == {
            "attemptId": WAVE9_ATTEMPT_ID,
            "documentType": "aetherlink.wave9-source-acquisition-manifest",
            "manifestWrittenLast": True,
            "receiptPath": WAVE9_RECEIPT_PATH,
            "receiptRawSha256": WAVE9_CONTROL_SHA256[WAVE9_RECEIPT_PATH],
            "schemaVersion": "1.0",
    ...
    snapshot_predecessor = (
        snapshot.get("predecessorBindings", {}).get("combinedFixedPointV7")
        if type(snapshot) is dict
        else None
    )
    final_directory = (
    ...
    check(
        ...
        and exact_keys(
            ...
            (
                ...
                "combinedFixedPointV7PredecessorBindingRecomputed",
                ...
                "exact20ResourceOrderAndAggregateRecomputed",
                "exact38FrozenFileSnapshotRequired",
    ...
    check(
        ...
        == {
            ...
            "sha256": WAVE9_CONTENT_SHA256[WAVE9_READBACK_PERMIT_PATH],
        }
        and readback_permit.get("status") == "authorized_not_consumed"
        and readback_permit.get("authority") == WAVE9_READBACK_AUTHORITY
        ...
        is True
        and verification_contract.get("exact38FrozenFileSnapshotRequired")
        is True
        ...
        and snapshot.get("attemptId") == WAVE9_ATTEMPT_ID
        and identity_bindings
        == {
            "compactIdentitySha256": WAVE9_COMPACT_IDENTITY_SHA256,
            "fullWitnessSha256": WAVE9_FULL_WITNESS_SHA256,
            "heldSourceBindingsSha256":
                WAVE9_HELD_SOURCE_BINDINGS_SHA256,
        ...
        == {
            ...
            "stagingPrefix": ".wave-9-v1-staging-",
        }
        and snapshot.get("frozenFileCount") == 38
        and snapshot.get("frozenFilesCanonicalSha256")
        == WAVE9_FROZEN_FILE_SET_SHA256
        and snapshot.get("acceptedResourceCount") == 20
        and snapshot.get("selectedTupleCount") == 0
        and snapshot.get("modCount") == 10
        and snapshot.get("zipCount") == 10
        and snapshot.get("aggregateAcceptedBytes") == 16_285_940
        and snapshot.get("aggregateModBytes") == 1_181
        and snapshot.get("aggregateZipBytes") == 16_284_759
        and snapshot.get("aggregateZipEntryCount") == 5_349
        and snapshot.get("aggregateZipUncompressedBytes") == 54_936_288
        ...
        and acquisition_authority_by_path.get(
            (
                "script/acquire_p2p_nat_g2_pion_rung3_dependency_wave9_"
                "v1_once.py"
            ),
            {},
        ).get("rawSha256")
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE9_RECEIPT_PATH,
            "rawSha256": WAVE9_CONTROL_SHA256[WAVE9_RECEIPT_PATH],
        }
        ...
        == {
            ...
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE9_MANIFEST_PATH,
            "rawSha256": WAVE9_CONTROL_SHA256[WAVE9_MANIFEST_PATH],
        }
        ...
        and accepted.get("path") == WAVE9_ACCEPTED_DIRECTORY
        and accepted.get("mode") == "0700"
        and accepted.get("ownerUid") == os.geteuid()
        and accepted.get("linkCount") == 22
        and accepted.get("exactFileCount") == 20
        and type(accepted_files) is list
        and len(accepted_files) == 20
        and sha256_bytes(
    ...
    check(
        ...
        == {
            ...
            "authorityFileCount",
            "combinedFixedPointV7ContentSha256",
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE9_CONTENT_SHA256[WAVE9_READBACK_PATH],
        }
        and readback.get("status")
        == "wave9_acquisition_retained_snapshot_independently_read_back"
        and readback.get("acquisitionAttemptId") == WAVE9_ATTEMPT_ID
        and readback.get("readbackAttemptId") == WAVE9_READBACK_ATTEMPT_ID
        ...
        == {
            "bytes": 1_251,
            "contentSha256": WAVE9_READBACK_CLAIM_CONTENT_SHA256,
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": (
        ...
        == "wave9_acquisition_retained_snapshot_independently_verified"
        ...
        and verified.get("acceptedResourceCount") == 20
        ...
        == 54_936_288
        and verified.get("combinedFixedPointV7ContentSha256")
        == V7_CANDIDATE_CONTENT_SHA256
    ...
    check(
        ...
        == {
            "algorithm":
                "sha256(canonical-json-without-contentBinding)",
            "sha256": WAVE9_CONTENT_SHA256[
                WAVE9_READBACK_MANIFEST_PATH
            ],
        }
        and readback_manifest.get("status")
        == "wave9_acquisition_retained_snapshot_readback_publication_complete"
        and readback_manifest.get("acquisitionAttemptId") == WAVE9_ATTEMPT_ID
        ...
        == {
            "bytes": 12_109,
            "contentSha256": WAVE9_CONTENT_SHA256[WAVE9_READBACK_PATH],
            "linkCount": 1,
            "mode": "0600",
            "ownerUid": os.geteuid(),
            "path": WAVE9_READBACK_PATH,
            "rawSha256": WAVE9_CONTROL_SHA256[WAVE9_READBACK_PATH],
        }
    ...
    check(
        len(accepted_by_name) == 20
        and len(verified_by_name) == 20
        and len(identity_by_order) == 10,
        "E_WAVE9_RESOURCE",
    )
    ...
    for index, value in enumerate(resources, start=1):
        ...
        check(
            ...
            == f"wave9-{tuple_order:03}-{digest[:12]}"
        ...
        check(
            ...
            == f"{WAVE9_ACCEPTED_DIRECTORY}/{name}"
    ...
    validate_wave9_duplicate_mod_boundary(result)
    return result
...
def validate_wave9_duplicate_mod_boundary(
    ...
    check(
        ...
        and len(resources) == 20
        and type(resources[4]) is dict
        and type(resources[6]) is dict,
        "E_WAVE9_DUPLICATE_MOD",
    )
    duplicate_mod_a = resources[4]
    duplicate_mod_b = resources[6]
    check(
        duplicate_mod_a["kind"] == duplicate_mod_b["kind"] == "mod"
        and duplicate_mod_a["rawSha256"] == duplicate_mod_b["rawSha256"]
        and duplicate_mod_a["path"] != duplicate_mod_b["path"]
        and duplicate_mod_a["tupleId"] != duplicate_mod_b["tupleId"]
        and duplicate_mod_a["version"] != duplicate_mod_b["version"],
        "E_WAVE9_DUPLICATE_MOD",
    )
...
def combined_source_bindings(
    ...
    bindings = v7.combined_source_bindings(
        v6,
        v5,
        v4,
        v1,
    ...
    bindings.extend(wave9_request_resources(v4, runner, wave9_documents))
    check(
        len(bindings) == 277
        and sum(row["kind"] == "root_zip" for row in bindings) == 1
        and sum(row["kind"] == "mod" for row in bindings) == 138
        and sum(row["kind"] == "zip" for row in bindings) == 138
    ...
    check(
        len({row["path"] for row in bindings}) == 277
        and len(
            {
    ...
    check(
        ...
        and sorted(order for _, _, order in pair_kinds) == list(range(1, 139)),
        "E_COMBINED_INPUT",
    )
    return bindings
...
def generate_candidate(root: Path = ROOT) -> dict[str, Any]:
    ...
    with (
        ...
        v7 = load_v7_checker(v7_held)
        predecessor_candidate = v7.generate_candidate(root)
        v7 = harden_checker_module(v7)
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(root) as provider_held:
                ...
                check(
                    v7.PinnedCodeFile is PinnedCodeFile
                ...
                auxiliary_evidence = wave9_auxiliary_evidence_bindings()
                with runner.HeldInputSet(
                    ...
                    wave9_documents = parse_wave9_documents(
                        runner,
                        control_held,
                    )
                    predecessor_verification = (
                        validate_v7_predecessor_candidate(
                            runner,
                            predecessor_candidate,
                            wave9_documents[WAVE9_DECISION_PATH],
                        )
                    )
                    ...
                    wave9_evidence_raw = control_held.raw[WAVE9_EVIDENCE_PATH]
                    wave9_evidence_document = runner.strict_json(
                        wave9_evidence_raw,
                        WAVE9_EVIDENCE_PATH,
                    )
                    validate_wave9_evidence(
                        runner,
                        wave9_evidence_raw,
                        wave9_evidence_document,
                        wave9_documents,
                    )
                    validate_wave9_consumed_claims(
                        runner,
                        control_held.raw[WAVE9_ACQUISITION_CLAIM_PATH],
                        control_held.raw[WAVE9_READBACK_CLAIM_PATH],
                    )
                    validate_wave9_completed_namespace(
                        control_held,
                        wave9_documents,
                    )
                    with runner.HeldInputSet(root, bindings) as source_held:
                        ...
                        body = {
                            ...
                            "toolBindings": [
                                {
                                    "role": "current_v8_combined_checker",
                                    "path": SELF_PATH,
                                    "normalizedSha256":
                                        SELF_NORMALIZED_SHA256,
                                },
                            ...
                            "checkerVerification": {
                                ...
                                "underlyingIndependentGraphAlgorithmCount":
                                    ...
                                    + 4,
                                "pinnedV7PredecessorExecuted": True,
                                "v7TestsBindingScope":
                                ...
                                "wave9HistoricalExact38FrozenSnapshotDescriptorSetBound":
                                    True,
                                "wave9LiveTerminalControlMetadataVerified":
                                    True,
                                "wave9LiveFinalAndAcceptedInventoriesVerified":
                                    True,
                                "wave9FinalNamespaceReverifiedAfterReconstruction":
                                    True,
                                "wave9RetainedFdPreManifestBarrierCount": 3,
                                "wave9CompletionAppliesToRetainedSnapshot":
                                    True,
                                "wave9CurrentPathIdentityGuaranteedThroughManifestPublication":
                                    False,
                            ...
                            "operationCounters": {
                                ...
                                "heldToolInputCount": 7,
                                "transitiveDistinctToolPathCount": 9,
...
def error_document_bytes() -> bytes:
    return (
        json.dumps(
            {
                "documentType": (
                    "aetherlink.g2-pion-combined-wave1-through-wave9-"
