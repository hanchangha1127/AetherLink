#!/usr/bin/env python3
"""Validate the read-only Wave9 identity and acquisition decision.

Run only with ``python3 -I -B -S``.  The checker executes the exact pinned
combined-v7 candidate, then scans the retained 257 inputs twice using only the
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "Wave9 decision checker requires unoptimized "
            "`python3 -I -B -S`"
        )
...
READER_PATH = (
    f"{BASE}/bounded-dependency-source-identity-and-acquisition-"
    "decision-wave9-v1.md"
)
SELF_PATH = (
    "script/check_p2p_nat_g2_pion_rung3_dependency_wave9_decision_v1.py"
)
SELF_NORMALIZED_SHA256 = (
    "88f5e11fb6a17375d5ccc97e41e19c05d446224008222433b60d2d939556958a"
)
TESTS_PATH = (
    "script/test_p2p_nat_g2_pion_rung3_dependency_wave9_decision_v1.py"
)
TESTS_RAW_SHA256 = (
    "0999212a310404b3d2bf5a762ed037ecc417ee2707e87ee90a990dd18f16c5ba"
)
READER_RAW_SHA256 = (
    "b35305cbeac56522eb03a682d754d3d34b504fb7a143e9327a201b24113004c2"
)
...
DECLARATION_WITNESS_SHA256 = (
    "3f8c4161f920942f2280bad06ef9e7fbc7e959ff10c2dd629877c8681357d63e"
)
GO_MOD_H1_WITNESS_SHA256 = (
    "fe099d10664264ae179bec367769910fb98322b3a16318694fd61a3a3e6ceed1"
)
MODULE_ZIP_H1_WITNESS_SHA256 = (
    "551157131f81e3e15534e800cda0a0dbcab2b7eb88feac8b1e5d46222c985581"
)
CHECKER_ID = "g2-pion-ice-v4.3.0-wave9-identity-acquisition-decision-check-v1"
DECISION_ID = (
    "g2-pion-ice-v4.3.0-rung3-bounded-dependency-source-identity-and-"
    "acquisition-decision-wave9-v1"
)
DEPENDENCY_ROOT = "build/offline-source/pion-ice-v4.3.0/dependencies"
NAMESPACE_ANCHOR_PATH = f"{DEPENDENCY_ROOT}/.wave-8-v1.claim"
NAMESPACE_ANCHOR_RAW_SHA256 = (
    "772ac8daf78e313281245d6474dfee38bfe10b32b5e74953ef7bb45fed6a9265"
)
WAVE9_CLAIM_PATH = f"{DEPENDENCY_ROOT}/.wave-9-v1.claim"
WAVE9_STAGING_PREFIX = ".wave-9-v1-staging-"
WAVE9_ACCEPTED_PATH = f"{DEPENDENCY_ROOT}/wave-9-v1/accepted"
...
EXPECTED_IDENTITY = [
    ("golang.org/x/crypto", "v0.0.0-20210921155107-089bfa567519",
     ...
     "h1:7I4JAnoQBe7ZtJcBaYHi5UtiO8tQHbUSXxL+pnGRANg=", 1, 13, 1),
    ("golang.org/x/mod", "v0.28.0",
     "h1:yfB/L0NOf/kmEbXjzCPOx1iK1fRutOydrCMsqRhEBxI=",
     "h1:gQBtGhjxykdjY9YhZpSlZIsbnaE2+PgjfLWUQTnoZ1U=", 2, 2, 2),
    ("golang.org/x/net", "v0.44.0",
     "h1:ECOoLqd5U3Lhyeyo/QDCEVQ4sNgYsqvCZ722XogGieY=",
     "h1:evd8IRDyfNBMBTTY5XRF1vaZlD+EmWx6x8PkhR04H/I=", 1, 1, 1),
    ("golang.org/x/net", "v0.45.0",
     "h1:ECOoLqd5U3Lhyeyo/QDCEVQ4sNgYsqvCZ722XogGieY=",
     "h1:RLBg5JKixCy82FtLJpeNlVM0nrSqpCRYzVU1n8kj0tM=", 1, 1, 1),
    ("golang.org/x/sys", "v0.0.0-20220520151302-bc2c85ada10a",
     "h1:oPkhp1MJrh7nUepCBck5+mAzfO9JrbApNNgaTdGDITg=",
     "h1:dGzPydgVsqGcTRVwiLJ1jVbufYwmzD3LfVPLKsKg+0k=", 1, 13, 1),
    ("golang.org/x/sys", "v0.36.0",
     "h1:OgkHotnGiDImocRcuBABYBEXf8A9a87e/uXjp9XT3ks=",
     "h1:KVRy2GtZBrk1cBYA7MKu5bEZFxQk4NIDV6RLVcC8o0k=", 1, 1, 1),
    ("golang.org/x/telemetry", "v0.0.0-20250908211612-aef8a434d053",
     "h1:+nZKN+XVh4LCiA9DV3ywrzN4gumyCnKjau3NGb9SGoE=",
     "h1:dHQOQddU4YHS5gY33/6klKjq7Gp3WwMyOXGNp5nzRj8=", 1, 1, 1),
    ("golang.org/x/term", "v0.0.0-20210927222741-03fcf44c2211",
     "h1:jbD1KX2456YbFQfuXm/mYQcufACuNUgVhRMnK/tPxf8=",
     "h1:JGgROgKl9N8DuW20oFS5gxc+lE67/N3FcwmBPMe7ArY=", 1, 13, 1),
    ("golang.org/x/tools", "v0.0.0-20180917221912-90fa682c2a6e",
     "h1:n7NCudcB/nEzxVGmLbDWY5pfWTLqBcC2KZ6jyYvM4mQ=",
     "h1:FDhOuMEY4JVRztM/gsbk+IKUQ8kj74bxZrgw87eMMVc=", 1, 15, 1),
    ("golang.org/x/tools", "v0.0.0-20191119224855-298f0cb1881e",
     "h1:b+2E5dAYhXwXZwtnZ6UAqBI28+e2cm9otk0dWdXHAEo=",
     "h1:aZzprAO9/8oim3qStq3wc1Xuxx4QmAGriC4VU4ojemQ=", 1, 13, 1),
]
...
EXPECTED_NON_CLAIMS = (
    ...
    "wave9_dependency_source_not_acquired",
...
def portable_name(value: str) -> str:
    require(type(value) is str, "E_WAVE9_NAMESPACE")
    return unicodedata.normalize("NFC", value).casefold()


def validate_wave9_namespace_absent(
    ...
    try:
        ...
        raise DecisionFailure("E_WAVE9_NAMESPACE") from error
    require(
    ...
    for name in dependency_names:
        ...
        require(
            not normalized.startswith(".wave-9-v1")
            and not normalized.startswith("wave-9-v1"),
            "E_WAVE9_NAMESPACE",
        )
    ...
    for name in docs_names:
        ...
        require(
            not normalized.startswith(
                "bounded-dependency-source-acquisition-wave9"
            ),
            "E_WAVE9_NAMESPACE",
        )
    ...
    for name in script_names:
        normalized = portable_name(name)
        if "p2p_nat_g2_pion" in normalized and "wave9" in normalized:
            require(
...
class BootstrapPinnedCodeFile:
    """Immediate-ownership bootstrap pin matching combined-v7 semantics."""
...
def load_v7_checker(
    ...
    module = types.ModuleType("aetherlink_combined_v7_pinned")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(ROOT / V7_CHECKER_PATH),
            "__loader__": None,
            "__name__": "aetherlink_combined_v7_pinned",
            "__package__": None,
        }
    )
    try:
        ...
        raise DecisionFailure("E_V7_LOAD") from error
    for name in (
        "PinnedCodeFile",
        "SafeHeldInputSet",
        "generate_candidate",
...
def build_identity_rows(
    *,
    ...
    require(len(wave_rows) == 10, "E_TARGETS")
...
def scan_source_identity(
    *,
    ...
    require(len(targets) == len(wave_rows) == 10, "E_TARGETS")
...
def require_closed_identity(scan: Mapping[str, Any]) -> None:
    ...
    require(
        len(rows) == 10
        and scan["archiveCount"] == 129
        and scan["externalModCount"] == 128
        and scan["embeddedRootGoModCount"] == 1
        and scan["goSumEntryCount"] == 90
        and sum(row["declarationCount"] for row in rows) == 11
        and sum(
...
def validate_v7_candidate(
    candidate: Mapping[str, Any],
) -> tuple[list[dict[str, Any]], list[dict[str, Any]]]:
    require(type(candidate) is dict, "E_V7_CANDIDATE")
    ...
    require(
        ...
        == (
            ...
            "wave4-wave5-wave6-wave7-wave8-fixed-point-candidate"
        )
    ...
    require(
        ...
        and inputs.get("modCount") == 128
        and inputs.get("zipCount") == 128
        ...
        and inputs.get("uniqueModuleVersionTupleCount") == 128
    ...
    require(
        ...
        == 12
        and verification.get("pinnedV6PredecessorExecuted") is True
        ...
        and verification.get("wave8RetainedFdPreManifestBarrierCount")
        == 3
        and verification.get("wave8CompletionAppliesToRetainedSnapshot")
        is True
        and verification.get(
        ...
        and counters.get("directArchiveOpenCount") == 258
        and counters.get("inheritedArchiveOpenCount") == 830
        and counters.get("totalArchiveOpenCount") == 1088
        and counters.get("heldSourceInputCount") == 257
        and counters.get("heldTerminalEvidenceCount") == 52
        and counters.get("heldAuxiliaryEvidenceCount") == 3
        and counters.get("heldToolInputCount") == 6
        and counters.get("transitiveDistinctToolPathCount") == 8
        and counters.get("stableReadPassesPerHeldInput") == 2
        and counters.get("directFullSourceReconstructionCount") == 2
        and counters.get("inheritedFullSourceReconstructionCount") == 10
        and counters.get("totalFullSourceReconstructionCount") == 12
        ...
        and len(tool_bindings) == 6
        and type(terminal_bindings) is list
        and len(terminal_bindings) == 52
...
def expected_tool_bindings(
    ...
    require(
        ...
        == TESTS_RAW_SHA256
        and sha256_bytes(package_raw[V7_CHECKER_PATH])
        == V7_CHECKER_RAW_SHA256
        and sha256_bytes(
            package_raw[V7_TESTS_PATH]
        )
        == V7_TESTS_RAW_SHA256,
        "E_TOOL_IDENTITY",
    )
    return [
        {
            "role": "current_wave9_decision_checker",
            "path": SELF_PATH,
            "normalizedSha256": SELF_NORMALIZED_SHA256,
        },
        {
            "role": "current_wave9_decision_tests",
            "path": TESTS_PATH,
            "rawSha256": TESTS_RAW_SHA256,
        },
        {
            "role": "immutable_combined_v7_checker",
            "path": V7_CHECKER_PATH,
            "rawSha256": V7_CHECKER_RAW_SHA256,
            "normalizedSha256": V7_CHECKER_NORMALIZED_SHA256,
        },
        {
            "role": "immutable_combined_v7_tests",
            "path": V7_TESTS_PATH,
            "rawSha256": V7_TESTS_RAW_SHA256,
        },
    ]
    ...
    *,
    ...
    return {
        "documentType": (
            ...
            "identity-and-acquisition-decision-wave9"
        ),
        "schemaVersion": "1.0",
        ...
        "date": "2026-07-26",
        "status": (
            "wave9_exact_10_frontier_identity_classified_"
            "10_complete_0_blocked_acquisition_ready_not_authorized"
        ),
        "result": (
            "exact_10_version_vertices_0_selected_10_nonselected_"
            "10_complete_h1_pairs_acquisition_ready_not_authorized"
        ),
        ...
        "heldSourceInputSet": {
            ...
            "sourceBindingsSha256": V7_SOURCE_BINDINGS_SHA256,
        ...
        "sourceAcquisitionPreparation": {
            ...
            "modulePathEncoding":
                "current_wave9_lowercase_ascii_direct_proxy_path",
            "claimPath": WAVE9_CLAIM_PATH,
            "stagingDirectoryPrefix": WAVE9_STAGING_PREFIX,
            "acceptedDirectoryPath": WAVE9_ACCEPTED_PATH,
        ...
        "operationCounters": {
            "combinedV7CandidateInvocationCount": 1,
            "predecessorFullSourceReconstructionCount": 10,
            "directV7FullSourceReconstructionCount": 2,
            "totalFullSourceReconstructionCount": 12,
            "predecessorGraphArchiveOpenCount": 830,
            "currentV7GraphArchiveOpenCount": 258,
            "totalV7GraphArchiveOpenCount": 1088,
            "identityWitnessScanCount": 2,
            "identityWitnessArchiveOpenCount": 258,
            "overallDecisionExecutionArchiveOpenCount": 1346,
        ...
        "closure": {
            "wave9IdentityResolved": True,
            "wave9AcquisitionReady": True,
            "wave9AcquisitionComplete": False,
        ...
        "nextAction": (
            "prepare_separate_one_use_20_resource_wave9_source_"
...
def validate_semantic_decision(
    ...
    combined = (
        predecessors.get("combinedFixedPointV7")
    ...
    retained_keys = {
        "historicalExact46FrozenSnapshotDescriptorSetBound",
        "liveTerminalControlMetadataVerifiedAtCombinedV7Barrier",
        "liveFinalAndAcceptedInventoriesVerifiedAtCombinedV7Barrier",
        "finalNamespaceReverifiedAfterCombinedV7Reconstruction",
    ...
    require(
        exact_keys(predecessors, {"combinedFixedPointV7"})
    ...
    require(
        ...
        and held["sourceBindingCount"] == 257
        and held["sourceBindingsSha256"]
        == V7_SOURCE_BINDINGS_SHA256
        and held["archiveCount"] == 129
        and held["externalModCount"] == 128
        and held["embeddedRootGoModCount"] == 1
        and held["goSumEntryCount"] == 90
    ...
    require(
        ...
        and identity["tupleCount"] == 10
        and identity["graphSelectedTupleCount"] == 0
        and identity["versionSpecificNonSelectedTupleCount"] == 10
        and identity["parentDeclarationCount"] == 11
        and identity["moduleZipH1WitnessCount"] == 11
        and identity["goModH1WitnessCount"] == 73
        and identity["completeIdentityPairCount"] == 10
    ...
    require(
        ...
        and preparation["requestCount"] == 20
        ...
        == "current_wave9_lowercase_ascii_direct_proxy_path"
        and preparation["claimPath"] == WAVE9_CLAIM_PATH
        and preparation["stagingDirectoryPrefix"]
        == WAVE9_STAGING_PREFIX
...
def evaluate(
    ...
    *,
    ...
    with ExitStack() as stack:
        ...
        v7_tests_held = stack.enter_context(
            v7.PinnedCodeFile(
                root,
                V7_TESTS_PATH,
                V7_TESTS_RAW_SHA256,
        ...
        package_raw = {
            ...
            V7_CHECKER_PATH: v7_held.raw,
            V7_TESTS_PATH: v7_tests_held.raw,
        }
        held: list[Any] = [
            self_held,
            v7_held,
        ...
        validate_wave9_namespace_absent(
            namespace_anchor_held.parent_fd,
            reader_held.parent_fd,
            self_held.parent_fd,
        )
        identity_barrier(root, held)
        candidate = v7.generate_candidate(root)
        identity_barrier(root, held)
        wave_rows, source_bindings = validate_v7_candidate(candidate)
        ...
        v6 = v7.harden_checker_module(
            v7.load_v6_checker(v6_held)
        )
        ...
        require(
            type(runner) is v7.ReadOnlyProviderFacade
            and v6.PinnedCodeFile is v7.PinnedCodeFile
            and v5.PinnedCodeFile is v7.PinnedCodeFile
            and v4.PinnedCodeFile is v7.PinnedCodeFile
            and v1.PinnedRunnerFile is v7.SafePinnedRunnerFile,
            "E_SAFE_RUNTIME",
        )
        ...
        require(
            ...
            == source_bindings
            and len(full_source_bindings) == 257
            and all(
                type(row) is dict
    ...
    return expected, {
        "documentType":
            "aetherlink.wave9-identity-acquisition-decision-check",
        "schemaVersion": "1.0",
        "status":
            "validated_10_of_10_acquisition_ready_not_authorized",
        "validationPassed": True,
        "tupleCount": 10,
        "parentDeclarationCount": 11,
        "moduleZipH1WitnessCount": 11,
        "goModH1WitnessCount": 73,
        "completeIdentityPairCount": 10,
        "blockedTupleCount": 0,
...
def error_document(code: str) -> dict[str, Any]:
    return {
        "documentType":
            "aetherlink.wave9-identity-acquisition-decision-error",
        "schemaVersion": "1.0",
