...
REQUIRED_RELEASE_COPY_VALUES = {
    "en": {
        ...
        "Show source excerpts": "Show source excerpts",
        "Hide source excerpts": "Hide source excerpts",
        "Source review collapsed": "Source review collapsed",
        "Selected": "Selected",
    ...
    "ko": {
        ...
        "Show source excerpts": "원본 발췌 보기",
        "Hide source excerpts": "원본 발췌 숨기기",
        "Source review collapsed": "원본 검토 접힘",
        "Selected": "선택됨",
    ...
    "ja": {
        ...
        "Approved from older chat": "以前のチャットから承認済み",
        "Show source excerpts": "参照抜粋を表示",
        "Hide source excerpts": "参照抜粋を隠す",
        "Source review collapsed": "参照レビューを折りたたみ中",
        "Selected": "選択済み",
        "Not selected": "未選択",
    ...
    "zh-Hans": {
        ...
        "Approved from older chat": "来自旧聊天的已批准内容",
        "Show source excerpts": "显示来源摘录",
        "Hide source excerpts": "隐藏来源摘录",
        "Source review collapsed": "来源审核已折叠",
        "Selected": "已选择",
        "Not selected": "未选择",
    ...
    "fr": {
        ...
        "Approved from older chat": "Approuvé depuis un ancien chat",
        "Show source excerpts": "Afficher les extraits source",
        "Hide source excerpts": "Masquer les extraits source",
        "Source review collapsed": "Revue de la source réduite",
...
def check_activity_log_redaction() -> list[str]:
    ...
    failures.extend(missing_source_snippets(
        ...
        (
            ...
            "p2p_class|p2pClass|p2pRouteClass|p2p_record_id|p2pRecordID|p2pRecordId",
            "p2p_encrypted_body|p2pEncryptedBody|p2p_expires_at|p2pExpiresAt|p2pExpiresAtEpochMillis",
            "p2p_anti_replay_nonce|p2pAntiReplayNonce|p2p_protocol_version|p2pProtocolVersion",
            "pc|prid|peb|px|pn|pv",
            "allocation_token|allocationToken",
            "rs|rt|ri|rrn|pc|prid|peb|px|pn|pv",
    ...
    failures.extend(missing_source_snippets(
        ...
        (
            ...
            "reconcileActivityLogEntries(",
            "ForEach(Array(logEntries.enumerated()), id: \\.element.id)",
            "position: index + 1",
    ...
    failures.extend(missing_source_snippets(
        ...
        "macOS model-residency status and activity summary copy",
    ))
    failures.extend(missing_source_snippets(
        LOCALIZATION_TEST_SOURCE,
        (
