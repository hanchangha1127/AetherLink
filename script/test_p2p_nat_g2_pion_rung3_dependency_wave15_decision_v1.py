#!/usr/bin/env python3
"""Focused adversarial tests for the read-only Wave15 decision checker."""
...
if not (
    ...
    raise RuntimeError("Wave15 decision tests require `python3 -I -B -S`")
...
DECISION_PATH = (
    ...
    "bounded-dependency-source-identity-and-acquisition-decision-wave15-v1.json"
)
READER_PATH = (
    "docs/security-hardening/production-p2p-nat-v1/"
    "g2-pion-restricted-fork-v1/rung-three/"
    "bounded-dependency-source-identity-and-acquisition-decision-wave15-v1.md"
)
...
EXPECTED_V13_PIN_ORACLE = {
    "checkerPath":
        "script/check_p2p_nat_g2_pion_combined_fixed_point_v13.py",
    "checkerRawSha256":
    ...
    "testsPath":
        "script/test_p2p_nat_g2_pion_combined_fixed_point_v13.py",
    "testsRawSha256":
    ...
    "totalGraphArchiveOpenCount": 2_986,
}

EXPECTED_WAVE14_NAMESPACE_ANCHOR = {
    "path":
...
EXPECTED_OPERATION_COUNTER_ORACLE = {
    ...
    "totalFullSourceReconstructionCount": 24,
    "predecessorGraphArchiveOpenCount": 2_644,
    "currentV13GraphArchiveOpenCount": 342,
    "totalV13GraphArchiveOpenCount": 2_986,
    "identityWitnessScanCount": 2,
    "identityWitnessArchiveOpenCount": 342,
    "overallDecisionExecutionArchiveOpenCount": 3_328,
...
EXPECTED_SUMMARY_ORACLE = {
    ...
    "schemaVersion": "1.0",
    "status": "validated_5_of_5_acquisition_ready_not_authorized",
    "validationPassed": True,
    "tupleCount": 5,
    "parentDeclarationCount": 7,
    "moduleZipH1WitnessCount": 7,
    "goModH1WitnessCount": 7,
    "completeIdentityPairCount": 5,
    "blockedTupleCount": 0,
...
EXPECTED_HELD_SOURCE_INPUT_COUNT = 341
EXPECTED_ARCHIVE_COUNT = 171
...
WAVE14_GO_SUM_DELTA_ORACLE = {
    ...
    "predecessorGoSumEntryCount": 116,
    "acceptedDirectory": (
    ...
    "archives": (
        (
            ...
            "6a55423d327359615db923c5f17e5f10c4c7d91c39ef8d0b7f6e0876f89ff9da",
            ("golang.org/x/crypto@v0.40.0/go.sum",),
        ),
        (
            "002-47100744b1c211a90d13.zip",
            "6165d56707f7b1aef699f762a05eed017502c60ebd486e6a735265fc586d0f07",
            ("golang.org/x/term@v0.33.0/go.sum",),
        ),
        (
            "003-1bdf857599830a828b79.zip",
            "1230ce66d74ed4510f1578f25b4e53beee00926dc24c86fab7242637f8415ea8",
            ("golang.org/x/text@v0.27.0/go.sum",),
        ),
        (
            "004-b142b05fc3ea3268cdd3.zip",
            "3c6b7e5a2a7cc47b1f354c097881d0bd11dc13457d57d5ff86b2469acbd5f846",
            ("golang.org/x/tools@v0.34.0/go.sum",),
        ),
    ),
}
...
def load_checker(raw: bytes) -> types.ModuleType:
    ...
    module = types.ModuleType("wave15_decision_checker_test_subject")
    module.__dict__.update(
        {
            "__cached__": None,
            "__file__": str(path),
            "__loader__": None,
            "__name__": "wave15_decision_checker_test_subject",
            "__package__": None,
        }
    )
    exec(
...
# Independently recomputed final Wave15 checker AST seals.
EXPECTED_CHECKER_CALL_COUNT = 749
EXPECTED_CHECKER_CALL_SURFACE_SHA256 = (
    "af5fe99d38950a18fb0337a8f6a4f578798eb7839dc79d07e23cbf298d367972"
)
EXPECTED_CHECKER_FULL_AST_SHA256 = (
    "203f8ca36ee73b2c4ee85d5ba450eabcf20f7bd13f9f654d79c2338c12ac57b0"
)
        ...
        if isinstance(call.func, ast.Name) and call.func.id in {
            ...
            if call.func.id == "compile":
                ...
                valid = (
                    ...
                    and call.args[1].id == "V13_CHECKER_PATH"
...
class UnitBoundaryTests(unittest.TestCase):
    ...
    def test_07_frontier_and_request_order_are_exact(self) -> None:
        ...
        self.assertEqual(
            ...
            EXPECTED_V13_PIN_ORACLE["frontierSha256"],
        )
        self.assertNotEqual(
    ...
    def test_07c_v13_predecessor_pins_are_independent(self) -> None:
        actual = {
            "checkerPath": CHECKER.V13_CHECKER_PATH,
            "checkerRawSha256": CHECKER.V13_CHECKER_RAW_SHA256,
            "checkerNormalizedSha256":
                CHECKER.V13_CHECKER_NORMALIZED_SHA256,
            "testsPath": CHECKER.V13_TESTS_PATH,
            "testsRawSha256": CHECKER.V13_TESTS_RAW_SHA256,
            "contentSha256": CHECKER.V13_CANDIDATE_CONTENT_SHA256,
            "combinedInputSetSha256": CHECKER.V13_INPUT_SET_SHA256,
            "sourceBindingsSha256":
                CHECKER.V13_SOURCE_BINDINGS_SHA256,
            "graphSha256": CHECKER.V13_GRAPH_SHA256,
            "frontierSha256": CHECKER.V13_FRONTIER_SHA256,
            "fixedPointReached": False,
            "frontierTupleCount": CHECKER.EXPECTED_FRONTIER_COUNT,
            "totalFullSourceReconstructionCount": 24,
            "totalGraphArchiveOpenCount": 2_986,
        }
        self.assertEqual(actual, EXPECTED_V13_PIN_ORACLE)
        self.assertEqual(
            CHECKER.EXPECTED_FRONTIER_COUNT,
        ...
        checker_raw = (
            ROOT / EXPECTED_V13_PIN_ORACLE["checkerPath"]
        ).read_bytes()
        tests_raw = (
            ROOT / EXPECTED_V13_PIN_ORACLE["testsPath"]
        ).read_bytes()
        self.assertEqual(
            sha256(checker_raw),
            EXPECTED_V13_PIN_ORACLE["checkerRawSha256"],
        )
        self.assertEqual(
            sha256(independent_normalized_checker_bytes(checker_raw)),
            EXPECTED_V13_PIN_ORACLE["checkerNormalizedSha256"],
        )
        self.assertEqual(
            sha256(tests_raw),
            EXPECTED_V13_PIN_ORACLE["testsRawSha256"],
        )

    def test_07d_go_sum_count_includes_exact_wave14_delta(self) -> None:
        decision_raw = (
            ROOT / WAVE14_GO_SUM_DELTA_ORACLE["decisionPath"]
        ).read_bytes()
        self.assertEqual(
            sha256(decision_raw),
            WAVE14_GO_SUM_DELTA_ORACLE["decisionRawSha256"],
        )
        ...
        delta_count = 0
        accepted = (
            ROOT / WAVE14_GO_SUM_DELTA_ORACLE["acceptedDirectory"]
        )
        for name, expected_sha256, expected_go_sums in (
            WAVE14_GO_SUM_DELTA_ORACLE["archives"]
        ):
...
class HardeningBoundaryTests(unittest.TestCase):
    ...
    def test_wave15_namespace_rejects_stale_and_portable_aliases(
        self,
    ) -> None:
        with tempfile.TemporaryDirectory() as temporary:
            ...
            try:
                CHECKER.validate_wave15_namespace_absent(*fds)
                cases = (
                    (dependency, ".WAVE-15-v1.claim"),
                    (
                        docs,
                        "bounded-dependency-source-acquisition-"
                        "wave15-execution-permit-v1.json",
                    ),
                    (
                        scripts,
                        "check_p2p_nat_g2_pion_rung3_dependency_"
                        "wave15_acquisition_v1.py",
                    ),
                )
        ...
        with mock.patch.object(
            ...
            with self.assertRaises(
                ...
                CHECKER.validate_wave15_namespace_absent(1, 2, 3)
        self.assertEqual(caught.exception.code, "E_WAVE15_NAMESPACE")
...
class LiveRepositoryTests(unittest.TestCase):
    ...
    def setUpClass(cls) -> None:
        cls.package_raw = {
            ...
            CHECKER.V13_CHECKER_PATH:
                (ROOT / CHECKER.V13_CHECKER_PATH).read_bytes(),
            CHECKER.V13_TESTS_PATH:
                (ROOT / CHECKER.V13_TESTS_PATH).read_bytes(),
        }
    ...
    def test_08_self_reader_tests_and_v13_pins(self) -> None:
        self.assertEqual(
            sha256(
                CHECKER.normalized_self_bytes(
        ...
        self.assertEqual(
            sha256(self.package_raw[CHECKER.V13_CHECKER_PATH]),
            EXPECTED_V13_PIN_ORACLE["checkerRawSha256"],
        )
        self.assertEqual(
            sha256(self.package_raw[CHECKER.V13_TESTS_PATH]),
            EXPECTED_V13_PIN_ORACLE["testsRawSha256"],
        )
    ...
    def test_09_materialized_decision_is_exact_canonical_output(
        ...
        self.assertEqual(
            ...
            EXPECTED_V13_PIN_ORACLE["sourceBindingsSha256"],
        )
        self.assertEqual(
            (
                identity["tupleCount"],
    ...
    def test_10_authority_scope_and_counters_are_closed(self) -> None:
        ...
        self.assertEqual(
            ...
            (
                ...
                EXPECTED_V13_PIN_ORACLE["checkerNormalizedSha256"],
                EXPECTED_V13_PIN_ORACLE["testsRawSha256"],
                EXPECTED_V13_PIN_ORACLE["contentSha256"],
                EXPECTED_V13_PIN_ORACLE["combinedInputSetSha256"],
                EXPECTED_V13_PIN_ORACLE["sourceBindingsSha256"],
                EXPECTED_V13_PIN_ORACLE["graphSha256"],
                EXPECTED_V13_PIN_ORACLE["frontierSha256"],
                EXPECTED_V13_PIN_ORACLE["frontierTupleCount"],
            ),
        )
        self.assertEqual(
            (
        ...
        cases = (
            ...
            (
                lambda value:
                    value["predecessorBindings"][
                        "combinedFixedPointV13"
                    ]["wave14NamespaceAnchor"].__setitem__(
                        "rawSha256",
                        "0" * 64,
                    ),
                "E_DECISION_LINEAGE",
            ...
            (
                lambda value:
                    value["predecessorBindings"][
                        "combinedFixedPointV13"
                    ].__setitem__("v12TestsLiveHeld", True),
                "E_DECISION_LINEAGE",
            ),
            (
                lambda value:
            ...
            (
                lambda value:
                    value["identityResolution"]["tuples"][4].__setitem__(
