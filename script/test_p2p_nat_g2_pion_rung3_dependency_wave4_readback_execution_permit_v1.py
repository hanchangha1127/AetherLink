#!/usr/bin/env python3
"""Tests for the Wave4 acquisition readback permit package."""
...
SPEC = importlib.util.spec_from_file_location("wave4_readback_permit_tests", PATH)
C = importlib.util.module_from_spec(SPEC)
assert SPEC.loader is not None
SPEC.loader.exec_module(C)


class Wave4ReadbackPermitTests(unittest.TestCase):
    def test_01_frozen_snapshot_constants_are_exact(self):
        self.assertEqual(C.ATTEMPT_ID, "4cda3d86462fff445d6e69bce4b92dec")
        ...
        self.assertEqual(payload["selectedTupleCount"], 3)
        self.assertEqual(payload["aggregateZipEntryCount"], 5_936)
        self.assertEqual(
