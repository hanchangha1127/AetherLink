#!/usr/bin/env python3
"""Consume the Wave16 v1 permit once and acquire 6 verified resources."""
...
if not (
    ...
    raise RuntimeError("Wave16 acquisition requires `python3 -I -B -S`")
...
# Finalized reverse pin to the exact Wave16 acquisition checker bytes. The
...
EXPECTED_CHECKER_RAW = "a153df4c254987ed8b214449333ba56bc5af3612e4eb03f875567498bd58fa48"
...
def _validate_resource_contract(
    ...
    for index, source in enumerate(rows):
        ...
        require(
            ...
            and row["tupleId"] == f"wave16-{tuple_order:03d}-{digest[:12]}"
            and row["kind"] == kind
            and row["method"] == "GET"
...
def _attempt(
    ...
    *,
    ...
    try:
        ...
        failure = {
            "documentType": "aetherlink.wave16-source-acquisition-failure",
            "schemaVersion": "1.0",
...
def validate_execution_context() -> dict[str, Any]:
    ...
    return {
        "documentType":
            "aetherlink.wave16-source-acquisition-execution-context-check",
        "schemaVersion": "1.0",
...
def error_document(error: AcquisitionError) -> dict[str, Any]:
    ...
    return {
        "documentType": "aetherlink.wave16-source-acquisition-error",
        "schemaVersion": "1.0",
        "status": status,
