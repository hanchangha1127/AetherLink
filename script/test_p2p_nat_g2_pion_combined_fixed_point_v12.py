#!/usr/bin/env python3
"""Focused tests for the exact read-only 333-input combined v12 checker."""
...
def require_isolated_interpreter() -> None:
    ...
    if not (
        ...
        raise RuntimeError(
            "combined fixed-point v12 tests require unoptimized "
            "`python3 -I -B -S`"
        )
...
CHECKER_PATH = ROOT / "script/check_p2p_nat_g2_pion_combined_fixed_point_v12.py"


def load_checker():
    spec = importlib.util.spec_from_file_location(
        "combined_fixed_point_v12_tests_target",
        CHECKER_PATH,
    )
...
EXPECTED_WAVE13_RESOURCE_IDENTITY = [
    (1, 163, 'mod', 'golang.org/x/mod', 'v0.26.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/001-867b3d6651ab1a03a470.mod', '429c65117eb26ef4ab1d411eb11882d9df35d477cdaefe72939af90761aabe25'),
    (2, 163, 'zip', 'golang.org/x/mod', 'v0.26.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/001-867b3d6651ab1a03a470.zip', '559ae04b112e304086df0300cf0bee7ce21497c36c088c461d68891b55905605'),
    (3, 164, 'mod', 'golang.org/x/net', 'v0.42.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/002-ca3882149832dac56a85.mod', 'dbb482b1bcd21574a359a452cde3a7f51d7fce28079673daaa6644ef166de7b1'),
    (4, 164, 'zip', 'golang.org/x/net', 'v0.42.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/002-ca3882149832dac56a85.zip', 'cc9f79d1c8a796c756b636cee007b4ac5eba7b1f3276cd42658f4ac4a28cfbc1'),
    (5, 165, 'mod', 'golang.org/x/sys', 'v0.34.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/003-affb7f9946408283a16e.mod', 'f67e3e18f4c08e60a7e80726ab36b691fdcea5b81ae1c696ff64caf518bcfe3d'),
    (6, 165, 'zip', 'golang.org/x/sys', 'v0.34.0', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/003-affb7f9946408283a16e.zip', '27d5489227865ffffc3fbbbaf6100952ca2925eba19cfdff01e6e76b986b4bb4'),
    (7, 166, 'mod', 'golang.org/x/telemetry', 'v0.0.0-20250710130107-8d8967aff50b', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/004-afa9b13f01de51bd6d80.mod', 'ffb3b7e0813e534843aacfd64925f1e0e6cfb2b701a9301e9d1123dc596b192c'),
    (8, 166, 'zip', 'golang.org/x/telemetry', 'v0.0.0-20250710130107-8d8967aff50b', 'build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/004-afa9b13f01de51bd6d80.zip', '05ec70dbe6ef46c881f7d7ebe70ff61d9e998d2b4bbdbe6ff968870ef86c67b9'),
]
EXPECTED_WAVE13_FALSE_ROOT_GO_MOD_FILES = set()
EXPECTED_WAVE13_FROZEN_PATH_RAWS = [
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave13-v1.json', '0092e8b0290b6bb60193e0d744f4f5af8fbf2f6d02f947997e683952caf7aa65'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-identity-and-acquisition-decision-wave13-v1.md', '82fa537d061354742bc4f9c2243e76df08842cb943c4c99a5c4894b1e3d12631'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave13_decision_v1.py', 'd6b0745e79e7080f295cbc9facfc18ba9778a78de8cc3798acf8dce73161f3a6'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave13_decision_v1.py', '347b953ae977fff01a1c2e05852ebeb387667a31043aa186a72711cfc8ea4fc5'),
    ('script/check_p2p_nat_g2_pion_combined_fixed_point_v11.py', 'd330a2f7dd4f12bd4f972e6c34749e10701c594cad75308ccc7de4d3e6aba176'),
    ('script/test_p2p_nat_g2_pion_combined_fixed_point_v11.py', '7d753c0406210ca7e7bb07905533084fdba8a5ed626d23d913211021c719e922'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/.wave-12-v1.claim', '58145cf6660a9a6c3ed5ab36ec4f38df388e88d10c5a1e6820ca9416f06b8280'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave13-execution-permit-v1.md', '60262d8c7705954106aac2c1f11be31f157f8063b11efb8055583bdccc45645f'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave13-execution-permit-v1.json', 'b976f9bea30a20e34df25e9d90cfa9ee4617ce825b0d28f254b5bb512b6c29a1'),
    ('script/check_p2p_nat_g2_pion_rung3_dependency_wave13_acquisition_v1.py', '0ea506ac073e854a04bfc22c6b3a4d25afd957d9c4043af1e55c6b876eb87612'),
    ('script/test_p2p_nat_g2_pion_rung3_dependency_wave13_acquisition_v1.py', '8021795d5c7001a9efc23056bd8ca50465aee6becaff180797c982f380fb6cd6'),
    ('script/acquire_p2p_nat_g2_pion_rung3_dependency_wave13_v1_once.py', '482a73740a4efeda92450efbb1ddf97caf53ed06e5dee98a03b4414c5ee3055c'),
    ('script/test_acquire_p2p_nat_g2_pion_rung3_dependency_wave13_v1_once.py', '11052f54868d94960a95e5251f1394d92691e93dcf6589210281890f191c8c03'),
    ...
    ('build/offline-source/pion-ice-v4.3.0/dependencies/.wave-13-v1.claim', '085fdfae86d88a53526c836e61f956b89694c67cf54ea95b9ef43cb2a8566cc2'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/evidence.json', '6a6e2973690dfa9c5d0a6edd2aee8f6ae584fe1c4cb03a12b4ed9243707ce9d7'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/001-867b3d6651ab1a03a470.mod', '429c65117eb26ef4ab1d411eb11882d9df35d477cdaefe72939af90761aabe25'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/001-867b3d6651ab1a03a470.zip', '559ae04b112e304086df0300cf0bee7ce21497c36c088c461d68891b55905605'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/002-ca3882149832dac56a85.mod', 'dbb482b1bcd21574a359a452cde3a7f51d7fce28079673daaa6644ef166de7b1'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/002-ca3882149832dac56a85.zip', 'cc9f79d1c8a796c756b636cee007b4ac5eba7b1f3276cd42658f4ac4a28cfbc1'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/003-affb7f9946408283a16e.mod', 'f67e3e18f4c08e60a7e80726ab36b691fdcea5b81ae1c696ff64caf518bcfe3d'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/003-affb7f9946408283a16e.zip', '27d5489227865ffffc3fbbbaf6100952ca2925eba19cfdff01e6e76b986b4bb4'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/004-afa9b13f01de51bd6d80.mod', 'ffb3b7e0813e534843aacfd64925f1e0e6cfb2b701a9301e9d1123dc596b192c'),
    ('build/offline-source/pion-ice-v4.3.0/dependencies/wave-13-v1/accepted/004-afa9b13f01de51bd6d80.zip', '05ec70dbe6ef46c881f7d7ebe70ff61d9e998d2b4bbdbe6ff968870ef86c67b9'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave13-receipt-v1.json', 'b85a242f11255a82a8422adfda8cfe86113bd47bd9920c69fafb69985895c514'),
    ('docs/security-hardening/production-p2p-nat-v1/g2-pion-restricted-fork-v1/rung-three/bounded-dependency-source-acquisition-wave13-manifest-v1.json', '6d33bb51108da1f8e010f23ff6abfdd5eb62b398db0fd048e2a50576b7cbfa12'),
]
...
EXPECTED_CHECKER_CALL_COUNT = 1_344
EXPECTED_CHECKER_CALL_SURFACE_SHA256 = (
    "6736d8299d7035f3f4eb34afbaad5188e983c967dab3b87864a9e0861953d2ac"
)
EXPECTED_V12_CANDIDATE_CONTENT_SHA256 = (
    "176f5802b4bb56a6136f930a02ddd648774416945984af04bae4438de4e2bc17"
)
EXPECTED_V12_GRAPH_SHA256 = (
    "0ab3b47d6b4fc628a3bf83e648308591c84ddce8ad46ce8f8d6aca1797cf1e26"
)
EXPECTED_V12_FRONTIER_SHA256 = (
...
def validate_checker_static_surface(source):
    ...
    if (compile_count, exec_count) != (7, 7):
...
def held_toolchain():
    with (
        ...
        v11 = CHECKER.harden_checker_module(
            CHECKER.load_v11_checker(held_v11)
        )
        ...
        with v4.PinnedCodeFile(
            ...
            with v1.PinnedRunnerFile(ROOT) as held_provider:
                ...
                yield v11, v10, v9, v8, v7, v6, v5, v4, v1, runner


@contextmanager
def held_wave13_documents(*, include_held=False):
    with held_toolchain() as chain:
        v11, v10, v9, v8, v7, v6, v5, v4, v1, runner = chain
        bindings = (
            CHECKER.wave13_control_bindings()
            + CHECKER.wave13_auxiliary_evidence_bindings()
        )
        with runner.HeldInputSet(ROOT, bindings) as held:
            documents = CHECKER.parse_wave13_documents(runner, held)
            if include_held:
...
def held_all_documents():
    with held_toolchain() as chain:
        ...
        auxiliary = CHECKER.wave13_auxiliary_evidence_bindings()
        with runner.HeldInputSet(ROOT, controls + auxiliary) as held:
            yield (
                ...
                CHECKER.parse_wave13_documents(runner, held),
            )


def assert_wave13_mutation_fails(
    testcase: unittest.TestCase,
    mutate,
    expected_code: str,
) -> None:
    with held_wave13_documents() as (v4, runner, documents):
        mutated = copy.deepcopy(documents)
        mutate(mutated)
        with (
            mock.patch.object(
                CHECKER,
                "verify_wave13_content_bindings",
            ),
            testcase.assertRaises(
                CHECKER.CombinedCheckFailure,
            ) as caught,
        ):
            CHECKER.wave13_request_resources(v4, runner, mutated)
    testcase.assertEqual(str(caught.exception), expected_code)


def rebind_wave13_selector_hashes(
    runner,
    documents,
) -> tuple[str, str]:
    """Rebind selector-bearing projections so semantic checks run."""

    decision = documents[CHECKER.WAVE13_DECISION_PATH]
    permit = documents[CHECKER.WAVE13_PERMIT_PATH]
    readback_permit = documents[CHECKER.WAVE13_READBACK_PERMIT_PATH]
    readback = documents[CHECKER.WAVE13_READBACK_PATH]
    ...
    request_set_sha256 = CHECKER.sha256_bytes(
        CHECKER.wave13_digest_bytes(source_requests)
    )
...
class CombinedFixedPointV12Tests(unittest.TestCase):
    maxDiff = None

    @classmethod
    def setUpClass(cls):
        original_load_v11 = CHECKER.load_v11_checker
        original_derive_tool_paths = CHECKER.derive_and_validate_tool_paths
        original_os_open = os.open
        cls.actual_python_open_paths = []

        def capturing_load_v11(held):
            module = original_load_v11(held)
        ...
        with (
            mock.patch.object(
                CHECKER,
                "load_v11_checker",
                side_effect=capturing_load_v11,
            ),
            mock.patch.object(
                CHECKER,
    ...
    def test_01_self_predecessor_and_terminal_bytes_are_exact(self):
        ...
        for path, expected in (
            (CHECKER.V11_CHECKER_PATH, CHECKER.V11_CHECKER_RAW_SHA256),
            (CHECKER.V11_TESTS_PATH, CHECKER.V11_TESTS_RAW_SHA256),
        ):
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
        for path, expected in CHECKER.WAVE13_CONTROL_SHA256.items():
            self.assertEqual(
                hashlib.sha256((ROOT / path).read_bytes()).hexdigest(),
                expected,
            )
    ...
    def test_02_candidate_content_authority_and_route_are_derived(self):
        ...
        self.assertEqual(candidate["schemaVersion"], "12.0")
        self.assertEqual(
            binding["sha256"],
            EXPECTED_V12_CANDIDATE_CONTENT_SHA256,
        )
        ...
        self.assertEqual(
            candidate["derivedResult"],
            {
                ...
                "frontierSha256": EXPECTED_V12_FRONTIER_SHA256,
    ...
    def test_03_exact_333_input_composition_and_hashes(self):
        inputs = self.candidate["inputSet"]
        rows = inputs["sourceBindings"]
        expected_counts = {
            "heldSourceInputCount": 333,
            "resourceCount": 332,
            "modCount": 166,
            "zipCount": 166,
            ...
            "aggregateRawByteSize": 307_486_547,
        }
        for key, value in expected_counts.items():
            self.assertEqual(inputs[key], value, key)
        self.assertEqual(len(rows), 333)
        self.assertEqual(len({row["path"] for row in rows}), 333)
        self.assertEqual(
            inputs["combinedInputSetSha256"],
            CHECKER.V12_INPUT_SET_SHA256,
        )
        self.assertEqual(
            hashlib.sha256(CHECKER.wave13_digest_bytes(rows)).hexdigest(),
            CHECKER.V12_SOURCE_BINDINGS_SHA256,
        )
        pair_orders = sorted(
            {
                row["tupleOrder"]
        ...
        self.assertEqual(pair_orders, list(range(1, 167)))
        self.assertEqual(
            sorted(
                {
                    row["tupleOrder"]
    ...
    def test_04_reconstruction_and_archive_counters_are_not_stale(self):
        ...
        self.assertEqual(
            (
                ...
                CHECKER.V12_MAXIMUM_AGGREGATE_UNCOMPRESSED_BYTES,
            ),
            (167, 63_688, 1_174_227_650, 1_174_227_650),
        )
        self.assertEqual(
            (
        ...
        self.assertEqual(
            ...
            (334, 2_310, 2_644, 2_644),
        )
        self.assertEqual(
            verification["underlyingIndependentGraphAlgorithmCount"],
            44,
        )
        self.assertEqual(verification["hardenedCheckerModuleCount"], 11)
        self.assertEqual(verification["providerFacadeLoadCount"], 11)
        self.assertEqual(counters["heldTerminalEvidenceCount"], 87)
        self.assertEqual(counters["heldAuxiliaryEvidenceCount"], 3)
        self.assertEqual(counters["heldToolInputCount"], 11)
        self.assertEqual(counters["transitiveDistinctToolPathCount"], 13)
        for key in (
    ...
    def test_05_live_and_historical_boundaries_are_explicit(self):
        ...
        self.assertTrue(verification["pinnedV11PredecessorExecuted"])
        self.assertEqual(
            verification["v11TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(verification["v11TestsLiveHeld"])
        self.assertTrue(
            verification[
        ...
        self.assertTrue(
            verification["wave13LiveTerminalControlMetadataVerified"]
        )
        self.assertTrue(
            verification["wave13LiveFinalAndAcceptedInventoriesVerified"]
        )
        self.assertTrue(
            verification["wave13CompletionAppliesToRetainedSnapshot"]
        )
        self.assertFalse(
            verification[
        ...
        self.assertFalse(predecessor["v11TestsLiveHeld"])

    def test_06_wave13_terminal_resources_are_exact(self):
        with held_wave13_documents() as (v4, runner, documents):
            resources = CHECKER.wave13_request_resources(
                v4,
                runner,
                documents,
            )
            snapshot = documents[CHECKER.WAVE13_READBACK_PERMIT_PATH][
            ...
            verified_resources = documents[CHECKER.WAVE13_READBACK_PATH][
                "verified"
            ]["resources"]
        ...
        self.assertEqual(len(EXPECTED_WAVE13_FROZEN_PATH_RAWS), 27)
        ...
        self.assertEqual(
            ...
            (5_097_538, 411, 5_097_127, 1_647, 20_065_482),
        )
        self.assertTrue(
            documents[CHECKER.WAVE13_READBACK_PERMIT_PATH][
        ...
        self.assertEqual(
            ...
            EXPECTED_WAVE13_FALSE_ROOT_GO_MOD_FILES,
        )
    ...
    def test_07_combined_input_inventory_is_recomputed(self):
        ...
        self.assertEqual((len(controls), len(auxiliary)), (87, 3))
        self.assertEqual(len(rows), 333)
        self.assertEqual(
            hashlib.sha256(
        ...
        self.assertEqual(
            hashlib.sha256(
                CHECKER.wave13_digest_bytes(projection)
            ).hexdigest(),
            CHECKER.V12_SOURCE_BINDINGS_SHA256,
        )

    def test_08_unknown_authority_and_tool_pin_fail_closed(self):
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_PERMIT_PATH][
                "authority"
        ...
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_DECISION_PATH][
                "toolBindings"
        ...
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                "toolBindings"
        ...
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_READBACK_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
            "E_WAVE13_READBACK",
        )
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_READBACK_MANIFEST_PATH][
                "contentBinding"
            ].__setitem__("sha256", "0" * 64),
        ...
        for key in ("acquisitionClaim", "evidence"):
            assert_wave13_mutation_fails(
                ...
                lambda docs, target=key: docs[
                    CHECKER.WAVE13_READBACK_PERMIT_PATH
    ...
    def test_08_each_wave13_accepted_raw_binding_tamper_fails_closed(self):
        with held_wave13_documents() as (v4, runner, documents):
            accepted = documents[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acceptedDirectory"]["files"]
            self.assertEqual(len(accepted), 8)
            for index in range(8):
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                    "frozenAcquisitionSnapshot"
    ...
    def test_09_stale_wave12_snapshot_and_v10_predecessor_fail_closed(self):
        def substitute_resource_same_cardinality(documents):
            rows = documents[CHECKER.WAVE13_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            rows[0] = copy.deepcopy(rows[2])

        def substitute_authority_same_cardinality(documents):
            rows = documents[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["acquisitionAuthority"]
            rows[0] = copy.deepcopy(rows[1])

        def substitute_v10_predecessor(documents):
            predecessors = documents[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                "frozenAcquisitionSnapshot"
            ]["predecessorBindings"]
            predecessors["combinedFixedPointV10"] = predecessors.pop(
                "combinedFixedPointV11"
            )

        def add_v10_predecessor_sibling(documents, path, nested=False):
            container = documents[path]
            if nested:
                container = container["frozenAcquisitionSnapshot"]
            predecessors = container["predecessorBindings"]
            predecessors["combinedFixedPointV10"] = copy.deepcopy(
                predecessors["combinedFixedPointV11"]
            )
        ...
        assert_wave13_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE13_DECISION_PATH][
                "heldSourceInputSet"
            ].__setitem__("sourceBindingCount", 317),
            "E_WAVE13_DECISION",
        )
        assert_wave13_mutation_fails(
            self,
        ...
        assert_wave13_mutation_fails(
            self,
            substitute_v10_predecessor,
            "E_WAVE13_READBACK_PERMIT",
        )
        for path, nested, expected in (
            (CHECKER.WAVE13_DECISION_PATH, False, "E_WAVE13_DECISION"),
            (CHECKER.WAVE13_PERMIT_PATH, False, "E_WAVE13_PERMIT"),
            (
                CHECKER.WAVE13_READBACK_PERMIT_PATH,
                True,
                "E_WAVE13_READBACK_PERMIT",
        ...
        for path, nested, expected in (
            ...
            for key, value in (
                ("path", "build/offline-source/stale-wave12.claim"),
                ("rawSha256", "0" * 64),
            ):
                assert_wave13_mutation_fails(
                    self,
                    ...
                    anchor_key=key, anchor_value=value: (
                        ...
                        )["predecessorBindings"]["combinedFixedPointV11"][
        ...
        for path, key, value, expected in (
            ...
            def mutate_limit(
                ...
                if target == CHECKER.WAVE13_PERMIT_PATH:
                    section = (
                        "zipLimits"
    ...
    def test_10_selected_tuple_and_live_hold_overclaim_fail_closed(self):
        ...
        assert_wave13_mutation_fails(
            ...
            lambda docs: docs[CHECKER.WAVE13_READBACK_PERMIT_PATH][
                "verificationContract"
            ].__setitem__("v11TestsLiveHeld", False),
            "E_WAVE13_READBACK_PERMIT",
        )

    def test_10_all_wave13_selectors_and_false_root_mods_are_exact(self):
        with held_wave13_documents() as (v4, runner, documents):
            baseline = documents[CHECKER.WAVE13_PERMIT_PATH][
                "requestContract"
            ]["resources"]
            verified = documents[CHECKER.WAVE13_READBACK_PATH]["verified"][
                "resources"
            ]
                ...
                for index in range(count):
                    for value in (True, 0, "false", None, missing):
                        ...
                        resources_sha256, request_set_sha256 = (
                            rebind_wave13_selector_hashes(runner, mutated)
                        )
                        with (
                            self.subTest(
                            ...
                            CHECKER.wave13_request_resources(
                                v4,
                                runner,
                                mutated,
                            )
            ...
            for index in zip_root_indexes:
                mutated = copy.deepcopy(documents)
                mutated[CHECKER.WAVE13_READBACK_PATH]["verified"][
                    "resources"
    ...
    def test_11_post_success_reporting_contract_is_pinned(self):
        ...
        assert_wave13_mutation_fails(
            self,
            lambda docs: docs[CHECKER.WAVE13_READBACK_PERMIT_PATH].__setitem__(
    ...
    def test_12_terminal_modes_sizes_and_namespace_are_live(self):
        with held_wave13_documents(include_held=True) as (
            _,
            _,
            documents,
            held,
        ):
            CHECKER.validate_wave13_completed_namespace(held, documents)
            for path, (size, mode) in CHECKER.WAVE13_CONTROL_METADATA.items():
    ...
    def test_13_legacy_wave9_compatibility_remains_exact_and_bounded(self):
        with held_all_documents() as value:
            chain = value[0]
            d9 = value[-5]
            _, _, _, v8, _, _, _, v4, _, runner = chain
    ...
    def test_16_error_document_requests_no_credentials(self):
        ...
        self.assertEqual(value["schemaVersion"], "12.0")
    ...
    def test_17_v11_predecessor_is_exact_and_mutations_fail_closed(self):
        predecessor = self.predecessor_candidate
        self.assertEqual(
            predecessor["contentBinding"]["sha256"],
            CHECKER.V11_CANDIDATE_CONTENT_SHA256,
        )
        self.assertEqual(
        ...
        self.assertEqual(
            ...
            CHECKER.V11_GRAPH_SHA256,
        )
        self.assertEqual(
            predecessor["derivedResult"]["frontierSha256"],
            CHECKER.V11_FRONTIER_SHA256,
        )
        self.assertEqual(
            predecessor["checkerVerification"]["v10TestsBindingScope"],
            "historical_metadata_only_not_live_held",
        )
        self.assertFalse(
            predecessor["checkerVerification"]["v10TestsLiveHeld"]
        )
        with held_wave13_documents() as (_, runner, documents):
            decision = documents[CHECKER.WAVE13_DECISION_PATH]
            verified = CHECKER.validate_v11_predecessor_candidate(
                runner,
                predecessor,
                decision,
            )
            ...
            with self.assertRaises(
                ...
                CHECKER.validate_v11_predecessor_candidate(
                    runner,
                    predecessor,
                    stale_key_decision,
                )
            self.assertEqual(str(caught.exception), "E_V11_PREDECESSOR")
            for key in (
                "contentSha256",
            ...
            for key, value in (
                ...
                with self.subTest(wave12_namespace_anchor=key):
                    mutated_decision = copy.deepcopy(decision)
                    mutated_decision["predecessorBindings"][
                        "combinedFixedPointV11"
                    ]["wave12NamespaceAnchor"][key] = value
                    with self.assertRaises(
                        CHECKER.CombinedCheckFailure,
                    ) as caught:
                        CHECKER.validate_v11_predecessor_candidate(
    ...
    def test_18_live_protocol_order_and_tool_holds_are_observed(self):
        ...
        with (
            mock.patch.object(
                CHECKER,
                "validate_wave13_completed_namespace",
    ...
    def test_20_tool_path_derivation_rejects_duplicate_missing_and_extra(self):
        ...
        self.assertEqual(len(direct_paths), 11)
        self.assertEqual(len(transitive_paths), 13)
...
class CombinedFixedPointV12FastBoundaryTests(unittest.TestCase):
