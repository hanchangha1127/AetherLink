...
public enum MessageType {
    ...
    public static let citationResolve = "citation.resolve"
    public static let trustedSourceApprove = "trusted_source.approve"
    ...
    public static let memorySemanticDuplicateClustersList = "memory.semantic_duplicate_clusters.list"
