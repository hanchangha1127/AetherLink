...
`1.0.0+24`; these link-output identities are deliberately not frozen in tracked
source because a later clean local link may produce a new UUID. Stable no-
...
independently read those build outputs with strict dependency locks. Pushes to
`main` additionally compile the macOS Release app and execute the exact
